const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AdminLayout-CRgMPIrW.js","assets/vendor-hyKWh86c.js","assets/adminPermissions-BpFOmu71.js","assets/AdminLayout-pgB0QKFz.css","assets/AdminDashboard-Bfm5Jbot.js","assets/adminClient-CxeB4YVu.js","assets/i18n-CaT5xHvk.js","assets/AdminUsers-n0qycMXb.js","assets/AdminListings-DEAtGMFc.js","assets/AdminBlog-Bjd_qs6h.js","assets/AdminConsulting-nAEVbOny.js","assets/AdminGallery-CV4Ki_vr.js","assets/DashboardLayout-DTW5HRte.js","assets/DashboardLayout-BpKe-wRa.css","assets/DashboardHome-DGOCm8br.js","assets/DashboardHome-BLD588yz.css","assets/CropManager-PsAtA4Ex.js","assets/CropManager-BD-LpmFo.css","assets/IrrigationManager-DI5P_SJd.js","assets/IrrigationManager-CZCXtdu3.css","assets/FinanceManager-DYSPFqrf.js","assets/charts-DdzZAI62.js","assets/FinanceManager-CTGCeKBU.css","assets/WeatherHub-QLNfJU_p.js","assets/WeatherHub-BCakf7cf.css","assets/SpeciesLibrary-atL8VbK0.js","assets/SpeciesLibrary-NnjfWp4_.css","assets/GreenBot-CmFJwvQA.js","assets/GreenBot-D75McUtq.css","assets/SoilAdvisor-DpDNtpLL.js","assets/SoilAdvisor-B1clJ25z.css","assets/KoobAssist-DQZOHPnf.js","assets/KoobAssist-CjSwZy0D.css","assets/MarketPage-CvePjo0E.js","assets/MarketPage-DpFR5JJb.css","assets/SellerProfilePage-D3AYHpLi.js","assets/SellerProfilePage-DPItoylU.css","assets/BuyerProfilePage-CgCQL6M6.js","assets/BuyerProfilePage-Cf8EZ_59.css","assets/NetworkPage-CbXt2YNK.js","assets/NetworkPage-CrcCg5Ce.css","assets/VerifyTransaction-BD0HF4eb.js","assets/VerifyTransaction-DfdVffKM.css","assets/AdminTransactions-8i5QPySX.js","assets/AdminSettings-BVcTBE6e.js","assets/AdminProjects-ZfywTB01.js","assets/AdminActivity-DINJIIOp.js","assets/AdminTeamChat-UUjbVMGY.js","assets/AdminLogin-CUbnFeaC.js"])))=>i.map(i=>d[i]);
import{R as fe,r as v,j as e,u as St,L as S,N as Je,h as _t,f as Jr,B as Ft,c as kt,b as C,a as Le,d as Et}from"./vendor-hyKWh86c.js";import{a as Ot,B as qt,i as Rt,u as D}from"./i18n-CaT5xHvk.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();const Lt="modulepreload",Pt=function(r){return"/"+r},jr={},F=function(t,s,a){let n=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));n=Promise.allSettled(s.map(c=>{if(c=Pt(c),c in jr)return;jr[c]=!0;const u=c.endsWith(".css"),m=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${m}`))return;const h=document.createElement("link");if(h.rel=u?"stylesheet":Lt,u||(h.as="script"),h.crossOrigin="",h.href=c,l&&h.setAttribute("nonce",l),document.head.appendChild(h),u)return new Promise((y,f)=>{h.addEventListener("load",y),h.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function i(o){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=o,window.dispatchEvent(l),!l.defaultPrevented)throw o}return n.then(o=>{for(const l of o||[])l.status==="rejected"&&i(l.reason);return t().catch(i)})},Tt={home:"Accueil",services:"Services",about:"À Propos",blog:"Blog",gallery:"Galerie",contact:"Contact",login:"Se connecter",register:"S'inscrire",dashboard:"Tableau de bord",market:"Marché",marketplace:"Marketplace",agropro:"AgroPro",network:"Réseau",profile:"Mon Profil",logout:"Déconnexion"},Dt={slogan:"Cultiver un avenir durable, ensemble.",subtitle:"Plateforme agro-environnementale pour l'Afrique francophone — outils intelligents, expertise locale, impact réel.",cta_primary:"Découvrir nos services",cta_secondary:"Accéder à la plateforme"},It={founded:"Fondé en 2021",fellows:"2 Fellows Internationaux",services:"7 Lignes de Services",presence:"Présence Afrique & Europe"},Bt={title:"Nos Services",subtitle:"7 lignes de services intégrés pour accompagner votre projet agricole et agri-alimentaire.",conseil:{title:"Assistance-Conseil",desc:"Accompagnement à la création et à la gestion d'entreprises agricoles et agri-alimentaires.",cta:"En savoir plus"},negoce:{title:"Négoce Agricole",desc:"Commerce de produits agricoles et agri-alimentaires : oignons, pommes de terre et autres.",cta:"En savoir plus"},formations:{title:"Formations",desc:"Agriculture Durable, Agriculture Intelligente, Agriculture Hors-sol — formations certifiantes.",cta:"En savoir plus"},etudes:{title:"Études",desc:"Études environnementales et études de marché pour vos projets agricoles.",cta:"En savoir plus"},hydro:{title:"Aménagements Hydro-Agricoles",desc:"Conception et réalisation d'aménagements hydro-agricoles durables.",cta:"En savoir plus"},intrants:{title:"Intrants Agricoles",desc:"Vente d'intrants agricoles de qualité, dont BioGrowth — notre bio-fertilisant liquide.",cta:"En savoir plus"},projets:{title:"Développement de Projets",desc:"Développement de projets et études de marché pour agripreneurs et institutions.",cta:"En savoir plus"}},Mt={title:"Qui Nous Sommes",subtitle:"GreenFCO est une entreprise agro-environnementale fondée au Burkina Faso par deux frères passionnés d'agriculture durable et d'impact.",mission:"Notre Mission",vision:"Notre Vision",values:"Nos Valeurs",mission_text:"Accompagner les acteurs agricoles de l'Afrique francophone dans la transition vers des pratiques durables, innovantes et rentables.",vision_text:"Un secteur agricole africain résilient, inclusif et compétitif, ancré dans les pratiques agroécologiques.",values_durability:"Durabilité",values_innovation:"Innovation",values_impact:"Impact",founders:"Nos Co-fondateurs",timeline_title:"Notre Parcours"},zt={title:"Blog & Actualités",subtitle:"Articles, recherches et nouvelles du monde agro-environnemental.",read_more:"Lire la suite",categories:{all:"Tous",news:"Actualités",research:"Recherche & Innovation",agriculture:"Agriculture Durable",environment:"Environnement"},newsletter_cta:"Restez informé",newsletter_text:"Abonnez-vous à notre newsletter pour recevoir les dernières nouvelles et conseils agricoles."},Gt={title:"Contactez-Nous",subtitle:"Notre équipe est disponible pour répondre à vos questions et vous accompagner dans vos projets.",form_name:"Nom complet",form_email:"Adresse e-mail",form_subject:"Sujet",form_message:"Message",form_country:"Pays",form_submit:"Envoyer le message",whatsapp:"Contactez-nous sur WhatsApp",email:"Écrire un e-mail",success:"Votre message a été envoyé avec succès !",error:"Une erreur est survenue. Veuillez réessayer."},Ut={login_title:"Se connecter",register_title:"Créer un compte",email:"Adresse e-mail",password:"Mot de passe",confirm_password:"Confirmer le mot de passe",name:"Nom complet",country:"Pays",user_type:"Type de compte",farmer:"Agriculteur / Agripreneur",expert:"Expert / Consultant",investor:"Investisseur",organization:"Organisation / Institution",login_btn:"Se connecter",register_btn:"Créer mon compte",forgot_password:"Mot de passe oublié ?",no_account:"Pas encore de compte ?",have_account:"Déjà un compte ?",language_pref:"Langue préférée"},Wt={welcome:"Bienvenue",crops:"Mes Cultures",irrigation:"Irrigation",finance:"Finances",map:"Cartographie",weather:"Météo",species:"Espèces",market:"Marché",business_plan:"Business Plan",ai_advisor:"Conseiller IA",greenbot:"GreenBot",my_farms:"Mes Fermes",add_farm:"Ajouter une ferme"},$t={title:"Météo Agricole",subtitle:"Prévisions et alertes adaptées à votre exploitation",detect_location:"Détecter ma position",manual_city:"Entrer une ville",forecast_7days:"Prévisions 7 jours",rainfall_30days:"Pluies — 30 derniers jours",alerts:"Alertes Météo",recommendation:"Conseils du jour",temp_max:"Max",temp_min:"Min",rain:"Pluies",wind:"Vent",humidity:"Humidité"},Ht={title:"Marché Numérique",subtitle:"Achetez, vendez et échangez des produits agricoles",post_listing:"Publier une annonce",browse:"Parcourir les annonces",filters:"Filtres",crop:"Culture",quantity:"Quantité (kg)",price:"Prix",location:"Localisation",contact_whatsapp:"Contacter sur WhatsApp",my_listings:"Mes annonces"},Vt={title:"Réseau Agro-Environnemental",subtitle:"Connectez-vous avec des experts, agriculteurs et organisations",forums:"Forums",experts:"Experts",events:"Événements",knowledge:"Ressources",sponsorship:"Parrainage Plantes",investors:"Hub Investisseurs",impact:"Impact"},Jt={slogan:"Cultiver un avenir durable, ensemble.",rights:"Tous droits réservés",founded:"Fondé en 2021 au Burkina Faso"},Kt={loading:"Chargement...",error:"Une erreur est survenue",save:"Enregistrer",cancel:"Annuler",delete:"Supprimer",edit:"Modifier",add:"Ajouter",close:"Fermer",back:"Retour",next:"Suivant",previous:"Précédent",search:"Rechercher",filter:"Filtrer",export:"Exporter",download:"Télécharger",view_all:"Voir tout",learn_more:"En savoir plus",coming_soon:"Bientôt disponible",in_development:"En développement"},Yt={nav:Tt,hero:Dt,stats:It,services:Bt,about:Mt,blog:zt,contact:Gt,auth:Ut,dashboard:Wt,weather:$t,market:Ht,network:Vt,footer:Jt,common:Kt},Xt={home:"Home",services:"Services",about:"About",blog:"Blog",gallery:"Gallery",contact:"Contact",login:"Sign In",register:"Register",dashboard:"Dashboard",market:"Market",marketplace:"Marketplace",agropro:"AgroPro",network:"Network",profile:"My Profile",logout:"Sign Out"},Qt={slogan:"Cultivating a sustainable future, together.",subtitle:"Agro-environmental platform for Francophone Africa — smart tools, local expertise, real impact.",cta_primary:"Explore our services",cta_secondary:"Access the platform"},Zt={founded:"Founded in 2021",fellows:"2 International Fellows",services:"7 Service Lines",presence:"Africa & Europe Presence"},es={title:"Our Services",subtitle:"7 integrated service lines to support your agricultural and agri-food project.",conseil:{title:"Advisory Services",desc:"Business creation and management consulting for agricultural and agri-food enterprises.",cta:"Learn more"},negoce:{title:"Agricultural Trading",desc:"Trading of agricultural and agri-food products: onions, potatoes, and more.",cta:"Learn more"},formations:{title:"Training Programs",desc:"Sustainable Agriculture, Smart Agriculture, Soilless Agriculture — certified training.",cta:"Learn more"},etudes:{title:"Studies & Research",desc:"Environmental studies and market research for your agricultural projects.",cta:"Learn more"},hydro:{title:"Hydro-Agricultural Development",desc:"Design and implementation of sustainable hydro-agricultural projects.",cta:"Learn more"},intrants:{title:"Agricultural Inputs",desc:"Quality agricultural inputs, including BioGrowth — our liquid bio-fertilizer.",cta:"Learn more"},projets:{title:"Project Development",desc:"Project development and market studies for agripreneurs and institutions.",cta:"Learn more"}},rs={title:"Who We Are",subtitle:"GreenFCO is an agro-environmental enterprise founded in Burkina Faso by two brothers passionate about sustainable agriculture and impact.",mission:"Our Mission",vision:"Our Vision",values:"Our Values",mission_text:"Accompany agricultural actors in Francophone Africa in their transition to sustainable, innovative, and profitable practices.",vision_text:"A resilient, inclusive, and competitive African agricultural sector, grounded in agroecological practices.",values_durability:"Sustainability",values_innovation:"Innovation",values_impact:"Impact",founders:"Our Co-founders",timeline_title:"Our Journey"},ts={title:"Blog & News",subtitle:"Articles, research, and news from the agro-environmental world.",read_more:"Read more",categories:{all:"All",news:"News",research:"Research & Innovation",agriculture:"Sustainable Agriculture",environment:"Environment"},newsletter_cta:"Stay Informed",newsletter_text:"Subscribe to our newsletter to receive the latest agricultural news and tips."},ss={title:"Contact Us",subtitle:"Our team is available to answer your questions and support your projects.",form_name:"Full name",form_email:"Email address",form_subject:"Subject",form_message:"Message",form_country:"Country",form_submit:"Send message",whatsapp:"Contact us on WhatsApp",email:"Send an email",success:"Your message was sent successfully!",error:"An error occurred. Please try again."},as={login_title:"Sign In",register_title:"Create Account",email:"Email address",password:"Password",confirm_password:"Confirm password",name:"Full name",country:"Country",user_type:"Account type",farmer:"Farmer / Agripreneur",expert:"Expert / Consultant",investor:"Investor",organization:"Organization / Institution",login_btn:"Sign In",register_btn:"Create my account",forgot_password:"Forgot password?",no_account:"Don't have an account?",have_account:"Already have an account?",language_pref:"Preferred language"},ns={welcome:"Welcome",crops:"My Crops",irrigation:"Irrigation",finance:"Finance",map:"Farm Map",weather:"Weather",species:"Species",market:"Market",business_plan:"Business Plan",ai_advisor:"AI Advisor",greenbot:"GreenBot",my_farms:"My Farms",add_farm:"Add Farm"},is={title:"Agricultural Weather",subtitle:"Forecasts and alerts adapted to your farm",detect_location:"Detect my location",manual_city:"Enter a city",forecast_7days:"7-day forecast",rainfall_30days:"Rainfall — last 30 days",alerts:"Weather Alerts",recommendation:"Today's Advice",temp_max:"Max",temp_min:"Min",rain:"Rain",wind:"Wind",humidity:"Humidity"},os={title:"Digital Market",subtitle:"Buy, sell, and trade agricultural products",post_listing:"Post a listing",browse:"Browse listings",filters:"Filters",crop:"Crop",quantity:"Quantity (kg)",price:"Price",location:"Location",contact_whatsapp:"Contact on WhatsApp",my_listings:"My listings"},ls={title:"Agro-Environmental Network",subtitle:"Connect with experts, farmers, and organizations",forums:"Forums",experts:"Experts",events:"Events",knowledge:"Resources",sponsorship:"Plant Sponsorship",investors:"Investor Hub",impact:"Impact"},cs={slogan:"Cultivating a sustainable future, together.",rights:"All rights reserved",founded:"Founded in 2021 in Burkina Faso"},us={loading:"Loading...",error:"An error occurred",save:"Save",cancel:"Cancel",delete:"Delete",edit:"Edit",add:"Add",close:"Close",back:"Back",next:"Next",previous:"Previous",search:"Search",filter:"Filter",export:"Export",download:"Download",view_all:"View all",learn_more:"Learn more",coming_soon:"Coming soon",in_development:"In development"},ds={nav:Xt,hero:Qt,stats:Zt,services:es,about:rs,blog:ts,contact:ss,auth:as,dashboard:ns,weather:is,market:os,network:ls,footer:cs,common:us};Ot.use(qt).use(Rt).init({resources:{fr:{translation:Yt},en:{translation:ds}},fallbackLng:"fr",defaultNS:"translation",detection:{order:["localStorage","navigator"],caches:["localStorage"],lookupLocalStorage:"greenfco_lang"},interpolation:{escapeValue:!1}});const Ar=r=>{let t;const s=new Set,a=(u,m)=>{const h=typeof u=="function"?u(t):u;if(!Object.is(h,t)){const y=t;t=m??(typeof h!="object"||h===null)?h:Object.assign({},t,h),s.forEach(f=>f(t,y))}},n=()=>t,l={setState:a,getState:n,getInitialState:()=>c,subscribe:u=>(s.add(u),()=>s.delete(u))},c=t=r(a,n,l);return l},ms=r=>r?Ar(r):Ar,ps=r=>r;function hs(r,t=ps){const s=fe.useSyncExternalStore(r.subscribe,fe.useCallback(()=>t(r.getState()),[r,t]),fe.useCallback(()=>t(r.getInitialState()),[r,t]));return fe.useDebugValue(s),s}const wr=r=>{const t=ms(r),s=a=>hs(t,a);return Object.assign(s,t),s},fs=r=>r?wr(r):wr;function gs(r,t){let s;try{s=r()}catch{return}return{getItem:n=>{var i;const o=c=>c===null?null:JSON.parse(c,void 0),l=(i=s.getItem(n))!=null?i:null;return l instanceof Promise?l.then(o):o(l)},setItem:(n,i)=>s.setItem(n,JSON.stringify(i,void 0)),removeItem:n=>s.removeItem(n)}}const rr=r=>t=>{try{const s=r(t);return s instanceof Promise?s:{then(a){return rr(a)(s)},catch(a){return this}}}catch(s){return{then(a){return this},catch(a){return rr(a)(s)}}}},bs=(r,t)=>(s,a,n)=>{let i={storage:gs(()=>window.localStorage),partialize:g=>g,version:0,merge:(g,A)=>({...A,...g}),...t},o=!1,l=0;const c=new Set,u=new Set;let m=i.storage;if(!m)return r((...g)=>{console.warn(`[zustand persist middleware] Unable to update item '${i.name}', the given storage is currently unavailable.`),s(...g)},a,n);const h=()=>{const g=i.partialize({...a()});return m.setItem(i.name,{state:g,version:i.version})},y=n.setState;n.setState=(g,A)=>(y(g,A),h());const f=r((...g)=>(s(...g),h()),a,n);n.getInitialState=()=>f;let b;const x=()=>{var g,A;if(!m)return;const N=++l;o=!1,c.forEach(j=>{var _;return j((_=a())!=null?_:f)});const p=((A=i.onRehydrateStorage)==null?void 0:A.call(i,(g=a())!=null?g:f))||void 0;return rr(m.getItem.bind(m))(i.name).then(j=>{if(j)if(typeof j.version=="number"&&j.version!==i.version){if(i.migrate){const _=i.migrate(j.state,j.version);return _ instanceof Promise?_.then(E=>[!0,E]):[!0,_]}console.error("State loaded from storage couldn't be migrated since no migrate function was provided")}else return[!1,j.state];return[!1,void 0]}).then(j=>{var _;if(N!==l)return;const[E,Z]=j;if(b=i.merge(Z,(_=a())!=null?_:f),s(b,!0),E)return h()}).then(()=>{N===l&&(p==null||p(a(),void 0),b=a(),o=!0,u.forEach(j=>j(b)))}).catch(j=>{N===l&&(p==null||p(void 0,j))})};return n.persist={setOptions:g=>{i={...i,...g},g.storage&&(m=g.storage)},clearStorage:()=>{m==null||m.removeItem(i.name)},getOptions:()=>i,rehydrate:()=>x(),hasHydrated:()=>o,onHydrate:g=>(c.add(g),()=>{c.delete(g)}),onFinishHydration:g=>(u.add(g),()=>{u.delete(g)})},i.skipHydration||x(),b||f},vs=bs,ue=fs(vs(r=>({user:null,token:null,isAuthenticated:!1,setAuth:(t,s)=>r({user:t,token:s,isAuthenticated:!0}),logout:()=>r({user:null,token:null,isAuthenticated:!1}),updateUser:t=>r(s=>({user:{...s.user,...t}}))}),{name:"greenfco_auth",partialize:r=>({user:r.user,token:r.token,isAuthenticated:r.isAuthenticated})}));class xs extends v.Component{constructor(t){super(t),this.state={hasError:!1,error:null}}static getDerivedStateFromError(t){return{hasError:!0,error:t}}componentDidCatch(t,s){console.error("[ErrorBoundary]",t,s.componentStack)}render(){return this.state.hasError?e.jsxs("div",{style:{minHeight:"60vh",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:"1rem",padding:"2rem",textAlign:"center"},children:[e.jsx("div",{style:{fontSize:"3rem"},children:"🌿"}),e.jsx("h2",{style:{color:"#1B4332"},children:"Une erreur est survenue / An error occurred"}),e.jsx("p",{style:{color:"#6B7280",maxWidth:"400px"},children:this.props.fallbackMessage||"Quelque chose s'est mal passé. Veuillez actualiser la page. / Something went wrong. Please refresh the page."}),e.jsx("button",{onClick:()=>{this.setState({hasError:!1,error:null}),window.location.reload()},style:{background:"#1B4332",color:"white",border:"none",padding:"0.75rem 1.5rem",borderRadius:"8px",cursor:"pointer",fontSize:"1rem"},children:"🔄 Actualiser / Refresh"}),!1]}):this.props.children}}function ys(){var a;const{i18n:r}=D(),t=(a=r.language)!=null&&a.startsWith("fr")?"fr":"en";function s(){const n=t==="fr"?"en":"fr";r.changeLanguage(n),localStorage.setItem("greenfco_lang",n)}return e.jsxs("button",{className:"lang-toggle",onClick:s,title:"Toggle language",children:[e.jsx("span",{className:t==="fr"?"active":"",children:"FR"}),e.jsx("span",{className:"separator",children:"|"}),e.jsx("span",{className:t==="en"?"active":"",children:"EN"})]})}function js(){var g,A,N;const{t:r,i18n:t}=D(),s=(g=t.language)!=null&&g.startsWith("fr")?"fr":"en",a=St(),{isAuthenticated:n,user:i,logout:o}=ue(),[l,c]=v.useState(!1),[u,m]=v.useState(!1),h=a.pathname.startsWith("/dashboard")||a.pathname.startsWith("/network")||a.pathname.startsWith("/market"),y=[{to:"/",icon:"🏠",label:r("nav.home"),exact:!0},{to:"/services",icon:"🌿",label:r("nav.services")},{to:"/consulting",icon:"🤝",label:s==="fr"?"Consultation":"Consulting"},{to:"/about",icon:"👥",label:r("nav.about")},{to:"/blog",icon:"📰",label:r("nav.blog")},{to:"/gallery",icon:"📷",label:r("nav.gallery")},{to:"/contact",icon:"✉️",label:r("nav.contact")},{to:"/marketplace",icon:"🛒",label:r("nav.marketplace"),highlight:!0},{to:"/agropro",icon:"📊",label:r("nav.agropro"),highlight:!0}],f=[{to:"/dashboard",icon:"📊",label:r("nav.dashboard"),exact:!0},{to:"/marketplace",icon:"🛒",label:r("nav.marketplace"),highlight:!0},{to:"/agropro",icon:"📊",label:r("nav.agropro"),highlight:!0},{to:"/network",icon:"🌍",label:r("nav.network")},{to:"/blog",icon:"📰",label:r("nav.blog")}],b=n?f:y;function x(){o(),m(!1),c(!1)}return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:`navbar ${h?"navbar-dashboard":""}`,children:e.jsxs("div",{className:"navbar-container",children:[e.jsxs(S,{to:"/",className:"navbar-logo",onClick:()=>c(!1),children:[e.jsx("span",{className:"logo-icon",children:"🌿"}),e.jsxs("span",{className:"logo-text",children:[e.jsx("span",{className:"logo-green",children:"Green"}),"FCO"]})]}),e.jsx("nav",{className:"navbar-links",children:b.map(p=>p.highlight?e.jsxs(Je,{to:p.to,className:({isActive:j})=>`nav-link nav-market-btn ${j?"active":""}`,children:[p.icon," ",p.label]},p.to):e.jsx(Je,{to:p.to,end:p.exact,className:({isActive:j})=>`nav-link ${j?"active":""}`,children:p.label},p.to))}),e.jsx(S,{to:"/admin",style:{fontSize:"0.75rem",color:"var(--gray-mid)",marginRight:"0.5rem",textDecoration:"none",letterSpacing:"0.02em",opacity:.7},children:"Admin"}),e.jsxs("div",{className:"navbar-actions",children:[e.jsx(ys,{}),n?e.jsxs("div",{className:"profile-menu",children:[e.jsxs("button",{className:"profile-trigger",onClick:()=>m(!u),children:[e.jsx("span",{className:"profile-avatar",children:((A=i==null?void 0:i.name)==null?void 0:A.charAt(0).toUpperCase())||"U"}),e.jsx("span",{className:"profile-name desktop-only",children:(N=i==null?void 0:i.name)==null?void 0:N.split(" ")[0]}),e.jsx("span",{className:"profile-chevron desktop-only",children:u?"▲":"▼"})]}),u&&e.jsxs("div",{className:"profile-dropdown",children:[e.jsx(S,{to:"/profile",onClick:()=>m(!1),children:r("nav.profile")}),e.jsx("button",{onClick:x,children:r("nav.logout")})]})]}):e.jsxs("div",{className:"auth-buttons",children:[e.jsx(S,{to:"/login",className:"btn btn-secondary btn-sm",children:r("nav.login")}),e.jsx(S,{to:"/register",className:"btn btn-primary btn-sm mobile-only",children:r("nav.register")})]})]}),e.jsxs("button",{className:`hamburger ${l?"open":""}`,onClick:()=>c(!l),"aria-label":"Menu","aria-expanded":l,children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})}),l&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mobile-overlay",onClick:()=>c(!1)}),e.jsxs("nav",{className:"mobile-sheet",role:"navigation",children:[e.jsx("div",{className:"sheet-handle"}),e.jsxs("div",{className:"sheet-header",children:[e.jsxs("span",{className:"sheet-logo",children:["🌿 ",e.jsx("strong",{children:"GreenFCO"})]}),e.jsx("button",{className:"sheet-close",onClick:()=>c(!1),children:"✕"})]}),e.jsx("div",{className:"sheet-links",children:b.map(p=>e.jsxs(Je,{to:p.to,end:p.exact,className:({isActive:j})=>`sheet-link ${j?"sheet-link-active":""}`,onClick:()=>c(!1),children:[e.jsx("span",{className:"sheet-link-icon",children:p.icon}),e.jsx("span",{children:p.label})]},p.to))}),!n&&e.jsxs("div",{className:"sheet-auth",children:[e.jsx(S,{to:"/register",className:"btn btn-primary",style:{width:"100%",justifyContent:"center"},onClick:()=>c(!1),children:s==="fr"?"Créer un compte gratuit":"Create free account"}),e.jsx(S,{to:"/login",className:"btn btn-secondary",style:{width:"100%",justifyContent:"center"},onClick:()=>c(!1),children:r("nav.login")})]}),n&&e.jsx("div",{className:"sheet-auth",children:e.jsx("button",{onClick:x,className:"btn btn-secondary",style:{width:"100%",justifyContent:"center",color:"#c00",borderColor:"#c00"},children:r("nav.logout")})})]})]})]})}function As(){const{t:r}=D(),t=new Date().getFullYear();return e.jsxs("footer",{className:"footer",children:[e.jsx("div",{className:"footer-grain"}),e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"footer-top",children:[e.jsxs("div",{className:"footer-brand",children:[e.jsxs(S,{to:"/",className:"footer-logo",children:[e.jsx("span",{children:"🌿"}),e.jsxs("span",{children:[e.jsx("span",{style:{color:"var(--green-light)"},children:"Green"}),"FCO"]})]}),e.jsxs("p",{className:"footer-slogan",children:['"',r("footer.slogan"),'"']}),e.jsx("p",{className:"footer-founded",children:r("footer.founded")}),e.jsxs("div",{className:"footer-social",children:[e.jsx("a",{href:"https://facebook.com",target:"_blank",rel:"noreferrer","aria-label":"Facebook",children:e.jsx(ws,{})}),e.jsx("a",{href:"https://twitter.com",target:"_blank",rel:"noreferrer","aria-label":"Twitter",children:e.jsx(Ns,{})}),e.jsx("a",{href:"https://linkedin.com",target:"_blank",rel:"noreferrer","aria-label":"LinkedIn",children:e.jsx(Cs,{})}),e.jsx("a",{href:"https://wa.me/22600000000",target:"_blank",rel:"noreferrer","aria-label":"WhatsApp",children:e.jsx(Ss,{})})]})]}),e.jsxs("div",{className:"footer-nav",children:[e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"Navigation"}),e.jsx(S,{to:"/",children:r("nav.home")}),e.jsx(S,{to:"/about",children:r("nav.about")}),e.jsx(S,{to:"/services",children:r("nav.services")}),e.jsx(S,{to:"/blog",children:r("nav.blog")}),e.jsx(S,{to:"/gallery",children:r("nav.gallery")}),e.jsx(S,{to:"/contact",children:r("nav.contact")})]}),e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"Plateforme"}),e.jsx(S,{to:"/dashboard",children:r("nav.dashboard")}),e.jsx(S,{to:"/marketplace",children:r("nav.marketplace")}),e.jsx(S,{to:"/agropro",children:r("nav.agropro")}),e.jsx(S,{to:"/network",children:r("nav.network")}),e.jsx(S,{to:"/register",children:r("nav.register")})]}),e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"Contact"}),e.jsx("a",{href:"mailto:info@greenfco.com",children:"info@greenfco.com"}),e.jsx("a",{href:"https://wa.me/22600000000",target:"_blank",rel:"noreferrer",children:"WhatsApp"}),e.jsx("span",{children:"Ouagadougou, Burkina Faso"})]})]})]}),e.jsxs("div",{className:"footer-bottom",children:[e.jsxs("p",{children:["© ",t," Green Field Consortium (GreenFCO). ",r("footer.rights"),"."]}),e.jsxs("div",{className:"footer-badges",children:[e.jsx("span",{className:"badge badge-green",children:"🏅 YALI Fellow 2023"}),e.jsx("span",{className:"badge badge-green",children:"🏅 Humboldt Fellow 2025"})]})]})]})]})}function ws(){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"18",height:"18",children:e.jsx("path",{d:"M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"})})}function Ns(){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"18",height:"18",children:e.jsx("path",{d:"M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"})})}function Cs(){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"18",height:"18",children:[e.jsx("path",{d:"M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z"}),e.jsx("circle",{cx:"4",cy:"4",r:"2"})]})}function Ss(){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"18",height:"18",children:e.jsx("path",{d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413z"})})}function Kr(r,t){return function(){return r.apply(t,arguments)}}const{toString:_s}=Object.prototype,{getPrototypeOf:De}=Object,{iterator:Ie,toStringTag:Yr}=Symbol,Be=(r=>t=>{const s=_s.call(t);return r[s]||(r[s]=s.slice(8,-1).toLowerCase())})(Object.create(null)),M=r=>(r=r.toLowerCase(),t=>Be(t)===r),Me=r=>t=>typeof t===r,{isArray:de}=Array,ce=Me("undefined");function ge(r){return r!==null&&!ce(r)&&r.constructor!==null&&!ce(r.constructor)&&T(r.constructor.isBuffer)&&r.constructor.isBuffer(r)}const Xr=M("ArrayBuffer");function Fs(r){let t;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?t=ArrayBuffer.isView(r):t=r&&r.buffer&&Xr(r.buffer),t}const ks=Me("string"),T=Me("function"),Qr=Me("number"),be=r=>r!==null&&typeof r=="object",Es=r=>r===!0||r===!1,Ee=r=>{if(Be(r)!=="object")return!1;const t=De(r);return(t===null||t===Object.prototype||Object.getPrototypeOf(t)===null)&&!(Yr in r)&&!(Ie in r)},Os=r=>{if(!be(r)||ge(r))return!1;try{return Object.keys(r).length===0&&Object.getPrototypeOf(r)===Object.prototype}catch{return!1}},qs=M("Date"),Rs=M("File"),Ls=r=>!!(r&&typeof r.uri<"u"),Ps=r=>r&&typeof r.getParts<"u",Ts=M("Blob"),Ds=M("FileList"),Is=r=>be(r)&&T(r.pipe);function Bs(){return typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}}const Nr=Bs(),Cr=typeof Nr.FormData<"u"?Nr.FormData:void 0,Ms=r=>{if(!r)return!1;if(Cr&&r instanceof Cr)return!0;const t=De(r);if(!t||t===Object.prototype||!T(r.append))return!1;const s=Be(r);return s==="formdata"||s==="object"&&T(r.toString)&&r.toString()==="[object FormData]"},zs=M("URLSearchParams"),[Gs,Us,Ws,$s]=["ReadableStream","Request","Response","Headers"].map(M),Hs=r=>r.trim?r.trim():r.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"");function ve(r,t,{allOwnKeys:s=!1}={}){if(r===null||typeof r>"u")return;let a,n;if(typeof r!="object"&&(r=[r]),de(r))for(a=0,n=r.length;a<n;a++)t.call(null,r[a],a,r);else{if(ge(r))return;const i=s?Object.getOwnPropertyNames(r):Object.keys(r),o=i.length;let l;for(a=0;a<o;a++)l=i[a],t.call(null,r[l],l,r)}}function Zr(r,t){if(ge(r))return null;t=t.toLowerCase();const s=Object.keys(r);let a=s.length,n;for(;a-- >0;)if(n=s[a],t===n.toLowerCase())return n;return null}const se=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:global,et=r=>!ce(r)&&r!==se;function tr(...r){const{caseless:t,skipUndefined:s}=et(this)&&this||{},a={},n=(i,o)=>{if(o==="__proto__"||o==="constructor"||o==="prototype")return;const l=t&&Zr(a,o)||o,c=sr(a,l)?a[l]:void 0;Ee(c)&&Ee(i)?a[l]=tr(c,i):Ee(i)?a[l]=tr({},i):de(i)?a[l]=i.slice():(!s||!ce(i))&&(a[l]=i)};for(let i=0,o=r.length;i<o;i++)r[i]&&ve(r[i],n);return a}const Vs=(r,t,s,{allOwnKeys:a}={})=>(ve(t,(n,i)=>{s&&T(n)?Object.defineProperty(r,i,{__proto__:null,value:Kr(n,s),writable:!0,enumerable:!0,configurable:!0}):Object.defineProperty(r,i,{__proto__:null,value:n,writable:!0,enumerable:!0,configurable:!0})},{allOwnKeys:a}),r),Js=r=>(r.charCodeAt(0)===65279&&(r=r.slice(1)),r),Ks=(r,t,s,a)=>{r.prototype=Object.create(t.prototype,a),Object.defineProperty(r.prototype,"constructor",{__proto__:null,value:r,writable:!0,enumerable:!1,configurable:!0}),Object.defineProperty(r,"super",{__proto__:null,value:t.prototype}),s&&Object.assign(r.prototype,s)},Ys=(r,t,s,a)=>{let n,i,o;const l={};if(t=t||{},r==null)return t;do{for(n=Object.getOwnPropertyNames(r),i=n.length;i-- >0;)o=n[i],(!a||a(o,r,t))&&!l[o]&&(t[o]=r[o],l[o]=!0);r=s!==!1&&De(r)}while(r&&(!s||s(r,t))&&r!==Object.prototype);return t},Xs=(r,t,s)=>{r=String(r),(s===void 0||s>r.length)&&(s=r.length),s-=t.length;const a=r.indexOf(t,s);return a!==-1&&a===s},Qs=r=>{if(!r)return null;if(de(r))return r;let t=r.length;if(!Qr(t))return null;const s=new Array(t);for(;t-- >0;)s[t]=r[t];return s},Zs=(r=>t=>r&&t instanceof r)(typeof Uint8Array<"u"&&De(Uint8Array)),ea=(r,t)=>{const a=(r&&r[Ie]).call(r);let n;for(;(n=a.next())&&!n.done;){const i=n.value;t.call(r,i[0],i[1])}},ra=(r,t)=>{let s;const a=[];for(;(s=r.exec(t))!==null;)a.push(s);return a},ta=M("HTMLFormElement"),sa=r=>r.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,function(s,a,n){return a.toUpperCase()+n}),sr=(({hasOwnProperty:r})=>(t,s)=>r.call(t,s))(Object.prototype),aa=M("RegExp"),rt=(r,t)=>{const s=Object.getOwnPropertyDescriptors(r),a={};ve(s,(n,i)=>{let o;(o=t(n,i,r))!==!1&&(a[i]=o||n)}),Object.defineProperties(r,a)},na=r=>{rt(r,(t,s)=>{if(T(r)&&["arguments","caller","callee"].includes(s))return!1;const a=r[s];if(T(a)){if(t.enumerable=!1,"writable"in t){t.writable=!1;return}t.set||(t.set=()=>{throw Error("Can not rewrite read-only method '"+s+"'")})}})},ia=(r,t)=>{const s={},a=n=>{n.forEach(i=>{s[i]=!0})};return de(r)?a(r):a(String(r).split(t)),s},oa=()=>{},la=(r,t)=>r!=null&&Number.isFinite(r=+r)?r:t;function ca(r){return!!(r&&T(r.append)&&r[Yr]==="FormData"&&r[Ie])}const ua=r=>{const t=new WeakSet,s=a=>{if(be(a)){if(t.has(a))return;if(ge(a))return a;if(!("toJSON"in a)){t.add(a);const n=de(a)?[]:{};return ve(a,(i,o)=>{const l=s(i);!ce(l)&&(n[o]=l)}),t.delete(a),n}}return a};return s(r)},da=M("AsyncFunction"),ma=r=>r&&(be(r)||T(r))&&T(r.then)&&T(r.catch),tt=((r,t)=>r?setImmediate:t?((s,a)=>(se.addEventListener("message",({source:n,data:i})=>{n===se&&i===s&&a.length&&a.shift()()},!1),n=>{a.push(n),se.postMessage(s,"*")}))(`axios@${Math.random()}`,[]):s=>setTimeout(s))(typeof setImmediate=="function",T(se.postMessage)),pa=typeof queueMicrotask<"u"?queueMicrotask.bind(se):typeof process<"u"&&process.nextTick||tt,ha=r=>r!=null&&T(r[Ie]),d={isArray:de,isArrayBuffer:Xr,isBuffer:ge,isFormData:Ms,isArrayBufferView:Fs,isString:ks,isNumber:Qr,isBoolean:Es,isObject:be,isPlainObject:Ee,isEmptyObject:Os,isReadableStream:Gs,isRequest:Us,isResponse:Ws,isHeaders:$s,isUndefined:ce,isDate:qs,isFile:Rs,isReactNativeBlob:Ls,isReactNative:Ps,isBlob:Ts,isRegExp:aa,isFunction:T,isStream:Is,isURLSearchParams:zs,isTypedArray:Zs,isFileList:Ds,forEach:ve,merge:tr,extend:Vs,trim:Hs,stripBOM:Js,inherits:Ks,toFlatObject:Ys,kindOf:Be,kindOfTest:M,endsWith:Xs,toArray:Qs,forEachEntry:ea,matchAll:ra,isHTMLForm:ta,hasOwnProperty:sr,hasOwnProp:sr,reduceDescriptors:rt,freezeMethods:na,toObjectSet:ia,toCamelCase:sa,noop:oa,toFiniteNumber:la,findKey:Zr,global:se,isContextDefined:et,isSpecCompliantForm:ca,toJSONObject:ua,isAsyncFn:da,isThenable:ma,setImmediate:tt,asap:pa,isIterable:ha},fa=d.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]),ga=r=>{const t={};let s,a,n;return r&&r.split(`
`).forEach(function(o){n=o.indexOf(":"),s=o.substring(0,n).trim().toLowerCase(),a=o.substring(n+1).trim(),!(!s||t[s]&&fa[s])&&(s==="set-cookie"?t[s]?t[s].push(a):t[s]=[a]:t[s]=t[s]?t[s]+", "+a:a)}),t};function ba(r){let t=0,s=r.length;for(;t<s;){const a=r.charCodeAt(t);if(a!==9&&a!==32)break;t+=1}for(;s>t;){const a=r.charCodeAt(s-1);if(a!==9&&a!==32)break;s-=1}return t===0&&s===r.length?r:r.slice(t,s)}const va=new RegExp("[\\u0000-\\u0008\\u000a-\\u001f\\u007f]+","g"),xa=new RegExp("[^\\u0009\\u0020-\\u007e\\u0080-\\u00ff]+","g");function cr(r,t){return d.isArray(r)?r.map(s=>cr(s,t)):ba(String(r).replace(t,""))}const ya=r=>cr(r,va),ja=r=>cr(r,xa);function st(r){const t=Object.create(null);return d.forEach(r.toJSON(),(s,a)=>{t[a]=ja(s)}),t}const Sr=Symbol("internals");function he(r){return r&&String(r).trim().toLowerCase()}function Oe(r){return r===!1||r==null?r:d.isArray(r)?r.map(Oe):ya(String(r))}function Aa(r){const t=Object.create(null),s=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let a;for(;a=s.exec(r);)t[a[1]]=a[2];return t}const wa=r=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(r.trim());function Ke(r,t,s,a,n){if(d.isFunction(a))return a.call(this,t,s);if(n&&(t=s),!!d.isString(t)){if(d.isString(a))return t.indexOf(a)!==-1;if(d.isRegExp(a))return a.test(t)}}function Na(r){return r.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,s,a)=>s.toUpperCase()+a)}function Ca(r,t){const s=d.toCamelCase(" "+t);["get","set","has"].forEach(a=>{Object.defineProperty(r,a+s,{__proto__:null,value:function(n,i,o){return this[a].call(this,t,n,i,o)},configurable:!0})})}let P=class{constructor(t){t&&this.set(t)}set(t,s,a){const n=this;function i(l,c,u){const m=he(c);if(!m)throw new Error("header name must be a non-empty string");const h=d.findKey(n,m);(!h||n[h]===void 0||u===!0||u===void 0&&n[h]!==!1)&&(n[h||c]=Oe(l))}const o=(l,c)=>d.forEach(l,(u,m)=>i(u,m,c));if(d.isPlainObject(t)||t instanceof this.constructor)o(t,s);else if(d.isString(t)&&(t=t.trim())&&!wa(t))o(ga(t),s);else if(d.isObject(t)&&d.isIterable(t)){let l={},c,u;for(const m of t){if(!d.isArray(m))throw TypeError("Object iterator must return a key-value pair");l[u=m[0]]=(c=l[u])?d.isArray(c)?[...c,m[1]]:[c,m[1]]:m[1]}o(l,s)}else t!=null&&i(s,t,a);return this}get(t,s){if(t=he(t),t){const a=d.findKey(this,t);if(a){const n=this[a];if(!s)return n;if(s===!0)return Aa(n);if(d.isFunction(s))return s.call(this,n,a);if(d.isRegExp(s))return s.exec(n);throw new TypeError("parser must be boolean|regexp|function")}}}has(t,s){if(t=he(t),t){const a=d.findKey(this,t);return!!(a&&this[a]!==void 0&&(!s||Ke(this,this[a],a,s)))}return!1}delete(t,s){const a=this;let n=!1;function i(o){if(o=he(o),o){const l=d.findKey(a,o);l&&(!s||Ke(a,a[l],l,s))&&(delete a[l],n=!0)}}return d.isArray(t)?t.forEach(i):i(t),n}clear(t){const s=Object.keys(this);let a=s.length,n=!1;for(;a--;){const i=s[a];(!t||Ke(this,this[i],i,t,!0))&&(delete this[i],n=!0)}return n}normalize(t){const s=this,a={};return d.forEach(this,(n,i)=>{const o=d.findKey(a,i);if(o){s[o]=Oe(n),delete s[i];return}const l=t?Na(i):String(i).trim();l!==i&&delete s[i],s[l]=Oe(n),a[l]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){const s=Object.create(null);return d.forEach(this,(a,n)=>{a!=null&&a!==!1&&(s[n]=t&&d.isArray(a)?a.join(", "):a)}),s}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,s])=>t+": "+s).join(`
`)}getSetCookie(){return this.get("set-cookie")||[]}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...s){const a=new this(t);return s.forEach(n=>a.set(n)),a}static accessor(t){const a=(this[Sr]=this[Sr]={accessors:{}}).accessors,n=this.prototype;function i(o){const l=he(o);a[l]||(Ca(n,o),a[l]=!0)}return d.isArray(t)?t.forEach(i):i(t),this}};P.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]);d.reduceDescriptors(P.prototype,({value:r},t)=>{let s=t[0].toUpperCase()+t.slice(1);return{get:()=>r,set(a){this[s]=a}}});d.freezeMethods(P);const Sa="[REDACTED ****]";function _a(r){if(d.hasOwnProp(r,"toJSON"))return!0;let t=Object.getPrototypeOf(r);for(;t&&t!==Object.prototype;){if(d.hasOwnProp(t,"toJSON"))return!0;t=Object.getPrototypeOf(t)}return!1}function Fa(r,t){const s=new Set(t.map(i=>String(i).toLowerCase())),a=[],n=i=>{if(i===null||typeof i!="object"||d.isBuffer(i))return i;if(a.indexOf(i)!==-1)return;i instanceof P&&(i=i.toJSON()),a.push(i);let o;if(d.isArray(i))o=[],i.forEach((l,c)=>{const u=n(l);d.isUndefined(u)||(o[c]=u)});else{if(!d.isPlainObject(i)&&_a(i))return a.pop(),i;o=Object.create(null);for(const[l,c]of Object.entries(i)){const u=s.has(l.toLowerCase())?Sa:n(c);d.isUndefined(u)||(o[l]=u)}}return a.pop(),o};return n(r)}let w=class at extends Error{static from(t,s,a,n,i,o){const l=new at(t.message,s||t.code,a,n,i);return l.cause=t,l.name=t.name,t.status!=null&&l.status==null&&(l.status=t.status),o&&Object.assign(l,o),l}constructor(t,s,a,n,i){super(t),Object.defineProperty(this,"message",{__proto__:null,value:t,enumerable:!0,writable:!0,configurable:!0}),this.name="AxiosError",this.isAxiosError=!0,s&&(this.code=s),a&&(this.config=a),n&&(this.request=n),i&&(this.response=i,this.status=i.status)}toJSON(){const t=this.config,s=t&&d.hasOwnProp(t,"redact")?t.redact:void 0,a=d.isArray(s)&&s.length>0?Fa(t,s):d.toJSONObject(t);return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:a,code:this.code,status:this.status}}};w.ERR_BAD_OPTION_VALUE="ERR_BAD_OPTION_VALUE";w.ERR_BAD_OPTION="ERR_BAD_OPTION";w.ECONNABORTED="ECONNABORTED";w.ETIMEDOUT="ETIMEDOUT";w.ECONNREFUSED="ECONNREFUSED";w.ERR_NETWORK="ERR_NETWORK";w.ERR_FR_TOO_MANY_REDIRECTS="ERR_FR_TOO_MANY_REDIRECTS";w.ERR_DEPRECATED="ERR_DEPRECATED";w.ERR_BAD_RESPONSE="ERR_BAD_RESPONSE";w.ERR_BAD_REQUEST="ERR_BAD_REQUEST";w.ERR_CANCELED="ERR_CANCELED";w.ERR_NOT_SUPPORT="ERR_NOT_SUPPORT";w.ERR_INVALID_URL="ERR_INVALID_URL";w.ERR_FORM_DATA_DEPTH_EXCEEDED="ERR_FORM_DATA_DEPTH_EXCEEDED";const ka=null;function ar(r){return d.isPlainObject(r)||d.isArray(r)}function nt(r){return d.endsWith(r,"[]")?r.slice(0,-2):r}function Ye(r,t,s){return r?r.concat(t).map(function(n,i){return n=nt(n),!s&&i?"["+n+"]":n}).join(s?".":""):t}function Ea(r){return d.isArray(r)&&!r.some(ar)}const Oa=d.toFlatObject(d,{},null,function(t){return/^is[A-Z]/.test(t)});function ze(r,t,s){if(!d.isObject(r))throw new TypeError("target must be an object");t=t||new FormData,s=d.toFlatObject(s,{metaTokens:!0,dots:!1,indexes:!1},!1,function(g,A){return!d.isUndefined(A[g])});const a=s.metaTokens,n=s.visitor||h,i=s.dots,o=s.indexes,l=s.Blob||typeof Blob<"u"&&Blob,c=s.maxDepth===void 0?100:s.maxDepth,u=l&&d.isSpecCompliantForm(t);if(!d.isFunction(n))throw new TypeError("visitor must be a function");function m(x){if(x===null)return"";if(d.isDate(x))return x.toISOString();if(d.isBoolean(x))return x.toString();if(!u&&d.isBlob(x))throw new w("Blob is not supported. Use a Buffer instead.");return d.isArrayBuffer(x)||d.isTypedArray(x)?u&&typeof Blob=="function"?new Blob([x]):Buffer.from(x):x}function h(x,g,A){let N=x;if(d.isReactNative(t)&&d.isReactNativeBlob(x))return t.append(Ye(A,g,i),m(x)),!1;if(x&&!A&&typeof x=="object"){if(d.endsWith(g,"{}"))g=a?g:g.slice(0,-2),x=JSON.stringify(x);else if(d.isArray(x)&&Ea(x)||(d.isFileList(x)||d.endsWith(g,"[]"))&&(N=d.toArray(x)))return g=nt(g),N.forEach(function(j,_){!(d.isUndefined(j)||j===null)&&t.append(o===!0?Ye([g],_,i):o===null?g:g+"[]",m(j))}),!1}return ar(x)?!0:(t.append(Ye(A,g,i),m(x)),!1)}const y=[],f=Object.assign(Oa,{defaultVisitor:h,convertValue:m,isVisitable:ar});function b(x,g,A=0){if(!d.isUndefined(x)){if(A>c)throw new w("Object is too deeply nested ("+A+" levels). Max depth: "+c,w.ERR_FORM_DATA_DEPTH_EXCEEDED);if(y.indexOf(x)!==-1)throw Error("Circular reference detected in "+g.join("."));y.push(x),d.forEach(x,function(p,j){(!(d.isUndefined(p)||p===null)&&n.call(t,p,d.isString(j)?j.trim():j,g,f))===!0&&b(p,g?g.concat(j):[j],A+1)}),y.pop()}}if(!d.isObject(r))throw new TypeError("data must be an object");return b(r),t}function _r(r){const t={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+"};return encodeURIComponent(r).replace(/[!'()~]|%20/g,function(a){return t[a]})}function ur(r,t){this._pairs=[],r&&ze(r,this,t)}const it=ur.prototype;it.append=function(t,s){this._pairs.push([t,s])};it.toString=function(t){const s=t?function(a){return t.call(this,a,_r)}:_r;return this._pairs.map(function(n){return s(n[0])+"="+s(n[1])},"").join("&")};function qa(r){return encodeURIComponent(r).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+")}function ot(r,t,s){if(!t)return r;const a=s&&s.encode||qa,n=d.isFunction(s)?{serialize:s}:s,i=n&&n.serialize;let o;if(i?o=i(t,n):o=d.isURLSearchParams(t)?t.toString():new ur(t,n).toString(a),o){const l=r.indexOf("#");l!==-1&&(r=r.slice(0,l)),r+=(r.indexOf("?")===-1?"?":"&")+o}return r}class Fr{constructor(){this.handlers=[]}use(t,s,a){return this.handlers.push({fulfilled:t,rejected:s,synchronous:a?a.synchronous:!1,runWhen:a?a.runWhen:null}),this.handlers.length-1}eject(t){this.handlers[t]&&(this.handlers[t]=null)}clear(){this.handlers&&(this.handlers=[])}forEach(t){d.forEach(this.handlers,function(a){a!==null&&t(a)})}}const dr={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1,legacyInterceptorReqResOrdering:!0},Ra=typeof URLSearchParams<"u"?URLSearchParams:ur,La=typeof FormData<"u"?FormData:null,Pa=typeof Blob<"u"?Blob:null,Ta={isBrowser:!0,classes:{URLSearchParams:Ra,FormData:La,Blob:Pa},protocols:["http","https","file","blob","url","data"]},mr=typeof window<"u"&&typeof document<"u",nr=typeof navigator=="object"&&navigator||void 0,Da=mr&&(!nr||["ReactNative","NativeScript","NS"].indexOf(nr.product)<0),Ia=typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope&&typeof self.importScripts=="function",Ba=mr&&window.location.href||"http://localhost",Ma=Object.freeze(Object.defineProperty({__proto__:null,hasBrowserEnv:mr,hasStandardBrowserEnv:Da,hasStandardBrowserWebWorkerEnv:Ia,navigator:nr,origin:Ba},Symbol.toStringTag,{value:"Module"})),L={...Ma,...Ta};function za(r,t){return ze(r,new L.classes.URLSearchParams,{visitor:function(s,a,n,i){return L.isNode&&d.isBuffer(s)?(this.append(a,s.toString("base64")),!1):i.defaultVisitor.apply(this,arguments)},...t})}function Ga(r){return d.matchAll(/\w+|\[(\w*)]/g,r).map(t=>t[0]==="[]"?"":t[1]||t[0])}function Ua(r){const t={},s=Object.keys(r);let a;const n=s.length;let i;for(a=0;a<n;a++)i=s[a],t[i]=r[i];return t}function lt(r){function t(s,a,n,i){let o=s[i++];if(o==="__proto__")return!0;const l=Number.isFinite(+o),c=i>=s.length;return o=!o&&d.isArray(n)?n.length:o,c?(d.hasOwnProp(n,o)?n[o]=d.isArray(n[o])?n[o].concat(a):[n[o],a]:n[o]=a,!l):((!d.hasOwnProp(n,o)||!d.isObject(n[o]))&&(n[o]=[]),t(s,a,n[o],i)&&d.isArray(n[o])&&(n[o]=Ua(n[o])),!l)}if(d.isFormData(r)&&d.isFunction(r.entries)){const s={};return d.forEachEntry(r,(a,n)=>{t(Ga(a),n,s,0)}),s}return null}const le=(r,t)=>r!=null&&d.hasOwnProp(r,t)?r[t]:void 0;function Wa(r,t,s){if(d.isString(r))try{return(t||JSON.parse)(r),d.trim(r)}catch(a){if(a.name!=="SyntaxError")throw a}return(s||JSON.stringify)(r)}const xe={transitional:dr,adapter:["xhr","http","fetch"],transformRequest:[function(t,s){const a=s.getContentType()||"",n=a.indexOf("application/json")>-1,i=d.isObject(t);if(i&&d.isHTMLForm(t)&&(t=new FormData(t)),d.isFormData(t))return n?JSON.stringify(lt(t)):t;if(d.isArrayBuffer(t)||d.isBuffer(t)||d.isStream(t)||d.isFile(t)||d.isBlob(t)||d.isReadableStream(t))return t;if(d.isArrayBufferView(t))return t.buffer;if(d.isURLSearchParams(t))return s.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),t.toString();let l;if(i){const c=le(this,"formSerializer");if(a.indexOf("application/x-www-form-urlencoded")>-1)return za(t,c).toString();if((l=d.isFileList(t))||a.indexOf("multipart/form-data")>-1){const u=le(this,"env"),m=u&&u.FormData;return ze(l?{"files[]":t}:t,m&&new m,c)}}return i||n?(s.setContentType("application/json",!1),Wa(t)):t}],transformResponse:[function(t){const s=le(this,"transitional")||xe.transitional,a=s&&s.forcedJSONParsing,n=le(this,"responseType"),i=n==="json";if(d.isResponse(t)||d.isReadableStream(t))return t;if(t&&d.isString(t)&&(a&&!n||i)){const l=!(s&&s.silentJSONParsing)&&i;try{return JSON.parse(t,le(this,"parseReviver"))}catch(c){if(l)throw c.name==="SyntaxError"?w.from(c,w.ERR_BAD_RESPONSE,this,null,le(this,"response")):c}}return t}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:L.classes.FormData,Blob:L.classes.Blob},validateStatus:function(t){return t>=200&&t<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};d.forEach(["delete","get","head","post","put","patch","query"],r=>{xe.headers[r]={}});function Xe(r,t){const s=this||xe,a=t||s,n=P.from(a.headers);let i=a.data;return d.forEach(r,function(l){i=l.call(s,i,n.normalize(),t?t.status:void 0)}),n.normalize(),i}function ct(r){return!!(r&&r.__CANCEL__)}let ye=class extends w{constructor(t,s,a){super(t??"canceled",w.ERR_CANCELED,s,a),this.name="CanceledError",this.__CANCEL__=!0}};function ut(r,t,s){const a=s.config.validateStatus;!s.status||!a||a(s.status)?r(s):t(new w("Request failed with status code "+s.status,s.status>=400&&s.status<500?w.ERR_BAD_REQUEST:w.ERR_BAD_RESPONSE,s.config,s.request,s))}function $a(r){const t=/^([-+\w]{1,25}):(?:\/\/)?/.exec(r);return t&&t[1]||""}function Ha(r,t){r=r||10;const s=new Array(r),a=new Array(r);let n=0,i=0,o;return t=t!==void 0?t:1e3,function(c){const u=Date.now(),m=a[i];o||(o=u),s[n]=c,a[n]=u;let h=i,y=0;for(;h!==n;)y+=s[h++],h=h%r;if(n=(n+1)%r,n===i&&(i=(i+1)%r),u-o<t)return;const f=m&&u-m;return f?Math.round(y*1e3/f):void 0}}function Va(r,t){let s=0,a=1e3/t,n,i;const o=(u,m=Date.now())=>{s=m,n=null,i&&(clearTimeout(i),i=null),r(...u)};return[(...u)=>{const m=Date.now(),h=m-s;h>=a?o(u,m):(n=u,i||(i=setTimeout(()=>{i=null,o(n)},a-h)))},()=>n&&o(n)]}const Pe=(r,t,s=3)=>{let a=0;const n=Ha(50,250);return Va(i=>{if(!i||typeof i.loaded!="number")return;const o=i.loaded,l=i.lengthComputable?i.total:void 0,c=l!=null?Math.min(o,l):o,u=Math.max(0,c-a),m=n(u);a=Math.max(a,c);const h={loaded:c,total:l,progress:l?c/l:void 0,bytes:u,rate:m||void 0,estimated:m&&l?(l-c)/m:void 0,event:i,lengthComputable:l!=null,[t?"download":"upload"]:!0};r(h)},s)},kr=(r,t)=>{const s=r!=null;return[a=>t[0]({lengthComputable:s,total:r,loaded:a}),t[1]]},Er=r=>(...t)=>d.asap(()=>r(...t)),Ja=L.hasStandardBrowserEnv?((r,t)=>s=>(s=new URL(s,L.origin),r.protocol===s.protocol&&r.host===s.host&&(t||r.port===s.port)))(new URL(L.origin),L.navigator&&/(msie|trident)/i.test(L.navigator.userAgent)):()=>!0,Ka=L.hasStandardBrowserEnv?{write(r,t,s,a,n,i,o){if(typeof document>"u")return;const l=[`${r}=${encodeURIComponent(t)}`];d.isNumber(s)&&l.push(`expires=${new Date(s).toUTCString()}`),d.isString(a)&&l.push(`path=${a}`),d.isString(n)&&l.push(`domain=${n}`),i===!0&&l.push("secure"),d.isString(o)&&l.push(`SameSite=${o}`),document.cookie=l.join("; ")},read(r){if(typeof document>"u")return null;const t=document.cookie.split(";");for(let s=0;s<t.length;s++){const a=t[s].replace(/^\s+/,""),n=a.indexOf("=");if(n!==-1&&a.slice(0,n)===r)return decodeURIComponent(a.slice(n+1))}return null},remove(r){this.write(r,"",Date.now()-864e5,"/")}}:{write(){},read(){return null},remove(){}};function Ya(r){return typeof r!="string"?!1:/^([a-z][a-z\d+\-.]*:)?\/\//i.test(r)}function Xa(r,t){return t?r.replace(/\/?\/$/,"")+"/"+t.replace(/^\/+/,""):r}function dt(r,t,s){let a=!Ya(t);return r&&(a||s===!1)?Xa(r,t):t}const Or=r=>r instanceof P?{...r}:r;function ne(r,t){t=t||{};const s=Object.create(null);Object.defineProperty(s,"hasOwnProperty",{__proto__:null,value:Object.prototype.hasOwnProperty,enumerable:!1,writable:!0,configurable:!0});function a(u,m,h,y){return d.isPlainObject(u)&&d.isPlainObject(m)?d.merge.call({caseless:y},u,m):d.isPlainObject(m)?d.merge({},m):d.isArray(m)?m.slice():m}function n(u,m,h,y){if(d.isUndefined(m)){if(!d.isUndefined(u))return a(void 0,u,h,y)}else return a(u,m,h,y)}function i(u,m){if(!d.isUndefined(m))return a(void 0,m)}function o(u,m){if(d.isUndefined(m)){if(!d.isUndefined(u))return a(void 0,u)}else return a(void 0,m)}function l(u,m,h){if(d.hasOwnProp(t,h))return a(u,m);if(d.hasOwnProp(r,h))return a(void 0,u)}const c={url:i,method:i,data:i,baseURL:o,transformRequest:o,transformResponse:o,paramsSerializer:o,timeout:o,timeoutMessage:o,withCredentials:o,withXSRFToken:o,adapter:o,responseType:o,xsrfCookieName:o,xsrfHeaderName:o,onUploadProgress:o,onDownloadProgress:o,decompress:o,maxContentLength:o,maxBodyLength:o,beforeRedirect:o,transport:o,httpAgent:o,httpsAgent:o,cancelToken:o,socketPath:o,allowedSocketPaths:o,responseEncoding:o,validateStatus:l,headers:(u,m,h)=>n(Or(u),Or(m),h,!0)};return d.forEach(Object.keys({...r,...t}),function(m){if(m==="__proto__"||m==="constructor"||m==="prototype")return;const h=d.hasOwnProp(c,m)?c[m]:n,y=d.hasOwnProp(r,m)?r[m]:void 0,f=d.hasOwnProp(t,m)?t[m]:void 0,b=h(y,f,m);d.isUndefined(b)&&h!==l||(s[m]=b)}),s}const Qa=["content-type","content-length"];function Za(r,t,s){if(s!=="content-only"){r.set(t);return}Object.entries(t).forEach(([a,n])=>{Qa.includes(a.toLowerCase())&&r.set(a,n)})}const en=r=>encodeURIComponent(r).replace(/%([0-9A-F]{2})/gi,(t,s)=>String.fromCharCode(parseInt(s,16))),mt=r=>{const t=ne({},r),s=y=>d.hasOwnProp(t,y)?t[y]:void 0,a=s("data");let n=s("withXSRFToken");const i=s("xsrfHeaderName"),o=s("xsrfCookieName");let l=s("headers");const c=s("auth"),u=s("baseURL"),m=s("allowAbsoluteUrls"),h=s("url");if(t.headers=l=P.from(l),t.url=ot(dt(u,h,m),r.params,r.paramsSerializer),c&&l.set("Authorization","Basic "+btoa((c.username||"")+":"+(c.password?en(c.password):""))),d.isFormData(a)&&(L.hasStandardBrowserEnv||L.hasStandardBrowserWebWorkerEnv?l.setContentType(void 0):d.isFunction(a.getHeaders)&&Za(l,a.getHeaders(),s("formDataHeaderPolicy"))),L.hasStandardBrowserEnv&&(d.isFunction(n)&&(n=n(t)),n===!0||n==null&&Ja(t.url))){const f=i&&o&&Ka.read(o);f&&l.set(i,f)}return t},rn=typeof XMLHttpRequest<"u",tn=rn&&function(r){return new Promise(function(s,a){const n=mt(r);let i=n.data;const o=P.from(n.headers).normalize();let{responseType:l,onUploadProgress:c,onDownloadProgress:u}=n,m,h,y,f,b;function x(){f&&f(),b&&b(),n.cancelToken&&n.cancelToken.unsubscribe(m),n.signal&&n.signal.removeEventListener("abort",m)}let g=new XMLHttpRequest;g.open(n.method.toUpperCase(),n.url,!0),g.timeout=n.timeout;function A(){if(!g)return;const p=P.from("getAllResponseHeaders"in g&&g.getAllResponseHeaders()),_={data:!l||l==="text"||l==="json"?g.responseText:g.response,status:g.status,statusText:g.statusText,headers:p,config:r,request:g};ut(function(Z){s(Z),x()},function(Z){a(Z),x()},_),g=null}"onloadend"in g?g.onloadend=A:g.onreadystatechange=function(){!g||g.readyState!==4||g.status===0&&!(g.responseURL&&g.responseURL.startsWith("file:"))||setTimeout(A)},g.onabort=function(){g&&(a(new w("Request aborted",w.ECONNABORTED,r,g)),x(),g=null)},g.onerror=function(j){const _=j&&j.message?j.message:"Network Error",E=new w(_,w.ERR_NETWORK,r,g);E.event=j||null,a(E),x(),g=null},g.ontimeout=function(){let j=n.timeout?"timeout of "+n.timeout+"ms exceeded":"timeout exceeded";const _=n.transitional||dr;n.timeoutErrorMessage&&(j=n.timeoutErrorMessage),a(new w(j,_.clarifyTimeoutError?w.ETIMEDOUT:w.ECONNABORTED,r,g)),x(),g=null},i===void 0&&o.setContentType(null),"setRequestHeader"in g&&d.forEach(st(o),function(j,_){g.setRequestHeader(_,j)}),d.isUndefined(n.withCredentials)||(g.withCredentials=!!n.withCredentials),l&&l!=="json"&&(g.responseType=n.responseType),u&&([y,b]=Pe(u,!0),g.addEventListener("progress",y)),c&&g.upload&&([h,f]=Pe(c),g.upload.addEventListener("progress",h),g.upload.addEventListener("loadend",f)),(n.cancelToken||n.signal)&&(m=p=>{g&&(a(!p||p.type?new ye(null,r,g):p),g.abort(),x(),g=null)},n.cancelToken&&n.cancelToken.subscribe(m),n.signal&&(n.signal.aborted?m():n.signal.addEventListener("abort",m)));const N=$a(n.url);if(N&&!L.protocols.includes(N)){a(new w("Unsupported protocol "+N+":",w.ERR_BAD_REQUEST,r));return}g.send(i||null)})},sn=(r,t)=>{if(r=r?r.filter(Boolean):[],!t&&!r.length)return;const s=new AbortController;let a=!1;const n=function(c){if(!a){a=!0,o();const u=c instanceof Error?c:this.reason;s.abort(u instanceof w?u:new ye(u instanceof Error?u.message:u))}};let i=t&&setTimeout(()=>{i=null,n(new w(`timeout of ${t}ms exceeded`,w.ETIMEDOUT))},t);const o=()=>{r&&(i&&clearTimeout(i),i=null,r.forEach(c=>{c.unsubscribe?c.unsubscribe(n):c.removeEventListener("abort",n)}),r=null)};r.forEach(c=>c.addEventListener("abort",n));const{signal:l}=s;return l.unsubscribe=()=>d.asap(o),l},an=function*(r,t){let s=r.byteLength;if(s<t){yield r;return}let a=0,n;for(;a<s;)n=a+t,yield r.slice(a,n),a=n},nn=async function*(r,t){for await(const s of on(r))yield*an(s,t)},on=async function*(r){if(r[Symbol.asyncIterator]){yield*r;return}const t=r.getReader();try{for(;;){const{done:s,value:a}=await t.read();if(s)break;yield a}}finally{await t.cancel()}},qr=(r,t,s,a)=>{const n=nn(r,t);let i=0,o,l=c=>{o||(o=!0,a&&a(c))};return new ReadableStream({async pull(c){try{const{done:u,value:m}=await n.next();if(u){l(),c.close();return}let h=m.byteLength;if(s){let y=i+=h;s(y)}c.enqueue(new Uint8Array(m))}catch(u){throw l(u),u}},cancel(c){return l(c),n.return()}},{highWaterMark:2})};function ln(r){if(!r||typeof r!="string"||!r.startsWith("data:"))return 0;const t=r.indexOf(",");if(t<0)return 0;const s=r.slice(5,t),a=r.slice(t+1);if(/;base64/i.test(s)){let o=a.length;const l=a.length;for(let f=0;f<l;f++)if(a.charCodeAt(f)===37&&f+2<l){const b=a.charCodeAt(f+1),x=a.charCodeAt(f+2);(b>=48&&b<=57||b>=65&&b<=70||b>=97&&b<=102)&&(x>=48&&x<=57||x>=65&&x<=70||x>=97&&x<=102)&&(o-=2,f+=2)}let c=0,u=l-1;const m=f=>f>=2&&a.charCodeAt(f-2)===37&&a.charCodeAt(f-1)===51&&(a.charCodeAt(f)===68||a.charCodeAt(f)===100);u>=0&&(a.charCodeAt(u)===61?(c++,u--):m(u)&&(c++,u-=3)),c===1&&u>=0&&(a.charCodeAt(u)===61||m(u))&&c++;const y=Math.floor(o/4)*3-(c||0);return y>0?y:0}if(typeof Buffer<"u"&&typeof Buffer.byteLength=="function")return Buffer.byteLength(a,"utf8");let i=0;for(let o=0,l=a.length;o<l;o++){const c=a.charCodeAt(o);if(c<128)i+=1;else if(c<2048)i+=2;else if(c>=55296&&c<=56319&&o+1<l){const u=a.charCodeAt(o+1);u>=56320&&u<=57343?(i+=4,o++):i+=3}else i+=3}return i}const pr="1.16.1",Rr=64*1024,{isFunction:Ce}=d,Lr=(r,...t)=>{try{return!!r(...t)}catch{return!1}},cn=r=>{const t=d.global!==void 0&&d.global!==null?d.global:globalThis,{ReadableStream:s,TextEncoder:a}=t;r=d.merge.call({skipUndefined:!0},{Request:t.Request,Response:t.Response},r);const{fetch:n,Request:i,Response:o}=r,l=n?Ce(n):typeof fetch=="function",c=Ce(i),u=Ce(o);if(!l)return!1;const m=l&&Ce(s),h=l&&(typeof a=="function"?(A=>N=>A.encode(N))(new a):async A=>new Uint8Array(await new i(A).arrayBuffer())),y=c&&m&&Lr(()=>{let A=!1;const N=new i(L.origin,{body:new s,method:"POST",get duplex(){return A=!0,"half"}}),p=N.headers.has("Content-Type");return N.body!=null&&N.body.cancel(),A&&!p}),f=u&&m&&Lr(()=>d.isReadableStream(new o("").body)),b={stream:f&&(A=>A.body)};l&&["text","arrayBuffer","blob","formData","stream"].forEach(A=>{!b[A]&&(b[A]=(N,p)=>{let j=N&&N[A];if(j)return j.call(N);throw new w(`Response type '${A}' is not supported`,w.ERR_NOT_SUPPORT,p)})});const x=async A=>{if(A==null)return 0;if(d.isBlob(A))return A.size;if(d.isSpecCompliantForm(A))return(await new i(L.origin,{method:"POST",body:A}).arrayBuffer()).byteLength;if(d.isArrayBufferView(A)||d.isArrayBuffer(A))return A.byteLength;if(d.isURLSearchParams(A)&&(A=A+""),d.isString(A))return(await h(A)).byteLength},g=async(A,N)=>{const p=d.toFiniteNumber(A.getContentLength());return p??x(N)};return async A=>{let{url:N,method:p,data:j,signal:_,cancelToken:E,timeout:Z,onDownloadProgress:$e,onUploadProgress:gr,responseType:H,headers:ee,withCredentials:Ae="same-origin",fetchOptions:br,maxContentLength:z,maxBodyLength:He}=mt(A);const me=d.isNumber(z)&&z>-1,Nt=d.isNumber(He)&&He>-1;let vr=n||fetch;H=H?(H+"").toLowerCase():"text";let V=sn([_,E&&E.toAbortSignal()],Z),I=null;const re=V&&V.unsubscribe&&(()=>{V.unsubscribe()});let xr;try{if(me&&typeof N=="string"&&N.startsWith("data:")&&ln(N)>z)throw new w("maxContentLength size of "+z+" exceeded",w.ERR_BAD_RESPONSE,A,I);if(Nt&&p!=="get"&&p!=="head"){const k=await g(ee,j);if(typeof k=="number"&&isFinite(k)&&k>He)throw new w("Request body larger than maxBodyLength limit",w.ERR_BAD_REQUEST,A,I)}if(gr&&y&&p!=="get"&&p!=="head"&&(xr=await g(ee,j))!==0){let k=new i(N,{method:"POST",body:j,duplex:"half"}),oe;if(d.isFormData(j)&&(oe=k.headers.get("content-type"))&&ee.setContentType(oe),k.body){const[we,Ne]=kr(xr,Pe(Er(gr)));j=qr(k.body,Rr,we,Ne)}}d.isString(Ae)||(Ae=Ae?"include":"omit");const R=c&&"credentials"in i.prototype;if(d.isFormData(j)){const k=ee.getContentType();k&&/^multipart\/form-data/i.test(k)&&!/boundary=/i.test(k)&&ee.delete("content-type")}ee.set("User-Agent","axios/"+pr,!1);const J={...br,signal:V,method:p.toUpperCase(),headers:st(ee.normalize()),body:j,duplex:"half",credentials:R?Ae:void 0};I=c&&new i(N,J);let G=await(c?vr(I,br):vr(N,J));if(me){const k=d.toFiniteNumber(G.headers.get("content-length"));if(k!=null&&k>z)throw new w("maxContentLength size of "+z+" exceeded",w.ERR_BAD_RESPONSE,A,I)}const Ve=f&&(H==="stream"||H==="response");if(f&&G.body&&($e||me||Ve&&re)){const k={};["status","statusText","headers"].forEach(pe=>{k[pe]=G[pe]});const oe=d.toFiniteNumber(G.headers.get("content-length")),[we,Ne]=$e&&kr(oe,Pe(Er($e),!0))||[];let yr=0;const Ct=pe=>{if(me&&(yr=pe,yr>z))throw new w("maxContentLength size of "+z+" exceeded",w.ERR_BAD_RESPONSE,A,I);we&&we(pe)};G=new o(qr(G.body,Rr,Ct,()=>{Ne&&Ne(),re&&re()}),k)}H=H||"text";let W=await b[d.findKey(b,H)||"text"](G,A);if(me&&!f&&!Ve){let k;if(W!=null&&(typeof W.byteLength=="number"?k=W.byteLength:typeof W.size=="number"?k=W.size:typeof W=="string"&&(k=typeof a=="function"?new a().encode(W).byteLength:W.length)),typeof k=="number"&&k>z)throw new w("maxContentLength size of "+z+" exceeded",w.ERR_BAD_RESPONSE,A,I)}return!Ve&&re&&re(),await new Promise((k,oe)=>{ut(k,oe,{data:W,headers:P.from(G.headers),status:G.status,statusText:G.statusText,config:A,request:I})})}catch(R){if(re&&re(),V&&V.aborted&&V.reason instanceof w){const J=V.reason;throw J.config=A,I&&(J.request=I),R!==J&&(J.cause=R),J}throw R&&R.name==="TypeError"&&/Load failed|fetch/i.test(R.message)?Object.assign(new w("Network Error",w.ERR_NETWORK,A,I,R&&R.response),{cause:R.cause||R}):w.from(R,R&&R.code,A,I,R&&R.response)}}},un=new Map,pt=r=>{let t=r&&r.env||{};const{fetch:s,Request:a,Response:n}=t,i=[a,n,s];let o=i.length,l=o,c,u,m=un;for(;l--;)c=i[l],u=m.get(c),u===void 0&&m.set(c,u=l?new Map:cn(t)),m=u;return u};pt();const hr={http:ka,xhr:tn,fetch:{get:pt}};d.forEach(hr,(r,t)=>{if(r){try{Object.defineProperty(r,"name",{__proto__:null,value:t})}catch{}Object.defineProperty(r,"adapterName",{__proto__:null,value:t})}});const Pr=r=>`- ${r}`,dn=r=>d.isFunction(r)||r===null||r===!1;function mn(r,t){r=d.isArray(r)?r:[r];const{length:s}=r;let a,n;const i={};for(let o=0;o<s;o++){a=r[o];let l;if(n=a,!dn(a)&&(n=hr[(l=String(a)).toLowerCase()],n===void 0))throw new w(`Unknown adapter '${l}'`);if(n&&(d.isFunction(n)||(n=n.get(t))))break;i[l||"#"+o]=n}if(!n){const o=Object.entries(i).map(([c,u])=>`adapter ${c} `+(u===!1?"is not supported by the environment":"is not available in the build"));let l=s?o.length>1?`since :
`+o.map(Pr).join(`
`):" "+Pr(o[0]):"as no adapter specified";throw new w("There is no suitable adapter to dispatch the request "+l,"ERR_NOT_SUPPORT")}return n}const ht={getAdapter:mn,adapters:hr};function Qe(r){if(r.cancelToken&&r.cancelToken.throwIfRequested(),r.signal&&r.signal.aborted)throw new ye(null,r)}function Tr(r){return Qe(r),r.headers=P.from(r.headers),r.data=Xe.call(r,r.transformRequest),["post","put","patch"].indexOf(r.method)!==-1&&r.headers.setContentType("application/x-www-form-urlencoded",!1),ht.getAdapter(r.adapter||xe.adapter,r)(r).then(function(a){Qe(r),r.response=a;try{a.data=Xe.call(r,r.transformResponse,a)}finally{delete r.response}return a.headers=P.from(a.headers),a},function(a){if(!ct(a)&&(Qe(r),a&&a.response)){r.response=a.response;try{a.response.data=Xe.call(r,r.transformResponse,a.response)}finally{delete r.response}a.response.headers=P.from(a.response.headers)}return Promise.reject(a)})}const Ge={};["object","boolean","number","function","string","symbol"].forEach((r,t)=>{Ge[r]=function(a){return typeof a===r||"a"+(t<1?"n ":" ")+r}});const Dr={};Ge.transitional=function(t,s,a){function n(i,o){return"[Axios v"+pr+"] Transitional option '"+i+"'"+o+(a?". "+a:"")}return(i,o,l)=>{if(t===!1)throw new w(n(o," has been removed"+(s?" in "+s:"")),w.ERR_DEPRECATED);return s&&!Dr[o]&&(Dr[o]=!0,console.warn(n(o," has been deprecated since v"+s+" and will be removed in the near future"))),t?t(i,o,l):!0}};Ge.spelling=function(t){return(s,a)=>(console.warn(`${a} is likely a misspelling of ${t}`),!0)};function pn(r,t,s){if(typeof r!="object")throw new w("options must be an object",w.ERR_BAD_OPTION_VALUE);const a=Object.keys(r);let n=a.length;for(;n-- >0;){const i=a[n],o=Object.prototype.hasOwnProperty.call(t,i)?t[i]:void 0;if(o){const l=r[i],c=l===void 0||o(l,i,r);if(c!==!0)throw new w("option "+i+" must be "+c,w.ERR_BAD_OPTION_VALUE);continue}if(s!==!0)throw new w("Unknown option "+i,w.ERR_BAD_OPTION)}}const qe={assertOptions:pn,validators:Ge},B=qe.validators;let ae=class{constructor(t){this.defaults=t||{},this.interceptors={request:new Fr,response:new Fr}}async request(t,s){try{return await this._request(t,s)}catch(a){if(a instanceof Error){let n={};Error.captureStackTrace?Error.captureStackTrace(n):n=new Error;const i=(()=>{if(!n.stack)return"";const o=n.stack.indexOf(`
...
Agroforestry is one of the rare agricultural practices that simultaneously improves production, climate resilience, biodiversity, and farmer income. It is at the heart of GreenFCO's vision for sustainable agriculture in West Africa.
    `}};function Rn(){var l;const{slug:r}=_t(),{t,i18n:s}=D(),a=(l=s.language)!=null&&l.startsWith("fr")?"fr":"en",n=qn[r];if(!n)return e.jsx("main",{className:"section",children:e.jsxs("div",{className:"container",style:{textAlign:"center"},children:[e.jsx("h2",{children:a==="fr"?"Article introuvable":"Article not found"}),e.jsx(S,{to:"/blog",className:"btn btn-primary",style:{marginTop:"1rem"},children:a==="fr"?"← Retour au blog":"← Back to blog"})]})});const i=typeof window<"u"?window.location.href:"",o=n[`title_${a}`];return e.jsxs("main",{className:"blog-post-page",children:[e.jsx("div",{className:"post-hero",children:e.jsxs("div",{className:"container",children:[e.jsx(S,{to:"/blog",className:"back-link",children:"← Blog"}),e.jsxs("div",{className:"post-meta",children:[e.jsx("span",{className:"badge badge-green",children:n.category}),e.jsx("span",{className:"post-date",children:new Date(n.date).toLocaleDateString(a==="fr"?"fr-FR":"en-US",{year:"numeric",month:"long",day:"numeric"})}),e.jsxs("span",{className:"post-read-time",children:["⏱ ",n.readTime]})]}),e.jsx("h1",{children:n[`title_${a}`]})]})}),e.jsxs("div",{className:"container post-layout",children:[e.jsxs("article",{className:"post-content",children:[e.jsx("div",{className:"post-image img-placeholder",style:{height:"400px",marginBottom:"2.5rem"},children:e.jsx("span",{children:a==="fr"?"Photo interview / GreenFCO — 1200×500px":"Interview photo / GreenFCO — 1200×500px"})}),e.jsx("div",{className:"prose",dangerouslySetInnerHTML:{__html:Ln(n[`body_${a}`])}})]}),e.jsxs("aside",{className:"post-sidebar",children:[e.jsxs("div",{className:"card author-bio-card",children:[e.jsx("div",{className:"author-avatar",style:{width:"64px",height:"64px",fontSize:"1.5rem",margin:"0 0 1rem"},children:n.author.charAt(0)}),e.jsx("h4",{children:n.author}),e.jsx("p",{children:a==="fr"?"Co-fondateur & Expert Agro-Environnemental, GreenFCO":"Co-founder & Agro-Environmental Expert, GreenFCO"}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.4rem",marginTop:"0.75rem"},children:[e.jsx("span",{className:"badge badge-green",children:"🏅 Mandela Washington Fellow 2023"}),e.jsx("span",{className:"badge badge-green",children:"🔬 Humboldt Fellow 2025"})]}),e.jsx("a",{href:"mailto:info@greenfco.com",className:"btn btn-secondary btn-sm",style:{marginTop:"1rem",width:"100%",textAlign:"center"},children:a==="fr"?"Contacter l'auteur":"Contact author"})]}),e.jsxs("div",{className:"card share-card",children:[e.jsx("h4",{children:a==="fr"?"Partager cet article":"Share this article"}),e.jsxs("div",{className:"share-buttons",children:[e.jsx("a",{href:`https://wa.me/?text=${encodeURIComponent(o+" "+i)}`,target:"_blank",rel:"noreferrer",className:"btn btn-whatsapp btn-sm",children:"💬 WhatsApp"}),e.jsx("a",{href:`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(i)}`,target:"_blank",rel:"noreferrer",className:"btn btn-secondary btn-sm",children:"Facebook"}),e.jsx("a",{href:`https://twitter.com/intent/tweet?text=${encodeURIComponent(o)}&url=${encodeURIComponent(i)}`,target:"_blank",rel:"noreferrer",className:"btn btn-secondary btn-sm",children:"Twitter/X"})]})]})]})]})]})}function Ln(r){return r?r.replace(/^## (.+)$/gm,"<h2>$1</h2>").replace(/^### (.+)$/gm,"<h3>$1</h3>").replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/^> (.+)$/gm,"<blockquote>$1</blockquote>").replace(/^---$/gm,'<hr style="border:none;border-top:1px solid var(--gray-light);margin:2rem 0">').replace(/^\d+\. \*\*(.+?)\*\* — (.+)$/gm,"<li><strong>$1</strong> — $2</li>").replace(/(<li>.*<\/li>\n?)+/g,"<ol>$&</ol>").replace(/\n\n/g,"</p><p>").replace(/^(?!<h|<bl|<hr|<ol|<li)(.+)$/gm,(t,s)=>s.startsWith("<")?t:`<p>${s}</p>`).replace(/<p><\/p>/g,""):""}const Wr=["Tout","Terrain","Formations","Événements","Ferme-École"],Pn=["All","Field","Training","Events","Farm School"],Tn=[{id:1,cat:"Terrain",w:600,h:400,label_fr:"Visite terrain — Burkina Faso",label_en:"Field visit — Burkina Faso"},{id:2,cat:"Formations",w:600,h:600,label_fr:"Formation agriculture durable",label_en:"Sustainable agriculture training"},{id:3,cat:"Terrain",w:800,h:500,label_fr:"Parcelles maraîchères",label_en:"Market garden plots"},{id:4,cat:"Événements",w:600,h:400,label_fr:"Forum agro-environmental",label_en:"Agro-environmental forum"},{id:5,cat:"Ferme-École",w:600,h:800,label_fr:"Ferme-école — démonstration",label_en:"Farm school — demonstration"},{id:6,cat:"Formations",w:600,h:400,label_fr:"Agriculture hors-sol workshop",label_en:"Soilless agriculture workshop"},{id:7,cat:"Terrain",w:800,h:600,label_fr:"Aménagements hydro-agricoles",label_en:"Hydro-agricultural development"},{id:8,cat:"Événements",w:600,h:400,label_fr:"Rencontre avec partenaires",label_en:"Partner meeting"},{id:9,cat:"Ferme-École",w:600,h:600,label_fr:"Formation pratique — semences",label_en:"Practical training — seeds"}];function Dn(){var f;const{t:r,i18n:t}=D(),s=(f=t.language)!=null&&f.startsWith("fr")?"fr":"en",[a,n]=v.useState(0),[i,o]=v.useState(null),[l,c]=v.useState([]);v.useEffect(()=>{fetch("/api/gallery").then(b=>b.ok?b.json():[]).then(b=>c(Array.isArray(b)?b:[])).catch(()=>{})},[]);const u=s==="fr"?Wr:Pn,h=[...l.map(b=>({id:`api-${b.id}`,cat:b.category?b.category.charAt(0).toUpperCase()+b.category.slice(1):"Terrain",w:600,h:400,label_fr:b.title_fr||b.title,label_en:b.title,image_url:b.image_url})),...Tn],y=a===0?h:h.filter(b=>b.cat===Wr[a]);return e.jsxs("main",{className:"gallery-page",children:[e.jsxs("section",{className:"page-hero",children:[e.jsx("div",{className:"page-hero-bg"}),e.jsxs("div",{className:"container",children:[e.jsx("span",{className:"eyebrow",children:s==="fr"?"Galerie":"Gallery"}),e.jsx("h1",{children:s==="fr"?"Nos Actions en Images":"Our Actions in Pictures"}),e.jsx("p",{children:s==="fr"?"Découvrez nos activités de terrain, formations, événements et ferme-école à travers ces témoignages visuels.":"Discover our field activities, training, events, and farm school through these visual testimonials."})]})]}),e.jsx("section",{className:"section",children:e.jsxs("div",{className:"container",children:[e.jsx("div",{className:"gallery-filter",children:u.map((b,x)=>e.jsx("button",{className:`filter-btn ${a===x?"active":""}`,onClick:()=>n(x),children:b},b))}),e.jsx("div",{className:"masonry-grid",children:y.map((b,x)=>e.jsxs("div",{className:"masonry-item",style:{animationDelay:`${x*.05}s`},onClick:()=>o(b),children:[b.image_url?e.jsx("img",{src:b.image_url,alt:s==="fr"?b.label_fr:b.label_en,className:"gallery-img gallery-real-img",style:{width:"100%",display:"block",borderRadius:"inherit"},loading:"lazy"}):e.jsx("div",{className:"img-placeholder gallery-img",style:{paddingBottom:`${b.h/b.w*100}%`},children:e.jsx("span",{className:"gallery-label",children:s==="fr"?b.label_fr:b.label_en})}),e.jsxs("div",{className:"gallery-overlay",children:[e.jsx("span",{className:"gallery-zoom",children:"🔍"}),e.jsx("p",{children:s==="fr"?b.label_fr:b.label_en})]})]},b.id))}),e.jsxs("div",{className:"video-section",style:{marginTop:"4rem"},children:[e.jsx("h2",{style:{textAlign:"center",marginBottom:"2rem"},children:s==="fr"?"Vidéos":"Videos"}),e.jsxs("div",{className:"grid-2",children:[e.jsx("div",{className:"video-placeholder",children:e.jsx("div",{className:"img-placeholder",style:{height:"220px"},children:e.jsxs("span",{children:["🎬 ",s==="fr"?"Vidéo présentation GreenFCO — YouTube/Vimeo":"GreenFCO presentation video — YouTube/Vimeo"]})})}),e.jsx("div",{className:"video-placeholder",children:e.jsx("div",{className:"img-placeholder",style:{height:"220px"},children:e.jsxs("span",{children:["🎬 ",s==="fr"?"Vidéo terrain — Formation agroécologie":"Field video — Agroecology training"]})})})]})]})]})}),i&&e.jsx("div",{className:"lightbox",onClick:()=>o(null),children:e.jsxs("div",{className:"lightbox-content",onClick:b=>b.stopPropagation(),children:[e.jsx("button",{className:"lightbox-close",onClick:()=>o(null),children:"✕"}),i.image_url?e.jsx("img",{src:i.image_url,alt:s==="fr"?i.label_fr:i.label_en,style:{width:"100%",maxHeight:"70vh",objectFit:"contain",borderRadius:"8px",display:"block"}}):e.jsx("div",{className:"img-placeholder",style:{width:"100%",height:"400px"},children:e.jsx("span",{children:s==="fr"?i.label_fr:i.label_en})}),e.jsx("p",{className:"lightbox-caption",children:s==="fr"?i.label_fr:i.label_en})]})})]})}function $r(r,t){document.title=r;const s=document.querySelector('meta[name="description"]');s&&s.setAttribute("content",t)}function In(){var h;const{t:r,i18n:t}=D(),s=(h=t.language)!=null&&h.startsWith("fr")?"fr":"en",[a,n]=v.useState({name:"",email:"",subject:"",message:"",country:""}),[i,o]=v.useState(null),[l,c]=v.useState(!1);v.useEffect(()=>{s==="fr"?$r("Contact | GreenFCO — Parlons de Votre Projet Agricole","Contactez GreenFCO pour discuter de votre projet agro-environnemental. Notre équipe d'experts est basée à Ouagadougou, Burkina Faso et disponible du lundi au vendredi."):$r("Contact | GreenFCO — Let's Talk About Your Agricultural Project","Contact GreenFCO to discuss your agro-environmental project. Our team of experts is based in Ouagadougou, Burkina Faso and available Monday to Friday.")},[s]);function u(y){n(f=>({...f,[y.target.name]:y.target.value}))}async function m(y){y.preventDefault(),c(!0);try{await ie.post("/contact",a),o("success"),n({name:"",email:"",subject:"",message:"",country:""})}catch{o("error")}finally{c(!1)}}return e.jsxs("main",{className:"contact-page",children:[e.jsxs("section",{className:"page-hero",children:[e.jsx("div",{className:"page-hero-bg"}),e.jsxs("div",{className:"container",children:[e.jsx("span",{className:"eyebrow",children:r("contact.title")}),e.jsx("h1",{children:s==="fr"?"Parlons de Votre Projet":"Let's Talk About Your Project"}),e.jsx("p",{children:r("contact.subtitle")})]})]}),e.jsx("section",{className:"section",children:e.jsxs("div",{className:"container contact-layout",children:[e.jsxs("div",{className:"contact-info",children:[e.jsxs("div",{className:"info-block card",children:[e.jsx("div",{className:"info-icon",children:"📍"}),e.jsx("h3",{children:s==="fr"?"Adresse":"Address"}),e.jsx("p",{children:"Ouagadougou, Burkina Faso"}),e.jsx("p",{children:s==="fr"?"Afrique de l'Ouest":"West Africa"})]}),e.jsxs("div",{className:"info-block card",children:[e.jsx("div",{className:"info-icon",children:"✉️"}),e.jsx("h3",{children:"Email"}),e.jsx("a",{href:"mailto:info@greenfco.com",children:"info@greenfco.com"})]}),e.jsxs("div",{className:"info-block card whatsapp-block",children:[e.jsx("div",{className:"info-icon",children:"💬"}),e.jsx("h3",{children:"WhatsApp"}),e.jsx("p",{children:s==="fr"?"Canal de communication privilégié":"Preferred communication channel"}),e.jsxs("a",{href:"https://wa.me/22600000000",target:"_blank",rel:"noreferrer",className:"btn btn-whatsapp",children:["💬 ",r("contact.whatsapp")]})]}),e.jsxs("div",{className:"info-block card",children:[e.jsx("div",{className:"info-icon",children:"🕐"}),e.jsx("h3",{children:s==="fr"?"Disponibilité":"Availability"}),e.jsx("p",{children:s==="fr"?"Lundi – Vendredi : 8h00 – 18h00 (GMT+0)":"Monday – Friday: 8:00 AM – 6:00 PM (GMT+0)"})]}),e.jsxs("div",{className:"map-placeholder",children:[e.jsx("div",{className:"img-placeholder",style:{height:"250px",borderRadius:"var(--radius-lg)"},children:e.jsxs("span",{children:["🗺️ ",s==="fr"?"Carte — Ouagadougou, Burkina Faso":"Map — Ouagadougou, Burkina Faso"]})}),e.jsx("p",{style:{fontSize:"0.82rem",color:"var(--gray-mid)",marginTop:"0.5rem",textAlign:"center"},children:"Ouagadougou, Burkina Faso · +226 XX XX XX XX"})]})]}),e.jsx("div",{className:"contact-form-section",children:e.jsxs("div",{className:"card",style:{padding:"2.5rem"},children:[e.jsx("h2",{style:{marginBottom:"0.5rem"},children:s==="fr"?"Envoyez-nous un message":"Send us a message"}),e.jsx("p",{style:{color:"var(--gray-mid)",fontSize:"0.9rem",marginBottom:"2rem"},children:s==="fr"?"Nous vous répondons sous 24-48h (jours ouvrés).":"We respond within 24-48h (business days)."}),i==="success"&&e.jsxs("div",{className:"form-success",children:["✅ ",r("contact.success")]}),i==="error"&&e.jsxs("div",{className:"form-error",children:["❌ ",r("contact.error")]}),e.jsxs("form",{onSubmit:m,children:[e.jsxs("div",{className:"grid-2",children:[e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("contact.form_name")," *"]}),e.jsx("input",{type:"text",name:"name",className:"form-input",value:a.name,onChange:u,required:!0,placeholder:s==="fr"?"Votre nom complet":"Your full name"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:r("contact.form_country")}),e.jsx("input",{type:"text",name:"country",className:"form-input",value:a.country,onChange:u,placeholder:"Burkina Faso"})]})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("contact.form_email")," *"]}),e.jsx("input",{type:"email",name:"email",className:"form-input",value:a.email,onChange:u,required:!0,placeholder:"example@email.com"})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("contact.form_subject")," *"]}),e.jsx("input",{type:"text",name:"subject",className:"form-input",value:a.subject,onChange:u,required:!0,placeholder:s==="fr"?"Sujet de votre message":"Subject of your message"})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("contact.form_message")," *"]}),e.jsx("textarea",{name:"message",className:"form-input",value:a.message,onChange:u,required:!0,rows:6,placeholder:s==="fr"?"Décrivez votre projet ou votre demande...":"Describe your project or request..."})]}),e.jsx("button",{type:"submit",className:"btn btn-primary",disabled:l,style:{width:"100%"},children:l?s==="fr"?"Envoi...":"Sending...":r("contact.form_submit")})]})]})})]})})]})}const Bn=r=>ie.post("/auth/login",r),Mn=r=>ie.post("/auth/register",r),zn=r=>ie.post("/auth/forgot-password",{email:r});function Gn(){var y;const{t:r,i18n:t}=D(),s=(y=t.language)!=null&&y.startsWith("fr")?"fr":"en",a=Jr(),n=ue(f=>f.setAuth),[i,o]=v.useState({email:"",password:""}),[l,c]=v.useState(""),[u,m]=v.useState(!1);async function h(f){var b,x;f.preventDefault(),m(!0),c("");try{const g=await Bn(i);n(g.data.user,g.data.token),a("/dashboard")}catch(g){c(((x=(b=g.response)==null?void 0:b.data)==null?void 0:x.message)||(s==="fr"?"Identifiants incorrects.":"Invalid credentials."))}finally{m(!1)}}return e.jsxs("div",{className:"auth-page",children:[e.jsxs("div",{className:"auth-side auth-side-brand",children:[e.jsxs(S,{to:"/",className:"auth-logo",children:["🌿 ",e.jsx("span",{children:"Green"}),"FCO"]}),e.jsxs("div",{className:"auth-brand-content",children:[e.jsx("h2",{children:s==="fr"?"Bienvenue sur GreenFCO":"Welcome to GreenFCO"}),e.jsx("p",{children:s==="fr"?"Votre plateforme agro-environnementale pour une agriculture durable en Afrique francophone.":"Your agro-environmental platform for sustainable agriculture in Francophone Africa."}),e.jsx("div",{className:"auth-brand-features",children:["🌱 Gestion de cultures","💧 Irrigation intelligente","🤖 Conseiller IA","🛒 Marché numérique"].map(f=>e.jsx("div",{className:"auth-feature",children:f},f))})]}),e.jsx("p",{className:"auth-slogan",children:'"Cultiver un avenir durable, ensemble."'})]}),e.jsx("div",{className:"auth-side auth-side-form",children:e.jsxs("div",{className:"auth-form-container",children:[e.jsx("h1",{children:r("auth.login_title")}),e.jsxs("p",{className:"auth-subtitle",children:[r("auth.no_account")," ",e.jsx(S,{to:"/register",children:r("nav.register")})]}),l&&e.jsx("div",{className:"auth-error",children:l}),e.jsxs("form",{onSubmit:h,children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:r("auth.email")}),e.jsx("input",{type:"email",className:"form-input",value:i.email,onChange:f=>o(b=>({...b,email:f.target.value})),required:!0,placeholder:"example@email.com"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:r("auth.password")}),e.jsx("input",{type:"password",className:"form-input",value:i.password,onChange:f=>o(b=>({...b,password:f.target.value})),required:!0,placeholder:"••••••••"})]}),e.jsx("div",{className:"auth-forgot",children:e.jsx(S,{to:"/forgot-password",children:r("auth.forgot_password")})}),e.jsx("button",{type:"submit",className:"btn btn-primary auth-submit",disabled:u,children:u?s==="fr"?"Connexion...":"Signing in...":r("auth.login_btn")})]})]})})]})}const Un=["farmer","expert","investor","organization"];function Wn(){var A;const{t:r,i18n:t}=D(),s=(A=t.language)!=null&&A.startsWith("fr")?"fr":"en",a=Jr(),n=ue(N=>N.setAuth),[i,o]=v.useState({name:"",email:"",password:"",confirm_password:"",country:"",user_type:"farmer",language:s}),[l,c]=v.useState("buyer"),[u,m]=v.useState(""),[h,y]=v.useState(""),[f,b]=v.useState(!1);function x(N){o(p=>({...p,[N.target.name]:N.target.value}))}async function g(N){var p,j;if(N.preventDefault(),i.password!==i.confirm_password){y(s==="fr"?"Les mots de passe ne correspondent pas.":"Passwords do not match.");return}if(b(!0),y(""),l==="seller"){const E={...(()=>{try{return JSON.parse(localStorage.getItem("greenfco_seller_profile"))||{}}catch{return{}}})(),location:u,memberSince:new Date().getFullYear().toString()};localStorage.setItem("greenfco_seller_profile",JSON.stringify(E))}try{const _=await Mn({...i,market_role:l});n(_.data.user,_.data.token),a("/dashboard")}catch(_){y(((j=(p=_.response)==null?void 0:p.data)==null?void 0:j.message)||(s==="fr"?"Erreur lors de la création du compte.":"Account creation failed."))}finally{b(!1)}}return e.jsxs("div",{className:"auth-page",children:[e.jsxs("div",{className:"auth-side auth-side-brand",children:[e.jsxs(S,{to:"/",className:"auth-logo",children:["🌿 ",e.jsx("span",{children:"Green"}),"FCO"]}),e.jsxs("div",{className:"auth-brand-content",children:[e.jsx("h2",{children:s==="fr"?"Rejoignez la communauté":"Join the community"}),e.jsx("p",{children:s==="fr"?"Agriculteurs, experts, investisseurs, organisations — GreenFCO rassemble tous les acteurs de l'agro-environnement.":"Farmers, experts, investors, organizations — GreenFCO brings together all agro-environmental actors."}),e.jsx("div",{className:"auth-brand-features",children:(s==="fr"?["🌱 Agriculteur / Agripreneur","🔬 Expert / Consultant","💼 Investisseur","🏢 Organisation / ONG"]:["🌱 Farmer / Agripreneur","🔬 Expert / Consultant","💼 Investor","🏢 Organization / NGO"]).map(N=>e.jsx("div",{className:"auth-feature",children:N},N))})]}),e.jsx("p",{className:"auth-slogan",children:'"Cultiver un avenir durable, ensemble."'})]}),e.jsx("div",{className:"auth-side auth-side-form",children:e.jsxs("div",{className:"auth-form-container",children:[e.jsx("h1",{children:r("auth.register_title")}),e.jsxs("p",{className:"auth-subtitle",children:[r("auth.have_account")," ",e.jsx(S,{to:"/login",children:r("nav.login")})]}),h&&e.jsx("div",{className:"auth-error",children:h}),e.jsxs("form",{onSubmit:g,children:[e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("auth.name")," *"]}),e.jsx("input",{type:"text",name:"name",className:"form-input",value:i.name,onChange:x,required:!0,placeholder:"Jean Ouédraogo"})]}),e.jsxs("div",{className:"grid-2",children:[e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("auth.email")," *"]}),e.jsx("input",{type:"email",name:"email",className:"form-input",value:i.email,onChange:x,required:!0,placeholder:"jean@email.com"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:r("auth.country")}),e.jsx("input",{type:"text",name:"country",className:"form-input",value:i.country,onChange:x,placeholder:"Burkina Faso"})]})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("auth.user_type")," *"]}),e.jsx("select",{name:"user_type",className:"form-select",value:i.user_type,onChange:x,children:Un.map(N=>e.jsx("option",{value:N,children:r(`auth.${N}`)},N))})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[s==="fr"?"Je souhaite utiliser la plateforme comme":"I want to use the platform as"," *"]}),e.jsxs("select",{className:"form-select",value:l,onChange:N=>c(N.target.value),children:[e.jsx("option",{value:"buyer",children:s==="fr"?"Acheteur (je cherche des produits)":"Buyer (I look for products)"}),e.jsx("option",{value:"seller",children:s==="fr"?"Vendeur (je vends des produits)":"Seller (I sell products)"})]})]}),l==="seller"&&e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:s==="fr"?"Localisation (ville / région) *":"Location (city / region) *"}),e.jsx("input",{type:"text",className:"form-input",value:u,onChange:N=>m(N.target.value),placeholder:s==="fr"?"Ex : Ouagadougou, Plateau Central":"E.g. Ouagadougou, Plateau Central",required:!0})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:r("auth.language_pref")}),e.jsxs("select",{name:"language",className:"form-select",value:i.language,onChange:x,children:[e.jsx("option",{value:"fr",children:"Français"}),e.jsx("option",{value:"en",children:"English"})]})]}),e.jsxs("div",{className:"grid-2",children:[e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("auth.password")," *"]}),e.jsx("input",{type:"password",name:"password",className:"form-input",value:i.password,onChange:x,required:!0,placeholder:"••••••••",minLength:8})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("auth.confirm_password")," *"]}),e.jsx("input",{type:"password",name:"confirm_password",className:"form-input",value:i.confirm_password,onChange:x,required:!0,placeholder:"••••••••"})]})]}),e.jsx("button",{type:"submit",className:"btn btn-primary auth-submit",disabled:f,children:f?s==="fr"?"Création...":"Creating...":r("auth.register_btn")})]})]})})]})}function $n(){var u;const{i18n:r}=D(),t=(u=r.language)!=null&&u.startsWith("fr")?"fr":"en",[s,a]=v.useState(""),[n,i]=v.useState(!1),[o,l]=v.useState(!1);async function c(m){m.preventDefault(),l(!0);try{await zn(s)}finally{i(!0),l(!1)}}return e.jsxs("div",{className:"auth-page",children:[e.jsxs("div",{className:"auth-side auth-side-brand",children:[e.jsxs(S,{to:"/",className:"auth-logo",children:["🌿 ",e.jsx("span",{children:"Green"}),"FCO"]}),e.jsxs("div",{className:"auth-brand-content",children:[e.jsx("h2",{children:t==="fr"?"Réinitialisation":"Password Reset"}),e.jsx("p",{children:t==="fr"?"Nous vous enverrons un lien de réinitialisation par e-mail.":"We'll send you a reset link by email."})]}),e.jsx("p",{className:"auth-slogan",children:'"Cultiver un avenir durable, ensemble."'})]}),e.jsx("div",{className:"auth-side auth-side-form",children:e.jsxs("div",{className:"auth-form-container",children:[e.jsx("h1",{children:t==="fr"?"Mot de passe oublié ?":"Forgot password?"}),e.jsx("p",{className:"auth-subtitle",children:e.jsxs(S,{to:"/login",children:["← ",t==="fr"?"Retour à la connexion":"Back to sign in"]})}),n?e.jsxs("div",{className:"form-success",style:{padding:"1.25rem",background:"var(--green-pale)",borderRadius:"var(--radius-md)",color:"var(--green-deep)"},children:["✅ ",t==="fr"?"Si un compte existe avec cet e-mail, vous recevrez un lien de réinitialisation sous peu.":"If an account exists with this email, you will receive a reset link shortly."]}):e.jsxs("form",{onSubmit:c,children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:t==="fr"?"Adresse e-mail":"Email address"}),e.jsx("input",{type:"email",className:"form-input",value:s,onChange:m=>a(m.target.value),required:!0,placeholder:"example@email.com"})]}),e.jsx("button",{type:"submit",className:"btn btn-primary auth-submit",disabled:o,children:o?"...":t==="fr"?"Envoyer le lien":"Send reset link"})]})]})})]})}const Hn=v.lazy(()=>F(()=>import("./AdminLayout-CRgMPIrW.js"),__vite__mapDeps([0,1,2,3]))),Vn=v.lazy(()=>F(()=>import("./AdminDashboard-Bfm5Jbot.js"),__vite__mapDeps([4,1,5,6]))),Jn=v.lazy(()=>F(()=>import("./AdminUsers-n0qycMXb.js"),__vite__mapDeps([7,1,5,6]))),Kn=v.lazy(()=>F(()=>import("./AdminListings-DEAtGMFc.js"),__vite__mapDeps([8,1,5,6]))),Yn=v.lazy(()=>F(()=>import("./AdminBlog-Bjd_qs6h.js"),__vite__mapDeps([9,1]))),Xn=v.lazy(()=>F(()=>import("./AdminConsulting-nAEVbOny.js"),__vite__mapDeps([10,1,5,6]))),Qn=v.lazy(()=>F(()=>import("./AdminGallery-CV4Ki_vr.js"),__vite__mapDeps([11,1,5,6]))),_e=v.lazy(()=>F(()=>import("./DashboardLayout-DTW5HRte.js"),__vite__mapDeps([12,1,6,13]))),Zn=v.lazy(()=>F(()=>import("./DashboardHome-DGOCm8br.js"),__vite__mapDeps([14,1,6,15]))),ei=v.lazy(()=>F(()=>import("./CropManager-PsAtA4Ex.js"),__vite__mapDeps([16,1,6,17]))),ri=v.lazy(()=>F(()=>import("./IrrigationManager-DI5P_SJd.js"),__vite__mapDeps([18,1,6,19]))),ti=v.lazy(()=>F(()=>import("./FinanceManager-DYSPFqrf.js"),__vite__mapDeps([20,1,6,21,22]))),si=v.lazy(()=>F(()=>import("./WeatherHub-QLNfJU_p.js"),__vite__mapDeps([23,1,6,21,24]))),ai=v.lazy(()=>F(()=>import("./SpeciesLibrary-atL8VbK0.js"),__vite__mapDeps([25,1,6,26]))),ni=v.lazy(()=>F(()=>import("./GreenBot-CmFJwvQA.js"),__vite__mapDeps([27,1,6,28]))),ii=v.lazy(()=>F(()=>import("./SoilAdvisor-DpDNtpLL.js"),__vite__mapDeps([29,1,6,30]))),oi=v.lazy(()=>F(()=>import("./KoobAssist-DQZOHPnf.js"),__vite__mapDeps([31,1,6,32]))),Hr=v.lazy(()=>F(()=>import("./MarketPage-CvePjo0E.js"),__vite__mapDeps([33,1,6,21,34]))),li=v.lazy(()=>F(()=>import("./SellerProfilePage-D3AYHpLi.js"),__vite__mapDeps([35,1,6,36]))),ci=v.lazy(()=>F(()=>import("./BuyerProfilePage-CgCQL6M6.js"),__vite__mapDeps([37,1,6,38]))),ui=v.lazy(()=>F(()=>import("./NetworkPage-CbXt2YNK.js"),__vite__mapDeps([39,1,6,40]))),di=v.lazy(()=>F(()=>import("./VerifyTransaction-BD0HF4eb.js"),__vite__mapDeps([41,1,42]))),mi=v.lazy(()=>F(()=>import("./AdminTransactions-8i5QPySX.js"),__vite__mapDeps([43,1]))),pi=v.lazy(()=>F(()=>import("./AdminSettings-BVcTBE6e.js"),__vite__mapDeps([44,1,2,5,6]))),hi=v.lazy(()=>F(()=>import("./AdminProjects-ZfywTB01.js"),__vite__mapDeps([45,1]))),fi=v.lazy(()=>F(()=>import("./AdminActivity-DINJIIOp.js"),__vite__mapDeps([46,1]))),gi=v.lazy(()=>F(()=>import("./AdminTeamChat-UUjbVMGY.js"),__vite__mapDeps([47,1]))),bi=v.lazy(()=>F(()=>import("./AdminLogin-CUbnFeaC.js"),__vite__mapDeps([48,1,6])));function Fe({children:r}){const{isAuthenticated:t}=ue();return t?r:e.jsx(Le,{to:"/login",replace:!0})}function vi({children:r}){const t=(()=>{try{return JSON.parse(localStorage.getItem("greenfco_admin_session"))}catch{return null}})();return t!=null&&t.verified?r:e.jsx(Le,{to:"/admin/login",replace:!0})}function K({children:r}){return e.jsxs(e.Fragment,{children:[e.jsx(js,{}),e.jsx("div",{style:{minHeight:"calc(100vh - 70px)"},children:r}),e.jsx(As,{})]})}function xi(){return e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",minHeight:"60vh"},children:e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("div",{style:{fontSize:"2rem",marginBottom:"1rem"},children:"🌿"}),e.jsx("p",{style:{color:"var(--gray-mid)"},children:"Chargement..."})]})})}function yi({title:r,icon:t}){return e.jsxs("div",{style:{textAlign:"center",padding:"4rem 2rem",color:"var(--gray-mid)"},children:[e.jsx("div",{style:{fontSize:"3rem",marginBottom:"1rem"},children:t}),e.jsx("h2",{style:{color:"var(--black)",marginBottom:"0.5rem"},children:r}),e.jsx("p",{children:"Cette fonctionnalité arrive bientôt. / This feature is coming soon."})]})}function ji(){return e.jsx(Ft,{children:e.jsx(xs,{children:e.jsx(v.Suspense,{fallback:e.jsx(xi,{}),children:e.jsxs(kt,{children:[e.jsx(C,{path:"/",element:e.jsx(K,{children:e.jsx(vn,{})})}),e.jsx(C,{path:"/about",element:e.jsx(K,{children:e.jsx(An,{})})}),e.jsx(C,{path:"/services",element:e.jsx(K,{children:e.jsx(Nn,{})})}),e.jsx(C,{path:"/consulting",element:e.jsx(K,{children:e.jsx(kn,{})})}),e.jsx(C,{path:"/blog",element:e.jsx(K,{children:e.jsx(En,{})})}),e.jsx(C,{path:"/blog/:slug",element:e.jsx(K,{children:e.jsx(Rn,{})})}),e.jsx(C,{path:"/gallery",element:e.jsx(K,{children:e.jsx(Dn,{})})}),e.jsx(C,{path:"/contact",element:e.jsx(K,{children:e.jsx(In,{})})}),e.jsx(C,{path:"/login",element:e.jsx(Gn,{})}),e.jsx(C,{path:"/register",element:e.jsx(Wn,{})}),e.jsx(C,{path:"/forgot-password",element:e.jsx($n,{})}),e.jsxs(C,{path:"/dashboard",element:e.jsx(Fe,{children:e.jsx(_e,{})}),children:[e.jsx(C,{index:!0,element:e.jsx(Zn,{})}),e.jsx(C,{path:"crops",element:e.jsx(ei,{})}),e.jsx(C,{path:"irrigation",element:e.jsx(ri,{})}),e.jsx(C,{path:"finance",element:e.jsx(ti,{})}),e.jsx(C,{path:"weather",element:e.jsx(si,{})}),e.jsx(C,{path:"species",element:e.jsx(ai,{})}),e.jsx(C,{path:"greenbot",element:e.jsx(ni,{})}),e.jsx(C,{path:"soil-advisor",element:e.jsx(ii,{})}),e.jsx(C,{path:"koob-assist",element:e.jsx(oi,{})}),e.jsx(C,{path:"map",element:e.jsx(yi,{title:"Farm Map",icon:"🗺️"})})]}),e.jsxs(C,{path:"/marketplace",element:e.jsx(Fe,{children:e.jsx(_e,{})}),children:[e.jsx(C,{index:!0,element:e.jsx(Hr,{mode:"marketplace"},"marketplace")}),e.jsx(C,{path:"profile",element:e.jsx(ci,{})})]}),e.jsxs(C,{path:"/agropro",element:e.jsx(Fe,{children:e.jsx(_e,{})}),children:[e.jsx(C,{index:!0,element:e.jsx(Hr,{mode:"agropro"},"agropro")}),e.jsx(C,{path:"profile",element:e.jsx(li,{})})]}),e.jsx(C,{path:"/verify-transaction",element:e.jsx(di,{})}),e.jsx(C,{path:"/market",element:e.jsx(Le,{to:"/marketplace",replace:!0})}),e.jsx(C,{path:"/network",element:e.jsx(Fe,{children:e.jsx(_e,{})}),children:e.jsx(C,{index:!0,element:e.jsx(ui,{})})}),e.jsx(C,{path:"/admin/login",element:e.jsx(bi,{})}),e.jsxs(C,{path:"/admin",element:e.jsx(vi,{children:e.jsx(Hn,{})}),children:[e.jsx(C,{index:!0,element:e.jsx(Vn,{})}),e.jsx(C,{path:"users",element:e.jsx(Jn,{})}),e.jsx(C,{path:"listings",element:e.jsx(Kn,{})}),e.jsx(C,{path:"blog",element:e.jsx(Yn,{})}),e.jsx(C,{path:"consulting",element:e.jsx(Xn,{})}),e.jsx(C,{path:"gallery",element:e.jsx(Qn,{})}),e.jsx(C,{path:"transactions",element:e.jsx(mi,{})}),e.jsx(C,{path:"settings",element:e.jsx(pi,{})}),e.jsx(C,{path:"projects",element:e.jsx(hi,{})}),e.jsx(C,{path:"activity",element:e.jsx(fi,{})}),e.jsx(C,{path:"messages",element:e.jsx(gi,{})})]}),e.jsx(C,{path:"*",element:e.jsx(Le,{to:"/",replace:!0})})]})})})})}let Ai={data:""},wi=r=>{if(typeof window=="object"){let t=(r?r.querySelector("#_goober"):window._goober)||Object.assign(document.createElement("style"),{innerHTML:" ",id:"_goober"});return t.nonce=window.__nonce__,t.parentNode||(r||document.head).appendChild(t),t.firstChild}return r||Ai},Ni=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,Ci=/\/\*[^]*?\*\/|  +/g,Vr=/\n+/g,X=(r,t)=>{let s="",a="",n="";for(let i in r){let o=r[i];i[0]=="@"?i[1]=="i"?s=i+" "+o+";":a+=i[1]=="f"?X(o,i):i+"{"+X(o,i[1]=="k"?"":t)+"}":typeof o=="object"?a+=X(o,t?t.replace(/([^,])+/g,l=>i.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,c=>/&/.test(c)?c.replace(/&/g,l):l?l+" "+c:c)):i):o!=null&&(i=i[1]=="-"?i:i.replace(/[A-Z]/g,"-$&").toLowerCase(),n+=X.p?X.p(i,o):i+":"+o+";")}return s+(t&&n?t+"{"+n+"}":n)+a},Y={},bt=r=>{if(typeof r=="object"){let t="";for(let s in r)t+=s+bt(r[s]);return t}return r},Si=(r,t,s,a,n)=>{let i=bt(r),o=Y[i]||(Y[i]=(c=>{let u=0,m=11;for(;u<c.length;)m=101*m+c.charCodeAt(u++)>>>0;return"go"+m})(i));if(!Y[o]){let c=i!==r?r:(u=>{let m,h,y=[{}];for(;m=Ni.exec(u.replace(Ci,""));)m[4]?y.shift():m[3]?(h=m[3].replace(Vr," ").trim(),y.unshift(y[0][h]=y[0][h]||{})):y[0][m[1]]=m[2].replace(Vr," ").trim();return y[0]})(r);Y[o]=X(n?{["@keyframes "+o]:c}:c,s?"":"."+o)}let l=s&&Y.g;return s&&(Y.g=Y[o]),((c,u,m,h)=>{h?u.data=u.data.replace(h,c):u.data.indexOf(c)===-1&&(u.data=m?c+u.data:u.data+c)})(Y[o],t,a,l),o},_i=(r,t,s)=>r.reduce((a,n,i)=>{let o=t[i];if(o&&o.call){let l=o(s),c=l&&l.props&&l.props.className||/^go/.test(l)&&l;o=c?"."+c:l&&typeof l=="object"?l.props?"":X(l,""):l===!1?"":l}return a+n+(o??"")},"");function Ue(r){let t=this||{},s=r.call?r(t.p):r;return Si(s.unshift?s.raw?_i(s,[].slice.call(arguments,1),t.p):s.reduce((a,n)=>Object.assign(a,n&&n.call?n(t.p):n),{}):s,wi(t.target),t.g,t.o,t.k)}let vt,or,lr;Ue.bind({g:1});let $=Ue.bind({k:1});function Fi(r,t,s,a){X.p=t,vt=r,or=s,lr=a}function Q(r,t){let s=this||{};return function(){let a=arguments;function n(i,o){let l=Object.assign({},i),c=l.className||n.className;s.p=Object.assign({theme:or&&or()},l),s.o=/go\d/.test(c),l.className=Ue.apply(s,a)+(c?" "+c:"");let u=r;return r[0]&&(u=l.as||r,delete l.as),lr&&u[0]&&lr(l),vt(u,l)}return n}}var ki=r=>typeof r=="function",Te=(r,t)=>ki(r)?r(t):r,Ei=(()=>{let r=0;return()=>(++r).toString()})(),xt=(()=>{let r;return()=>{if(r===void 0&&typeof window<"u"){let t=matchMedia("(prefers-reduced-motion: reduce)");r=!t||t.matches}return r}})(),Oi=20,fr="default",yt=(r,t)=>{let{toastLimit:s}=r.settings;switch(t.type){case 0:return{...r,toasts:[t.toast,...r.toasts].slice(0,s)};case 1:return{...r,toasts:r.toasts.map(o=>o.id===t.toast.id?{...o,...t.toast}:o)};case 2:let{toast:a}=t;return yt(r,{type:r.toasts.find(o=>o.id===a.id)?1:0,toast:a});case 3:let{toastId:n}=t;return{...r,toasts:r.toasts.map(o=>o.id===n||n===void 0?{...o,dismissed:!0,visible:!1}:o)};case 4:return t.toastId===void 0?{...r,toasts:[]}:{...r,toasts:r.toasts.filter(o=>o.id!==t.toastId)};case 5:return{...r,pausedAt:t.time};case 6:let i=t.time-(r.pausedAt||0);return{...r,pausedAt:void 0,toasts:r.toasts.map(o=>({...o,pauseDuration:o.pauseDuration+i}))}}},Re=[],jt={toasts:[],pausedAt:void 0,settings:{toastLimit:Oi}},U={},At=(r,t=fr)=>{U[t]=yt(U[t]||jt,r),Re.forEach(([s,a])=>{s===t&&a(U[t])})},wt=r=>Object.keys(U).forEach(t=>At(r,t)),qi=r=>Object.keys(U).find(t=>U[t].toasts.some(s=>s.id===r)),We=(r=fr)=>t=>{At(t,r)},Ri={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},Li=(r={},t=fr)=>{let[s,a]=v.useState(U[t]||jt),n=v.useRef(U[t]);v.useEffect(()=>(n.current!==U[t]&&a(U[t]),Re.push([t,a]),()=>{let o=Re.findIndex(([l])=>l===t);o>-1&&Re.splice(o,1)}),[t]);let i=s.toasts.map(o=>{var l,c,u;return{...r,...r[o.type],...o,removeDelay:o.removeDelay||((l=r[o.type])==null?void 0:l.removeDelay)||(r==null?void 0:r.removeDelay),duration:o.duration||((c=r[o.type])==null?void 0:c.duration)||(r==null?void 0:r.duration)||Ri[o.type],style:{...r.style,...(u=r[o.type])==null?void 0:u.style,...o.style}}});return{...s,toasts:i}},Pi=(r,t="blank",s)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:t,ariaProps:{role:"status","aria-live":"polite"},message:r,pauseDuration:0,...s,id:(s==null?void 0:s.id)||Ei()}),je=r=>(t,s)=>{let a=Pi(t,r,s);return We(a.toasterId||qi(a.id))({type:2,toast:a}),a.id},q=(r,t)=>je("blank")(r,t);q.error=je("error");q.success=je("success");q.loading=je("loading");q.custom=je("custom");q.dismiss=(r,t)=>{let s={type:3,toastId:r};t?We(t)(s):wt(s)};q.dismissAll=r=>q.dismiss(void 0,r);q.remove=(r,t)=>{let s={type:4,toastId:r};t?We(t)(s):wt(s)};q.removeAll=r=>q.remove(void 0,r);q.promise=(r,t,s)=>{let a=q.loading(t.loading,{...s,...s==null?void 0:s.loading});return typeof r=="function"&&(r=r()),r.then(n=>{let i=t.success?Te(t.success,n):void 0;return i?q.success(i,{id:a,...s,...s==null?void 0:s.success}):q.dismiss(a),n}).catch(n=>{let i=t.error?Te(t.error,n):void 0;i?q.error(i,{id:a,...s,...s==null?void 0:s.error}):q.dismiss(a)}),r};var Ti=1e3,Di=(r,t="default")=>{let{toasts:s,pausedAt:a}=Li(r,t),n=v.useRef(new Map).current,i=v.useCallback((h,y=Ti)=>{if(n.has(h))return;let f=setTimeout(()=>{n.delete(h),o({type:4,toastId:h})},y);n.set(h,f)},[]);v.useEffect(()=>{if(a)return;let h=Date.now(),y=s.map(f=>{if(f.duration===1/0)return;let b=(f.duration||0)+f.pauseDuration-(h-f.createdAt);if(b<0){f.visible&&q.dismiss(f.id);return}return setTimeout(()=>q.dismiss(f.id,t),b)});return()=>{y.forEach(f=>f&&clearTimeout(f))}},[s,a,t]);let o=v.useCallback(We(t),[t]),l=v.useCallback(()=>{o({type:5,time:Date.now()})},[o]),c=v.useCallback((h,y)=>{o({type:1,toast:{id:h,height:y}})},[o]),u=v.useCallback(()=>{a&&o({type:6,time:Date.now()})},[a,o]),m=v.useCallback((h,y)=>{let{reverseOrder:f=!1,gutter:b=8,defaultPosition:x}=y||{},g=s.filter(p=>(p.position||x)===(h.position||x)&&p.height),A=g.findIndex(p=>p.id===h.id),N=g.filter((p,j)=>j<A&&p.visible).length;return g.filter(p=>p.visible).slice(...f?[N+1]:[0,N]).reduce((p,j)=>p+(j.height||0)+b,0)},[s]);return v.useEffect(()=>{s.forEach(h=>{if(h.dismissed)i(h.id,h.removeDelay);else{let y=n.get(h.id);y&&(clearTimeout(y),n.delete(h.id))}})},[s,i]),{toasts:s,handlers:{updateHeight:c,startPause:l,endPause:u,calculateOffset:m}}},Ii=$`
from {
...
to {
  ...
  animation: ${Ki} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Xi=({toast:r})=>{let{icon:t,type:s,iconTheme:a}=r;return t!==void 0?typeof t=="string"?v.createElement(Yi,null,t):t:s==="blank"?null:v.createElement(Ji,null,v.createElement(Ui,{...a}),s!=="loading"&&v.createElement(Vi,null,s==="error"?v.createElement(zi,{...a}):v.createElement(Hi,{...a})))},Qi=r=>`
0% {transform: translate3d(0,${r*-200}%,0) scale(.6); opacity:.5;}
100% {transform: translate3d(0,0,0) scale(1); opacity:1;}
`,Zi=r=>`
0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}
100% {transform: translate3d(0,${r*-150}%,-1px) scale(.6); opacity:0;}
`,eo="0%{opacity:0;} 100%{opacity:1;}",ro="0%{opacity:1;} 100%{opacity:0;}",to=Q("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`,ao=(r,t)=>{let s=r.includes("top")?1:-1,[a,n]=xt()?[eo,ro]:[Qi(s),Zi(s)];return{animation:t?`${$(a)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${$(n)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},no=v.memo(({toast:r,position:t,style:s,children:a})=>{let n=r.height?ao(r.position||t||"top-center",r.visible):{opacity:0},i=v.createElement(Xi,{toast:r}),o=v.createElement(so,{...r.ariaProps},Te(r.message,r));return v.createElement(to,{className:r.className,style:{...n,...s,...r.style}},typeof a=="function"?a({icon:i,message:o}):v.createElement(v.Fragment,null,i,o))});Fi(v.createElement);var io=({id:r,className:t,style:s,onHeightUpdate:a,children:n})=>{let i=v.useCallback(o=>{if(o){let l=()=>{let c=o.getBoundingClientRect().height;a(r,c)};l(),new MutationObserver(l).observe(o,{subtree:!0,childList:!0,characterData:!0})}},[r,a]);return v.createElement("div",{ref:i,className:t,style:s},n)},oo=(r,t)=>{let s=r.includes("top"),a=s?{top:0}:{bottom:0},n=r.includes("center")?{justifyContent:"center"}:r.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:xt()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${t*(s?1:-1)}px)`,...a,...n}},lo=Ue`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,ke=16,co=({reverseOrder:r,position:t="top-center",toastOptions:s,gutter:a,children:n,toasterId:i,containerStyle:o,containerClassName:l})=>{let{toasts:c,handlers:u}=Di(s,i);return v.createElement("div",{"data-rht-toaster":i||"",style:{position:"fixed",zIndex:9999,top:ke,left:ke,right:ke,bottom:ke,pointerEvents:"none",...o},className:l,onMouseEnter:u.startPause,onMouseLeave:u.endPause},c.map(m=>{let h=m.position||t,y=u.calculateOffset(m,{reverseOrder:r,gutter:a,defaultPosition:t}),f=oo(h,y);return v.createElement(io,{id:m.id,key:m.id,onHeightUpdate:u.updateHeight,className:m.visible?lo:"",style:f},m.type==="custom"?Te(m.message,m):n?n(m):v.createElement(no,{toast:m,position:h}))}))};Et.createRoot(document.getElementById("root")).render(e.jsxs(fe.StrictMode,{children:[e.jsx(ji,{}),e.jsx(co,{position:"bottom-right",toastOptions:{style:{fontFamily:"var(--font-body)",borderRadius:"var(--radius-md)"},success:{iconTheme:{primary:"#52B788",secondary:"white"}}}})]}));export{ys as L,ie as a,O as b,ue as u};
