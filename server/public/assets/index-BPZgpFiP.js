...
to {
  ...
  animation: ${Hi} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Ji=({toast:r})=>{let{icon:t,type:s,iconTheme:n}=r;return t!==void 0?typeof t=="string"?b.createElement(Vi,null,t):t:s==="blank"?null:b.createElement($i,null,b.createElement(Mi,{...n}),s!=="loading"&&b.createElement(Wi,null,s==="error"?b.createElement(Ii,{...n}):b.createElement(Ui,{...n})))},Ki=r=>`
0% {transform: translate3d(0,${r*-200}%,0) scale(.6); opacity:.5;}
100% {transform: translate3d(0,0,0) scale(1); opacity:1;}
`,Yi=r=>`
0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}
100% {transform: translate3d(0,${r*-150}%,-1px) scale(.6); opacity:0;}
`,Xi="0%{opacity:0;} 100%{opacity:1;}",Qi="0%{opacity:1;} 100%{opacity:0;}",Zi=Q("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`,ro=(r,t)=>{let s=r.includes("top")?1:-1,[n,a]=yt()?[Xi,Qi]:[Ki(s),Yi(s)];return{animation:t?`${$(n)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${$(a)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},to=b.memo(({toast:r,position:t,style:s,children:n})=>{let a=r.height?ro(r.position||t||"top-center",r.visible):{opacity:0},i=b.createElement(Ji,{toast:r}),o=b.createElement(eo,{...r.ariaProps},Pe(r.message,r));return b.createElement(Zi,{className:r.className,style:{...a,...s,...r.style}},typeof n=="function"?n({icon:i,message:o}):b.createElement(b.Fragment,null,i,o))});Ci(b.createElement);var so=({id:r,className:t,style:s,onHeightUpdate:n,children:a})=>{let i=b.useCallback(o=>{if(o){let l=()=>{let u=o.getBoundingClientRect().height;n(r,u)};l(),new MutationObserver(l).observe(o,{subtree:!0,childList:!0,characterData:!0})}},[r,n]);return b.createElement("div",{ref:i,className:t,style:s},a)},no=(r,t)=>{let s=r.includes("top"),n=s?{top:0}:{bottom:0},a=r.includes("center")?{justifyContent:"center"}:r.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:yt()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${t*(s?1:-1)}px)`,...n,...a}},ao=Ge`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,ke=16,io=({reverseOrder:r,position:t="top-center",toastOptions:s,gutter:n,children:a,toasterId:i,containerStyle:o,containerClassName:l})=>{let{toasts:u,handlers:d}=Li(s,i);return b.createElement("div",{"data-rht-toaster":i||"",style:{position:"fixed",zIndex:9999,top:ke,left:ke,right:ke,bottom:ke,pointerEvents:"none",...o},className:l,onMouseEnter:d.startPause,onMouseLeave:d.endPause},u.map(c=>{let p=c.position||t,x=d.calculateOffset(c,{reverseOrder:r,gutter:n,defaultPosition:t}),f=no(p,x);return b.createElement(so,{id:c.id,key:c.id,onHeightUpdate:d.updateHeight,className:c.visible?ao:"",style:f},c.type==="custom"?Pe(c.message,c):a?a(c):b.createElement(to,{toast:c,position:p}))}))};Ot.createRoot(document.getElementById("root")).render(e.jsxs(he.StrictMode,{children:[e.jsx(vi,{}),e.jsx(io,{position:"bottom-right",toastOptions:{style:{fontFamily:"var(--font-body)",borderRadius:"var(--radius-md)"},success:{iconTheme:{primary:"#52B788",secondary:"white"}}}})]}));export{js as L,ie as a,fe as u};
