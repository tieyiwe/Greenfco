...
to {
  ...
  animation: ${Yi} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Qi=({toast:r})=>{let{icon:t,type:s,iconTheme:a}=r;return t!==void 0?typeof t=="string"?v.createElement(Xi,null,t):t:s==="blank"?null:v.createElement(Ki,null,v.createElement(Wi,{...a}),s!=="loading"&&v.createElement(Ji,null,s==="error"?v.createElement(Gi,{...a}):v.createElement(Vi,{...a})))},Zi=r=>`
0% {transform: translate3d(0,${r*-200}%,0) scale(.6); opacity:.5;}
100% {transform: translate3d(0,0,0) scale(1); opacity:1;}
`,eo=r=>`
0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}
100% {transform: translate3d(0,${r*-150}%,-1px) scale(.6); opacity:0;}
`,ro="0%{opacity:0;} 100%{opacity:1;}",to="0%{opacity:1;} 100%{opacity:0;}",so=Z("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`,no=(r,t)=>{let s=r.includes("top")?1:-1,[a,n]=xt()?[ro,to]:[Zi(s),eo(s)];return{animation:t?`${$(a)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${$(n)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},io=v.memo(({toast:r,position:t,style:s,children:a})=>{let n=r.height?no(r.position||t||"top-center",r.visible):{opacity:0},i=v.createElement(Qi,{toast:r}),o=v.createElement(ao,{...r.ariaProps},Te(r.message,r));return v.createElement(so,{className:r.className,style:{...n,...s,...r.style}},typeof a=="function"?a({icon:i,message:o}):v.createElement(v.Fragment,null,i,o))});Ei(v.createElement);var oo=({id:r,className:t,style:s,onHeightUpdate:a,children:n})=>{let i=v.useCallback(o=>{if(o){let l=()=>{let c=o.getBoundingClientRect().height;a(r,c)};l(),new MutationObserver(l).observe(o,{subtree:!0,childList:!0,characterData:!0})}},[r,a]);return v.createElement("div",{ref:i,className:t,style:s},n)},lo=(r,t)=>{let s=r.includes("top"),a=s?{top:0}:{bottom:0},n=r.includes("center")?{justifyContent:"center"}:r.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:xt()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${t*(s?1:-1)}px)`,...a,...n}},co=Ue`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,Ee=16,uo=({reverseOrder:r,position:t="top-center",toastOptions:s,gutter:a,children:n,toasterId:i,containerStyle:o,containerClassName:l})=>{let{toasts:c,handlers:u}=Ii(s,i);return v.createElement("div",{"data-rht-toaster":i||"",style:{position:"fixed",zIndex:9999,top:Ee,left:Ee,right:Ee,bottom:Ee,pointerEvents:"none",...o},className:l,onMouseEnter:u.startPause,onMouseLeave:u.endPause},c.map(m=>{let h=m.position||t,y=u.calculateOffset(m,{reverseOrder:r,gutter:a,defaultPosition:t}),f=lo(h,y);return v.createElement(oo,{id:m.id,key:m.id,onHeightUpdate:u.updateHeight,className:m.visible?co:"",style:f},m.type==="custom"?Te(m.message,m):n?n(m):v.createElement(io,{toast:m,position:h}))}))};kt.createRoot(document.getElementById("root")).render(e.jsxs(fe.StrictMode,{children:[e.jsx(Ai,{}),e.jsx(uo,{position:"bottom-right",toastOptions:{style:{fontFamily:"var(--font-body)",borderRadius:"var(--radius-md)"},success:{iconTheme:{primary:"#52B788",secondary:"white"}}}})]}));export{ys as L,Q as a,k as b,ue as u};
