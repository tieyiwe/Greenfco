const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ResetPassword-BRQ5H9cQ.js","assets/vendor-hyKWh86c.js","assets/i18n-CaT5xHvk.js","assets/AdminLayout-DNEB-Qvr.js","assets/adminPermissions-BOjaiS7-.js","assets/adminClient-D85Lmr7P.js","assets/AdminLayout-BCVkwY2N.css","assets/AdminDashboard-t28pIDMb.js","assets/AdminUsers-SNgVHDPE.js","assets/AdminActivity-B8kGOhrd.js","assets/AdminListings-B9zMXWxX.js","assets/AdminBlog-Bjd_qs6h.js","assets/AdminConsulting-BxwOLwFf.js","assets/AdminGallery-ByGhguaM.js","assets/DashboardLayout-CSuroefW.js","assets/DashboardLayout-BpKe-wRa.css","assets/DashboardHome-DgsFgGQX.js","assets/DashboardHome-BLD588yz.css","assets/CropManager-YK1klW9M.js","assets/CropManager-BD-LpmFo.css","assets/IrrigationManager-DI5P_SJd.js","assets/IrrigationManager-CZCXtdu3.css","assets/FinanceManager-DuCoQ3sB.js","assets/charts-DdzZAI62.js","assets/FinanceManager-CTGCeKBU.css","assets/WeatherHub-QLNfJU_p.js","assets/WeatherHub-BCakf7cf.css","assets/SpeciesLibrary-atL8VbK0.js","assets/SpeciesLibrary-NnjfWp4_.css","assets/GreenBot-CVqcXQG5.js","assets/GreenBot-D75McUtq.css","assets/SoilAdvisor-FBYCJrVQ.js","assets/SoilAdvisor-B1clJ25z.css","assets/KoobAssist-BHYPrQVG.js","assets/KoobAssist-CjSwZy0D.css","assets/MarketPage-CaQ4i16Y.js","assets/MarketPage-DpFR5JJb.css","assets/SellerProfilePage-BxshXGZJ.js","assets/SellerProfilePage-DPItoylU.css","assets/BuyerProfilePage-BtrHiGss.js","assets/BuyerProfilePage-Cf8EZ_59.css","assets/NetworkPage-CbXt2YNK.js","assets/NetworkPage-CrcCg5Ce.css","assets/VerifyTransaction-BD0HF4eb.js","assets/VerifyTransaction-DfdVffKM.css","assets/AdminTransactions-8i5QPySX.js","assets/AdminSettings-BdIPoKjG.js","assets/AdminProjects-Bs8mcpMk.js","assets/AdminTeamChat-CqlZc-BM.js","assets/AdminLogin-DqON5QF6.js"])))=>i.map(i=>d[i]);
import{R as fe,r as v,j as e,u as Ft,L as S,N as Je,h as kt,f as Yr,B as Et,c as Ot,b as C,a as Le,d as qt}from"./vendor-hyKWh86c.js";import{a as Rt,B as Lt,i as Pt,u as D}from"./i18n-CaT5xHvk.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();const Tt="modulepreload",Dt=function(r){return"/"+r},Ar={},F=function(t,s,n){let a=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));a=Promise.allSettled(s.map(c=>{if(c=Dt(c),c in Ar)return;Ar[c]=!0;const u=c.endsWith(".css"),m=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${m}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":Tt,u||(p.as="script"),p.crossOrigin="",p.href=c,l&&p.setAttribute("nonce",l),document.head.appendChild(p),u)return new Promise((y,f)=>{p.addEventListener("load",y),p.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function i(o){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=o,window.dispatchEvent(l),!l.defaultPrevented)throw o}return a.then(o=>{for(const l of o||[])l.status==="rejected"&&i(l.reason);return t().catch(i)})},It={home:"Accueil",services:"Services",about:"À Propos",blog:"Blog",gallery:"Galerie",contact:"Contact",login:"Se connecter",register:"S'inscrire",dashboard:"Tableau de bord",market:"Marché",marketplace:"Marketplace",agropro:"AgroPro",network:"Réseau",profile:"Mon Profil",logout:"Déconnexion"},Bt={slogan:"Cultiver un avenir durable, ensemble.",subtitle:"Plateforme agro-environnementale pour l'Afrique francophone — outils intelligents, expertise locale, impact réel.",cta_primary:"Découvrir nos services",cta_secondary:"Accéder à la plateforme"},Mt={founded:"Fondé en 2021",fellows:"2 Fellows Internationaux",services:"7 Lignes de Services",presence:"Présence Afrique & Europe"},zt={title:"Nos Services",subtitle:"7 lignes de services intégrés pour accompagner votre projet agricole et agri-alimentaire.",conseil:{title:"Assistance-Conseil",desc:"Accompagnement à la création et à la gestion d'entreprises agricoles et agri-alimentaires.",cta:"En savoir plus"},negoce:{title:"Négoce Agricole",desc:"Commerce de produits agricoles et agri-alimentaires : oignons, pommes de terre et autres.",cta:"En savoir plus"},formations:{title:"Formations",desc:"Agriculture Durable, Agriculture Intelligente, Agriculture Hors-sol — formations certifiantes.",cta:"En savoir plus"},etudes:{title:"Études",desc:"Études environnementales et études de marché pour vos projets agricoles.",cta:"En savoir plus"},hydro:{title:"Aménagements Hydro-Agricoles",desc:"Conception et réalisation d'aménagements hydro-agricoles durables.",cta:"En savoir plus"},intrants:{title:"Intrants Agricoles",desc:"Vente d'intrants agricoles de qualité, dont BioGrowth — notre bio-fertilisant liquide.",cta:"En savoir plus"},projets:{title:"Développement de Projets",desc:"Développement de projets et études de marché pour agripreneurs et institutions.",cta:"En savoir plus"}},Gt={title:"Qui Nous Sommes",subtitle:"GreenFCO est une entreprise agro-environnementale fondée au Burkina Faso par deux frères passionnés d'agriculture durable et d'impact.",mission:"Notre Mission",vision:"Notre Vision",values:"Nos Valeurs",mission_text:"Accompagner les acteurs agricoles de l'Afrique francophone dans la transition vers des pratiques durables, innovantes et rentables.",vision_text:"Un secteur agricole africain résilient, inclusif et compétitif, ancré dans les pratiques agroécologiques.",values_durability:"Durabilité",values_innovation:"Innovation",values_impact:"Impact",founders:"Nos Co-fondateurs",timeline_title:"Notre Parcours"},Wt={title:"Blog & Actualités",subtitle:"Articles, recherches et nouvelles du monde agro-environnemental.",read_more:"Lire la suite",categories:{all:"Tous",news:"Actualités",research:"Recherche & Innovation",agriculture:"Agriculture Durable",environment:"Environnement"},newsletter_cta:"Restez informé",newsletter_text:"Abonnez-vous à notre newsletter pour recevoir les dernières nouvelles et conseils agricoles."},Ut={title:"Contactez-Nous",subtitle:"Notre équipe est disponible pour répondre à vos questions et vous accompagner dans vos projets.",form_name:"Nom complet",form_email:"Adresse e-mail",form_subject:"Sujet",form_message:"Message",form_country:"Pays",form_submit:"Envoyer le message",whatsapp:"Contactez-nous sur WhatsApp",email:"Écrire un e-mail",success:"Votre message a été envoyé avec succès !",error:"Une erreur est survenue. Veuillez réessayer."},$t={login_title:"Se connecter",register_title:"Créer un compte",email:"Adresse e-mail",password:"Mot de passe",confirm_password:"Confirmer le mot de passe",name:"Nom complet",country:"Pays",user_type:"Type de compte",farmer:"Agriculteur / Agripreneur",expert:"Expert / Consultant",investor:"Investisseur",organization:"Organisation / Institution",login_btn:"Se connecter",register_btn:"Créer mon compte",forgot_password:"Mot de passe oublié ?",no_account:"Pas encore de compte ?",have_account:"Déjà un compte ?",language_pref:"Langue préférée"},Ht={welcome:"Bienvenue",crops:"Mes Cultures",irrigation:"Irrigation",finance:"Finances",map:"Cartographie",weather:"Météo",species:"Espèces",market:"Marché",business_plan:"Business Plan",ai_advisor:"Conseiller IA",greenbot:"GreenBot",my_farms:"Mes Fermes",add_farm:"Ajouter une ferme"},Vt={title:"Météo Agricole",subtitle:"Prévisions et alertes adaptées à votre exploitation",detect_location:"Détecter ma position",manual_city:"Entrer une ville",forecast_7days:"Prévisions 7 jours",rainfall_30days:"Pluies — 30 derniers jours",alerts:"Alertes Météo",recommendation:"Conseils du jour",temp_max:"Max",temp_min:"Min",rain:"Pluies",wind:"Vent",humidity:"Humidité"},Jt={title:"Marché Numérique",subtitle:"Achetez, vendez et échangez des produits agricoles",post_listing:"Publier une annonce",browse:"Parcourir les annonces",filters:"Filtres",crop:"Culture",quantity:"Quantité (kg)",price:"Prix",location:"Localisation",contact_whatsapp:"Contacter sur WhatsApp",my_listings:"Mes annonces"},Kt={title:"Réseau Agro-Environnemental",subtitle:"Connectez-vous avec des experts, agriculteurs et organisations",forums:"Forums",experts:"Experts",events:"Événements",knowledge:"Ressources",sponsorship:"Parrainage Plantes",investors:"Hub Investisseurs",impact:"Impact"},Yt={slogan:"Cultiver un avenir durable, ensemble.",rights:"Tous droits réservés",founded:"Fondé en 2021 au Burkina Faso"},Xt={loading:"Chargement...",error:"Une erreur est survenue",save:"Enregistrer",cancel:"Annuler",delete:"Supprimer",edit:"Modifier",add:"Ajouter",close:"Fermer",back:"Retour",next:"Suivant",previous:"Précédent",search:"Rechercher",filter:"Filtrer",export:"Exporter",download:"Télécharger",view_all:"Voir tout",learn_more:"En savoir plus",coming_soon:"Bientôt disponible",in_development:"En développement"},Qt={nav:It,hero:Bt,stats:Mt,services:zt,about:Gt,blog:Wt,contact:Ut,auth:$t,dashboard:Ht,weather:Vt,market:Jt,network:Kt,footer:Yt,common:Xt},Zt={home:"Home",services:"Services",about:"About",blog:"Blog",gallery:"Gallery",contact:"Contact",login:"Sign In",register:"Register",dashboard:"Dashboard",market:"Market",marketplace:"Marketplace",agropro:"AgroPro",network:"Network",profile:"My Profile",logout:"Sign Out"},es={slogan:"Cultivating a sustainable future, together.",subtitle:"Agro-environmental platform for Francophone Africa — smart tools, local expertise, real impact.",cta_primary:"Explore our services",cta_secondary:"Access the platform"},rs={founded:"Founded in 2021",fellows:"2 International Fellows",services:"7 Service Lines",presence:"Africa & Europe Presence"},ts={title:"Our Services",subtitle:"7 integrated service lines to support your agricultural and agri-food project.",conseil:{title:"Advisory Services",desc:"Business creation and management consulting for agricultural and agri-food enterprises.",cta:"Learn more"},negoce:{title:"Agricultural Trading",desc:"Trading of agricultural and agri-food products: onions, potatoes, and more.",cta:"Learn more"},formations:{title:"Training Programs",desc:"Sustainable Agriculture, Smart Agriculture, Soilless Agriculture — certified training.",cta:"Learn more"},etudes:{title:"Studies & Research",desc:"Environmental studies and market research for your agricultural projects.",cta:"Learn more"},hydro:{title:"Hydro-Agricultural Development",desc:"Design and implementation of sustainable hydro-agricultural projects.",cta:"Learn more"},intrants:{title:"Agricultural Inputs",desc:"Quality agricultural inputs, including BioGrowth — our liquid bio-fertilizer.",cta:"Learn more"},projets:{title:"Project Development",desc:"Project development and market studies for agripreneurs and institutions.",cta:"Learn more"}},ss={title:"Who We Are",subtitle:"GreenFCO is an agro-environmental enterprise founded in Burkina Faso by two brothers passionate about sustainable agriculture and impact.",mission:"Our Mission",vision:"Our Vision",values:"Our Values",mission_text:"Accompany agricultural actors in Francophone Africa in their transition to sustainable, innovative, and profitable practices.",vision_text:"A resilient, inclusive, and competitive African agricultural sector, grounded in agroecological practices.",values_durability:"Sustainability",values_innovation:"Innovation",values_impact:"Impact",founders:"Our Co-founders",timeline_title:"Our Journey"},ns={title:"Blog & News",subtitle:"Articles, research, and news from the agro-environmental world.",read_more:"Read more",categories:{all:"All",news:"News",research:"Research & Innovation",agriculture:"Sustainable Agriculture",environment:"Environment"},newsletter_cta:"Stay Informed",newsletter_text:"Subscribe to our newsletter to receive the latest agricultural news and tips."},as={title:"Contact Us",subtitle:"Our team is available to answer your questions and support your projects.",form_name:"Full name",form_email:"Email address",form_subject:"Subject",form_message:"Message",form_country:"Country",form_submit:"Send message",whatsapp:"Contact us on WhatsApp",email:"Send an email",success:"Your message was sent successfully!",error:"An error occurred. Please try again."},is={login_title:"Sign In",register_title:"Create Account",email:"Email address",password:"Password",confirm_password:"Confirm password",name:"Full name",country:"Country",user_type:"Account type",farmer:"Farmer / Agripreneur",expert:"Expert / Consultant",investor:"Investor",organization:"Organization / Institution",login_btn:"Sign In",register_btn:"Create my account",forgot_password:"Forgot password?",no_account:"Don't have an account?",have_account:"Already have an account?",language_pref:"Preferred language"},os={welcome:"Welcome",crops:"My Crops",irrigation:"Irrigation",finance:"Finance",map:"Farm Map",weather:"Weather",species:"Species",market:"Market",business_plan:"Business Plan",ai_advisor:"AI Advisor",greenbot:"GreenBot",my_farms:"My Farms",add_farm:"Add Farm"},ls={title:"Agricultural Weather",subtitle:"Forecasts and alerts adapted to your farm",detect_location:"Detect my location",manual_city:"Enter a city",forecast_7days:"7-day forecast",rainfall_30days:"Rainfall — last 30 days",alerts:"Weather Alerts",recommendation:"Today's Advice",temp_max:"Max",temp_min:"Min",rain:"Rain",wind:"Wind",humidity:"Humidity"},cs={title:"Digital Market",subtitle:"Buy, sell, and trade agricultural products",post_listing:"Post a listing",browse:"Browse listings",filters:"Filters",crop:"Crop",quantity:"Quantity (kg)",price:"Price",location:"Location",contact_whatsapp:"Contact on WhatsApp",my_listings:"My listings"},us={title:"Agro-Environmental Network",subtitle:"Connect with experts, farmers, and organizations",forums:"Forums",experts:"Experts",events:"Events",knowledge:"Resources",sponsorship:"Plant Sponsorship",investors:"Investor Hub",impact:"Impact"},ds={slogan:"Cultivating a sustainable future, together.",rights:"All rights reserved",founded:"Founded in 2021 in Burkina Faso"},ms={loading:"Loading...",error:"An error occurred",save:"Save",cancel:"Cancel",delete:"Delete",edit:"Edit",add:"Add",close:"Close",back:"Back",next:"Next",previous:"Previous",search:"Search",filter:"Filter",export:"Export",download:"Download",view_all:"View all",learn_more:"Learn more",coming_soon:"Coming soon",in_development:"In development"},ps={nav:Zt,hero:es,stats:rs,services:ts,about:ss,blog:ns,contact:as,auth:is,dashboard:os,weather:ls,market:cs,network:us,footer:ds,common:ms};Rt.use(Lt).use(Pt).init({resources:{fr:{translation:Qt},en:{translation:ps}},fallbackLng:"fr",defaultNS:"translation",detection:{order:["localStorage","navigator"],caches:["localStorage"],lookupLocalStorage:"greenfco_lang"},interpolation:{escapeValue:!1}});const wr=r=>{let t;const s=new Set,n=(u,m)=>{const p=typeof u=="function"?u(t):u;if(!Object.is(p,t)){const y=t;t=m??(typeof p!="object"||p===null)?p:Object.assign({},t,p),s.forEach(f=>f(t,y))}},a=()=>t,l={setState:n,getState:a,getInitialState:()=>c,subscribe:u=>(s.add(u),()=>s.delete(u))},c=t=r(n,a,l);return l},hs=r=>r?wr(r):wr,fs=r=>r;function gs(r,t=fs){const s=fe.useSyncExternalStore(r.subscribe,fe.useCallback(()=>t(r.getState()),[r,t]),fe.useCallback(()=>t(r.getInitialState()),[r,t]));return fe.useDebugValue(s),s}const Nr=r=>{const t=hs(r),s=n=>gs(t,n);return Object.assign(s,t),s},bs=r=>r?Nr(r):Nr;function vs(r,t){let s;try{s=r()}catch{return}return{getItem:a=>{var i;const o=c=>c===null?null:JSON.parse(c,void 0),l=(i=s.getItem(a))!=null?i:null;return l instanceof Promise?l.then(o):o(l)},setItem:(a,i)=>s.setItem(a,JSON.stringify(i,void 0)),removeItem:a=>s.removeItem(a)}}const rr=r=>t=>{try{const s=r(t);return s instanceof Promise?s:{then(n){return rr(n)(s)},catch(n){return this}}}catch(s){return{then(n){return this},catch(n){return rr(n)(s)}}}},xs=(r,t)=>(s,n,a)=>{let i={storage:vs(()=>window.localStorage),partialize:g=>g,version:0,merge:(g,A)=>({...A,...g}),...t},o=!1,l=0;const c=new Set,u=new Set;let m=i.storage;if(!m)return r((...g)=>{console.warn(`[zustand persist middleware] Unable to update item '${i.name}', the given storage is currently unavailable.`),s(...g)},n,a);const p=()=>{const g=i.partialize({...n()});return m.setItem(i.name,{state:g,version:i.version})},y=a.setState;a.setState=(g,A)=>(y(g,A),p());const f=r((...g)=>(s(...g),p()),n,a);a.getInitialState=()=>f;let b;const x=()=>{var g,A;if(!m)return;const N=++l;o=!1,c.forEach(j=>{var _;return j((_=n())!=null?_:f)});const h=((A=i.onRehydrateStorage)==null?void 0:A.call(i,(g=n())!=null?g:f))||void 0;return rr(m.getItem.bind(m))(i.name).then(j=>{if(j)if(typeof j.version=="number"&&j.version!==i.version){if(i.migrate){const _=i.migrate(j.state,j.version);return _ instanceof Promise?_.then(q=>[!0,q]):[!0,_]}console.error("State loaded from storage couldn't be migrated since no migrate function was provided")}else return[!1,j.state];return[!1,void 0]}).then(j=>{var _;if(N!==l)return;const[q,ee]=j;if(b=i.merge(ee,(_=n())!=null?_:f),s(b,!0),q)return p()}).then(()=>{N===l&&(h==null||h(n(),void 0),b=n(),o=!0,u.forEach(j=>j(b)))}).catch(j=>{N===l&&(h==null||h(void 0,j))})};return a.persist={setOptions:g=>{i={...i,...g},g.storage&&(m=g.storage)},clearStorage:()=>{m==null||m.removeItem(i.name)},getOptions:()=>i,rehydrate:()=>x(),hasHydrated:()=>o,onHydrate:g=>(c.add(g),()=>{c.delete(g)}),onFinishHydration:g=>(u.add(g),()=>{u.delete(g)})},i.skipHydration||x(),b||f},ys=xs,ue=bs(ys(r=>({user:null,token:null,isAuthenticated:!1,setAuth:(t,s)=>r({user:t,token:s,isAuthenticated:!0}),logout:()=>r({user:null,token:null,isAuthenticated:!1}),updateUser:t=>r(s=>({user:{...s.user,...t}}))}),{name:"greenfco_auth",partialize:r=>({user:r.user,token:r.token,isAuthenticated:r.isAuthenticated})}));class js extends v.Component{constructor(t){super(t),this.state={hasError:!1,error:null}}static getDerivedStateFromError(t){return{hasError:!0,error:t}}componentDidCatch(t,s){console.error("[ErrorBoundary]",t,s.componentStack)}render(){return this.state.hasError?e.jsxs("div",{style:{minHeight:"60vh",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:"1rem",padding:"2rem",textAlign:"center"},children:[e.jsx("div",{style:{fontSize:"3rem"},children:"🌿"}),e.jsx("h2",{style:{color:"#1B4332"},children:"Une erreur est survenue / An error occurred"}),e.jsx("p",{style:{color:"#6B7280",maxWidth:"400px"},children:this.props.fallbackMessage||"Quelque chose s'est mal passé. Veuillez actualiser la page. / Something went wrong. Please refresh the page."}),e.jsx("button",{onClick:()=>{this.setState({hasError:!1,error:null}),window.location.reload()},style:{background:"#1B4332",color:"white",border:"none",padding:"0.75rem 1.5rem",borderRadius:"8px",cursor:"pointer",fontSize:"1rem"},children:"🔄 Actualiser / Refresh"}),!1]}):this.props.children}}function As(){var n;const{i18n:r}=D(),t=(n=r.language)!=null&&n.startsWith("fr")?"fr":"en";function s(){const a=t==="fr"?"en":"fr";r.changeLanguage(a),localStorage.setItem("greenfco_lang",a)}return e.jsxs("button",{className:"lang-toggle",onClick:s,title:"Toggle language",children:[e.jsx("span",{className:t==="fr"?"active":"",children:"FR"}),e.jsx("span",{className:"separator",children:"|"}),e.jsx("span",{className:t==="en"?"active":"",children:"EN"})]})}function ws(){var g,A,N;const{t:r,i18n:t}=D(),s=(g=t.language)!=null&&g.startsWith("fr")?"fr":"en",n=Ft(),{isAuthenticated:a,user:i,logout:o}=ue(),[l,c]=v.useState(!1),[u,m]=v.useState(!1),p=n.pathname.startsWith("/dashboard")||n.pathname.startsWith("/network")||n.pathname.startsWith("/market"),y=[{to:"/",icon:"🏠",label:r("nav.home"),exact:!0},{to:"/services",icon:"🌿",label:r("nav.services")},{to:"/consulting",icon:"🤝",label:s==="fr"?"Consultation":"Consulting"},{to:"/about",icon:"👥",label:r("nav.about")},{to:"/blog",icon:"📰",label:r("nav.blog")},{to:"/gallery",icon:"📷",label:r("nav.gallery")},{to:"/contact",icon:"✉️",label:r("nav.contact")},{to:"/marketplace",icon:"🛒",label:r("nav.marketplace"),highlight:!0},{to:"/agropro",icon:"📊",label:r("nav.agropro"),highlight:!0}],f=[{to:"/dashboard",icon:"📊",label:r("nav.dashboard"),exact:!0},{to:"/marketplace",icon:"🛒",label:r("nav.marketplace"),highlight:!0},{to:"/agropro",icon:"📊",label:r("nav.agropro"),highlight:!0},{to:"/network",icon:"🌍",label:r("nav.network")},{to:"/blog",icon:"📰",label:r("nav.blog")}],b=a?f:y;function x(){o(),m(!1),c(!1)}return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:`navbar ${p?"navbar-dashboard":""}`,children:e.jsxs("div",{className:"navbar-container",children:[e.jsxs(S,{to:"/",className:"navbar-logo",onClick:()=>c(!1),children:[e.jsx("span",{className:"logo-icon",children:"🌿"}),e.jsxs("span",{className:"logo-text",children:[e.jsx("span",{className:"logo-green",children:"Green"}),"FCO"]})]}),e.jsx("nav",{className:"navbar-links",children:b.map(h=>h.highlight?e.jsxs(Je,{to:h.to,className:({isActive:j})=>`nav-link nav-market-btn ${j?"active":""}`,children:[h.icon," ",h.label]},h.to):e.jsx(Je,{to:h.to,end:h.exact,className:({isActive:j})=>`nav-link ${j?"active":""}`,children:h.label},h.to))}),e.jsx(S,{to:"/admin",style:{fontSize:"0.75rem",color:"var(--gray-mid)",marginRight:"0.5rem",textDecoration:"none",letterSpacing:"0.02em",opacity:.7},children:"Admin"}),e.jsxs("div",{className:"navbar-actions",children:[e.jsx(As,{}),a?e.jsxs("div",{className:"profile-menu",children:[e.jsxs("button",{className:"profile-trigger",onClick:()=>m(!u),children:[e.jsx("span",{className:"profile-avatar",children:((A=i==null?void 0:i.name)==null?void 0:A.charAt(0).toUpperCase())||"U"}),e.jsx("span",{className:"profile-name desktop-only",children:(N=i==null?void 0:i.name)==null?void 0:N.split(" ")[0]}),e.jsx("span",{className:"profile-chevron desktop-only",children:u?"▲":"▼"})]}),u&&e.jsxs("div",{className:"profile-dropdown",children:[e.jsx(S,{to:"/profile",onClick:()=>m(!1),children:r("nav.profile")}),e.jsx("button",{onClick:x,children:r("nav.logout")})]})]}):e.jsxs("div",{className:"auth-buttons",children:[e.jsx(S,{to:"/login",className:"btn btn-secondary btn-sm",children:r("nav.login")}),e.jsx(S,{to:"/register",className:"btn btn-primary btn-sm mobile-only",children:r("nav.register")})]})]}),e.jsxs("button",{className:`hamburger ${l?"open":""}`,onClick:()=>c(!l),"aria-label":"Menu","aria-expanded":l,children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})}),l&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mobile-overlay",onClick:()=>c(!1)}),e.jsxs("nav",{className:"mobile-sheet",role:"navigation",children:[e.jsx("div",{className:"sheet-handle"}),e.jsxs("div",{className:"sheet-header",children:[e.jsxs("span",{className:"sheet-logo",children:["🌿 ",e.jsx("strong",{children:"GreenFCO"})]}),e.jsx("button",{className:"sheet-close",onClick:()=>c(!1),children:"✕"})]}),e.jsx("div",{className:"sheet-links",children:b.map(h=>e.jsxs(Je,{to:h.to,end:h.exact,className:({isActive:j})=>`sheet-link ${j?"sheet-link-active":""}`,onClick:()=>c(!1),children:[e.jsx("span",{className:"sheet-link-icon",children:h.icon}),e.jsx("span",{children:h.label})]},h.to))}),!a&&e.jsxs("div",{className:"sheet-auth",children:[e.jsx(S,{to:"/register",className:"btn btn-primary",style:{width:"100%",justifyContent:"center"},onClick:()=>c(!1),children:s==="fr"?"Créer un compte gratuit":"Create free account"}),e.jsx(S,{to:"/login",className:"btn btn-secondary",style:{width:"100%",justifyContent:"center"},onClick:()=>c(!1),children:r("nav.login")})]}),a&&e.jsx("div",{className:"sheet-auth",children:e.jsx("button",{onClick:x,className:"btn btn-secondary",style:{width:"100%",justifyContent:"center",color:"#c00",borderColor:"#c00"},children:r("nav.logout")})})]})]})]})}function Ns(){const{t:r}=D(),t=new Date().getFullYear();return e.jsxs("footer",{className:"footer",children:[e.jsx("div",{className:"footer-grain"}),e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"footer-top",children:[e.jsxs("div",{className:"footer-brand",children:[e.jsxs(S,{to:"/",className:"footer-logo",children:[e.jsx("span",{children:"🌿"}),e.jsxs("span",{children:[e.jsx("span",{style:{color:"var(--green-light)"},children:"Green"}),"FCO"]})]}),e.jsxs("p",{className:"footer-slogan",children:['"',r("footer.slogan"),'"']}),e.jsx("p",{className:"footer-founded",children:r("footer.founded")}),e.jsxs("div",{className:"footer-social",children:[e.jsx("a",{href:"https://facebook.com",target:"_blank",rel:"noreferrer","aria-label":"Facebook",children:e.jsx(Cs,{})}),e.jsx("a",{href:"https://twitter.com",target:"_blank",rel:"noreferrer","aria-label":"Twitter",children:e.jsx(Ss,{})}),e.jsx("a",{href:"https://linkedin.com",target:"_blank",rel:"noreferrer","aria-label":"LinkedIn",children:e.jsx(_s,{})}),e.jsx("a",{href:"https://wa.me/22600000000",target:"_blank",rel:"noreferrer","aria-label":"WhatsApp",children:e.jsx(Fs,{})})]})]}),e.jsxs("div",{className:"footer-nav",children:[e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"Navigation"}),e.jsx(S,{to:"/",children:r("nav.home")}),e.jsx(S,{to:"/about",children:r("nav.about")}),e.jsx(S,{to:"/services",children:r("nav.services")}),e.jsx(S,{to:"/blog",children:r("nav.blog")}),e.jsx(S,{to:"/gallery",children:r("nav.gallery")}),e.jsx(S,{to:"/contact",children:r("nav.contact")})]}),e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"Plateforme"}),e.jsx(S,{to:"/dashboard",children:r("nav.dashboard")}),e.jsx(S,{to:"/marketplace",children:r("nav.marketplace")}),e.jsx(S,{to:"/agropro",children:r("nav.agropro")}),e.jsx(S,{to:"/network",children:r("nav.network")}),e.jsx(S,{to:"/register",children:r("nav.register")})]}),e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"Contact"}),e.jsx("a",{href:"mailto:info@greenfco.com",children:"info@greenfco.com"}),e.jsx("a",{href:"https://wa.me/22600000000",target:"_blank",rel:"noreferrer",children:"WhatsApp"}),e.jsx("span",{children:"Ouagadougou, Burkina Faso"})]})]})]}),e.jsxs("div",{className:"footer-bottom",children:[e.jsxs("p",{children:["© ",t," Green Field Consortium (GreenFCO). ",r("footer.rights"),"."]}),e.jsxs("div",{className:"footer-badges",children:[e.jsx("span",{className:"badge badge-green",children:"🏅 YALI Fellow 2023"}),e.jsx("span",{className:"badge badge-green",children:"🏅 Humboldt Fellow 2025"})]})]})]})]})}function Cs(){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"18",height:"18",children:e.jsx("path",{d:"M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"})})}function Ss(){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"18",height:"18",children:e.jsx("path",{d:"M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"})})}function _s(){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"18",height:"18",children:[e.jsx("path",{d:"M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z"}),e.jsx("circle",{cx:"4",cy:"4",r:"2"})]})}function Fs(){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"18",height:"18",children:e.jsx("path",{d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413z"})})}function Xr(r,t){return function(){return r.apply(t,arguments)}}const{toString:ks}=Object.prototype,{getPrototypeOf:De}=Object,{iterator:Ie,toStringTag:Qr}=Symbol,Be=(r=>t=>{const s=ks.call(t);return r[s]||(r[s]=s.slice(8,-1).toLowerCase())})(Object.create(null)),M=r=>(r=r.toLowerCase(),t=>Be(t)===r),Me=r=>t=>typeof t===r,{isArray:de}=Array,ce=Me("undefined");function ge(r){return r!==null&&!ce(r)&&r.constructor!==null&&!ce(r.constructor)&&T(r.constructor.isBuffer)&&r.constructor.isBuffer(r)}const Zr=M("ArrayBuffer");function Es(r){let t;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?t=ArrayBuffer.isView(r):t=r&&r.buffer&&Zr(r.buffer),t}const Os=Me("string"),T=Me("function"),et=Me("number"),be=r=>r!==null&&typeof r=="object",qs=r=>r===!0||r===!1,Ee=r=>{if(Be(r)!=="object")return!1;const t=De(r);return(t===null||t===Object.prototype||Object.getPrototypeOf(t)===null)&&!(Qr in r)&&!(Ie in r)},Rs=r=>{if(!be(r)||ge(r))return!1;try{return Object.keys(r).length===0&&Object.getPrototypeOf(r)===Object.prototype}catch{return!1}},Ls=M("Date"),Ps=M("File"),Ts=r=>!!(r&&typeof r.uri<"u"),Ds=r=>r&&typeof r.getParts<"u",Is=M("Blob"),Bs=M("FileList"),Ms=r=>be(r)&&T(r.pipe);function zs(){return typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}}const Cr=zs(),Sr=typeof Cr.FormData<"u"?Cr.FormData:void 0,Gs=r=>{if(!r)return!1;if(Sr&&r instanceof Sr)return!0;const t=De(r);if(!t||t===Object.prototype||!T(r.append))return!1;const s=Be(r);return s==="formdata"||s==="object"&&T(r.toString)&&r.toString()==="[object FormData]"},Ws=M("URLSearchParams"),[Us,$s,Hs,Vs]=["ReadableStream","Request","Response","Headers"].map(M),Js=r=>r.trim?r.trim():r.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"");function ve(r,t,{allOwnKeys:s=!1}={}){if(r===null||typeof r>"u")return;let n,a;if(typeof r!="object"&&(r=[r]),de(r))for(n=0,a=r.length;n<a;n++)t.call(null,r[n],n,r);else{if(ge(r))return;const i=s?Object.getOwnPropertyNames(r):Object.keys(r),o=i.length;let l;for(n=0;n<o;n++)l=i[n],t.call(null,r[l],l,r)}}function rt(r,t){if(ge(r))return null;t=t.toLowerCase();const s=Object.keys(r);let n=s.length,a;for(;n-- >0;)if(a=s[n],t===a.toLowerCase())return a;return null}const ne=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:global,tt=r=>!ce(r)&&r!==ne;function tr(...r){const{caseless:t,skipUndefined:s}=tt(this)&&this||{},n={},a=(i,o)=>{if(o==="__proto__"||o==="constructor"||o==="prototype")return;const l=t&&rt(n,o)||o,c=sr(n,l)?n[l]:void 0;Ee(c)&&Ee(i)?n[l]=tr(c,i):Ee(i)?n[l]=tr({},i):de(i)?n[l]=i.slice():(!s||!ce(i))&&(n[l]=i)};for(let i=0,o=r.length;i<o;i++)r[i]&&ve(r[i],a);return n}const Ks=(r,t,s,{allOwnKeys:n}={})=>(ve(t,(a,i)=>{s&&T(a)?Object.defineProperty(r,i,{__proto__:null,value:Xr(a,s),writable:!0,enumerable:!0,configurable:!0}):Object.defineProperty(r,i,{__proto__:null,value:a,writable:!0,enumerable:!0,configurable:!0})},{allOwnKeys:n}),r),Ys=r=>(r.charCodeAt(0)===65279&&(r=r.slice(1)),r),Xs=(r,t,s,n)=>{r.prototype=Object.create(t.prototype,n),Object.defineProperty(r.prototype,"constructor",{__proto__:null,value:r,writable:!0,enumerable:!1,configurable:!0}),Object.defineProperty(r,"super",{__proto__:null,value:t.prototype}),s&&Object.assign(r.prototype,s)},Qs=(r,t,s,n)=>{let a,i,o;const l={};if(t=t||{},r==null)return t;do{for(a=Object.getOwnPropertyNames(r),i=a.length;i-- >0;)o=a[i],(!n||n(o,r,t))&&!l[o]&&(t[o]=r[o],l[o]=!0);r=s!==!1&&De(r)}while(r&&(!s||s(r,t))&&r!==Object.prototype);return t},Zs=(r,t,s)=>{r=String(r),(s===void 0||s>r.length)&&(s=r.length),s-=t.length;const n=r.indexOf(t,s);return n!==-1&&n===s},en=r=>{if(!r)return null;if(de(r))return r;let t=r.length;if(!et(t))return null;const s=new Array(t);for(;t-- >0;)s[t]=r[t];return s},rn=(r=>t=>r&&t instanceof r)(typeof Uint8Array<"u"&&De(Uint8Array)),tn=(r,t)=>{const n=(r&&r[Ie]).call(r);let a;for(;(a=n.next())&&!a.done;){const i=a.value;t.call(r,i[0],i[1])}},sn=(r,t)=>{let s;const n=[];for(;(s=r.exec(t))!==null;)n.push(s);return n},nn=M("HTMLFormElement"),an=r=>r.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,function(s,n,a){return n.toUpperCase()+a}),sr=(({hasOwnProperty:r})=>(t,s)=>r.call(t,s))(Object.prototype),on=M("RegExp"),st=(r,t)=>{const s=Object.getOwnPropertyDescriptors(r),n={};ve(s,(a,i)=>{let o;(o=t(a,i,r))!==!1&&(n[i]=o||a)}),Object.defineProperties(r,n)},ln=r=>{st(r,(t,s)=>{if(T(r)&&["arguments","caller","callee"].includes(s))return!1;const n=r[s];if(T(n)){if(t.enumerable=!1,"writable"in t){t.writable=!1;return}t.set||(t.set=()=>{throw Error("Can not rewrite read-only method '"+s+"'")})}})},cn=(r,t)=>{const s={},n=a=>{a.forEach(i=>{s[i]=!0})};return de(r)?n(r):n(String(r).split(t)),s},un=()=>{},dn=(r,t)=>r!=null&&Number.isFinite(r=+r)?r:t;function mn(r){return!!(r&&T(r.append)&&r[Qr]==="FormData"&&r[Ie])}const pn=r=>{const t=new WeakSet,s=n=>{if(be(n)){if(t.has(n))return;if(ge(n))return n;if(!("toJSON"in n)){t.add(n);const a=de(n)?[]:{};return ve(n,(i,o)=>{const l=s(i);!ce(l)&&(a[o]=l)}),t.delete(n),a}}return n};return s(r)},hn=M("AsyncFunction"),fn=r=>r&&(be(r)||T(r))&&T(r.then)&&T(r.catch),nt=((r,t)=>r?setImmediate:t?((s,n)=>(ne.addEventListener("message",({source:a,data:i})=>{a===ne&&i===s&&n.length&&n.shift()()},!1),a=>{n.push(a),ne.postMessage(s,"*")}))(`axios@${Math.random()}`,[]):s=>setTimeout(s))(typeof setImmediate=="function",T(ne.postMessage)),gn=typeof queueMicrotask<"u"?queueMicrotask.bind(ne):typeof process<"u"&&process.nextTick||nt,bn=r=>r!=null&&T(r[Ie]),d={isArray:de,isArrayBuffer:Zr,isBuffer:ge,isFormData:Gs,isArrayBufferView:Es,isString:Os,isNumber:et,isBoolean:qs,isObject:be,isPlainObject:Ee,isEmptyObject:Rs,isReadableStream:Us,isRequest:$s,isResponse:Hs,isHeaders:Vs,isUndefined:ce,isDate:Ls,isFile:Ps,isReactNativeBlob:Ts,isReactNative:Ds,isBlob:Is,isRegExp:on,isFunction:T,isStream:Ms,isURLSearchParams:Ws,isTypedArray:rn,isFileList:Bs,forEach:ve,merge:tr,extend:Ks,trim:Js,stripBOM:Ys,inherits:Xs,toFlatObject:Qs,kindOf:Be,kindOfTest:M,endsWith:Zs,toArray:en,forEachEntry:tn,matchAll:sn,isHTMLForm:nn,hasOwnProperty:sr,hasOwnProp:sr,reduceDescriptors:st,freezeMethods:ln,toObjectSet:cn,toCamelCase:an,noop:un,toFiniteNumber:dn,findKey:rt,global:ne,isContextDefined:tt,isSpecCompliantForm:mn,toJSONObject:pn,isAsyncFn:hn,isThenable:fn,setImmediate:nt,asap:gn,isIterable:bn},vn=d.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]),xn=r=>{const t={};let s,n,a;return r&&r.split(`
`).forEach(function(o){a=o.indexOf(":"),s=o.substring(0,a).trim().toLowerCase(),n=o.substring(a+1).trim(),!(!s||t[s]&&vn[s])&&(s==="set-cookie"?t[s]?t[s].push(n):t[s]=[n]:t[s]=t[s]?t[s]+", "+n:n)}),t};function yn(r){let t=0,s=r.length;for(;t<s;){const n=r.charCodeAt(t);if(n!==9&&n!==32)break;t+=1}for(;s>t;){const n=r.charCodeAt(s-1);if(n!==9&&n!==32)break;s-=1}return t===0&&s===r.length?r:r.slice(t,s)}const jn=new RegExp("[\\u0000-\\u0008\\u000a-\\u001f\\u007f]+","g"),An=new RegExp("[^\\u0009\\u0020-\\u007e\\u0080-\\u00ff]+","g");function ur(r,t){return d.isArray(r)?r.map(s=>ur(s,t)):yn(String(r).replace(t,""))}const wn=r=>ur(r,jn),Nn=r=>ur(r,An);function at(r){const t=Object.create(null);return d.forEach(r.toJSON(),(s,n)=>{t[n]=Nn(s)}),t}const _r=Symbol("internals");function he(r){return r&&String(r).trim().toLowerCase()}function Oe(r){return r===!1||r==null?r:d.isArray(r)?r.map(Oe):wn(String(r))}function Cn(r){const t=Object.create(null),s=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let n;for(;n=s.exec(r);)t[n[1]]=n[2];return t}const Sn=r=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(r.trim());function Ke(r,t,s,n,a){if(d.isFunction(n))return n.call(this,t,s);if(a&&(t=s),!!d.isString(t)){if(d.isString(n))return t.indexOf(n)!==-1;if(d.isRegExp(n))return n.test(t)}}function _n(r){return r.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,s,n)=>s.toUpperCase()+n)}function Fn(r,t){const s=d.toCamelCase(" "+t);["get","set","has"].forEach(n=>{Object.defineProperty(r,n+s,{__proto__:null,value:function(a,i,o){return this[n].call(this,t,a,i,o)},configurable:!0})})}let P=class{constructor(t){t&&this.set(t)}set(t,s,n){const a=this;function i(l,c,u){const m=he(c);if(!m)throw new Error("header name must be a non-empty string");const p=d.findKey(a,m);(!p||a[p]===void 0||u===!0||u===void 0&&a[p]!==!1)&&(a[p||c]=Oe(l))}const o=(l,c)=>d.forEach(l,(u,m)=>i(u,m,c));if(d.isPlainObject(t)||t instanceof this.constructor)o(t,s);else if(d.isString(t)&&(t=t.trim())&&!Sn(t))o(xn(t),s);else if(d.isObject(t)&&d.isIterable(t)){let l={},c,u;for(const m of t){if(!d.isArray(m))throw TypeError("Object iterator must return a key-value pair");l[u=m[0]]=(c=l[u])?d.isArray(c)?[...c,m[1]]:[c,m[1]]:m[1]}o(l,s)}else t!=null&&i(s,t,n);return this}get(t,s){if(t=he(t),t){const n=d.findKey(this,t);if(n){const a=this[n];if(!s)return a;if(s===!0)return Cn(a);if(d.isFunction(s))return s.call(this,a,n);if(d.isRegExp(s))return s.exec(a);throw new TypeError("parser must be boolean|regexp|function")}}}has(t,s){if(t=he(t),t){const n=d.findKey(this,t);return!!(n&&this[n]!==void 0&&(!s||Ke(this,this[n],n,s)))}return!1}delete(t,s){const n=this;let a=!1;function i(o){if(o=he(o),o){const l=d.findKey(n,o);l&&(!s||Ke(n,n[l],l,s))&&(delete n[l],a=!0)}}return d.isArray(t)?t.forEach(i):i(t),a}clear(t){const s=Object.keys(this);let n=s.length,a=!1;for(;n--;){const i=s[n];(!t||Ke(this,this[i],i,t,!0))&&(delete this[i],a=!0)}return a}normalize(t){const s=this,n={};return d.forEach(this,(a,i)=>{const o=d.findKey(n,i);if(o){s[o]=Oe(a),delete s[i];return}const l=t?_n(i):String(i).trim();l!==i&&delete s[i],s[l]=Oe(a),n[l]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){const s=Object.create(null);return d.forEach(this,(n,a)=>{n!=null&&n!==!1&&(s[a]=t&&d.isArray(n)?n.join(", "):n)}),s}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,s])=>t+": "+s).join(`
`)}getSetCookie(){return this.get("set-cookie")||[]}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...s){const n=new this(t);return s.forEach(a=>n.set(a)),n}static accessor(t){const n=(this[_r]=this[_r]={accessors:{}}).accessors,a=this.prototype;function i(o){const l=he(o);n[l]||(Fn(a,o),n[l]=!0)}return d.isArray(t)?t.forEach(i):i(t),this}};P.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]);d.reduceDescriptors(P.prototype,({value:r},t)=>{let s=t[0].toUpperCase()+t.slice(1);return{get:()=>r,set(n){this[s]=n}}});d.freezeMethods(P);const kn="[REDACTED ****]";function En(r){if(d.hasOwnProp(r,"toJSON"))return!0;let t=Object.getPrototypeOf(r);for(;t&&t!==Object.prototype;){if(d.hasOwnProp(t,"toJSON"))return!0;t=Object.getPrototypeOf(t)}return!1}function On(r,t){const s=new Set(t.map(i=>String(i).toLowerCase())),n=[],a=i=>{if(i===null||typeof i!="object"||d.isBuffer(i))return i;if(n.indexOf(i)!==-1)return;i instanceof P&&(i=i.toJSON()),n.push(i);let o;if(d.isArray(i))o=[],i.forEach((l,c)=>{const u=a(l);d.isUndefined(u)||(o[c]=u)});else{if(!d.isPlainObject(i)&&En(i))return n.pop(),i;o=Object.create(null);for(const[l,c]of Object.entries(i)){const u=s.has(l.toLowerCase())?kn:a(c);d.isUndefined(u)||(o[l]=u)}}return n.pop(),o};return a(r)}let w=class it extends Error{static from(t,s,n,a,i,o){const l=new it(t.message,s||t.code,n,a,i);return l.cause=t,l.name=t.name,t.status!=null&&l.status==null&&(l.status=t.status),o&&Object.assign(l,o),l}constructor(t,s,n,a,i){super(t),Object.defineProperty(this,"message",{__proto__:null,value:t,enumerable:!0,writable:!0,configurable:!0}),this.name="AxiosError",this.isAxiosError=!0,s&&(this.code=s),n&&(this.config=n),a&&(this.request=a),i&&(this.response=i,this.status=i.status)}toJSON(){const t=this.config,s=t&&d.hasOwnProp(t,"redact")?t.redact:void 0,n=d.isArray(s)&&s.length>0?On(t,s):d.toJSONObject(t);return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:n,code:this.code,status:this.status}}};w.ERR_BAD_OPTION_VALUE="ERR_BAD_OPTION_VALUE";w.ERR_BAD_OPTION="ERR_BAD_OPTION";w.ECONNABORTED="ECONNABORTED";w.ETIMEDOUT="ETIMEDOUT";w.ECONNREFUSED="ECONNREFUSED";w.ERR_NETWORK="ERR_NETWORK";w.ERR_FR_TOO_MANY_REDIRECTS="ERR_FR_TOO_MANY_REDIRECTS";w.ERR_DEPRECATED="ERR_DEPRECATED";w.ERR_BAD_RESPONSE="ERR_BAD_RESPONSE";w.ERR_BAD_REQUEST="ERR_BAD_REQUEST";w.ERR_CANCELED="ERR_CANCELED";w.ERR_NOT_SUPPORT="ERR_NOT_SUPPORT";w.ERR_INVALID_URL="ERR_INVALID_URL";w.ERR_FORM_DATA_DEPTH_EXCEEDED="ERR_FORM_DATA_DEPTH_EXCEEDED";const qn=null;function nr(r){return d.isPlainObject(r)||d.isArray(r)}function ot(r){return d.endsWith(r,"[]")?r.slice(0,-2):r}function Ye(r,t,s){return r?r.concat(t).map(function(a,i){return a=ot(a),!s&&i?"["+a+"]":a}).join(s?".":""):t}function Rn(r){return d.isArray(r)&&!r.some(nr)}const Ln=d.toFlatObject(d,{},null,function(t){return/^is[A-Z]/.test(t)});function ze(r,t,s){if(!d.isObject(r))throw new TypeError("target must be an object");t=t||new FormData,s=d.toFlatObject(s,{metaTokens:!0,dots:!1,indexes:!1},!1,function(g,A){return!d.isUndefined(A[g])});const n=s.metaTokens,a=s.visitor||p,i=s.dots,o=s.indexes,l=s.Blob||typeof Blob<"u"&&Blob,c=s.maxDepth===void 0?100:s.maxDepth,u=l&&d.isSpecCompliantForm(t);if(!d.isFunction(a))throw new TypeError("visitor must be a function");function m(x){if(x===null)return"";if(d.isDate(x))return x.toISOString();if(d.isBoolean(x))return x.toString();if(!u&&d.isBlob(x))throw new w("Blob is not supported. Use a Buffer instead.");return d.isArrayBuffer(x)||d.isTypedArray(x)?u&&typeof Blob=="function"?new Blob([x]):Buffer.from(x):x}function p(x,g,A){let N=x;if(d.isReactNative(t)&&d.isReactNativeBlob(x))return t.append(Ye(A,g,i),m(x)),!1;if(x&&!A&&typeof x=="object"){if(d.endsWith(g,"{}"))g=n?g:g.slice(0,-2),x=JSON.stringify(x);else if(d.isArray(x)&&Rn(x)||(d.isFileList(x)||d.endsWith(g,"[]"))&&(N=d.toArray(x)))return g=ot(g),N.forEach(function(j,_){!(d.isUndefined(j)||j===null)&&t.append(o===!0?Ye([g],_,i):o===null?g:g+"[]",m(j))}),!1}return nr(x)?!0:(t.append(Ye(A,g,i),m(x)),!1)}const y=[],f=Object.assign(Ln,{defaultVisitor:p,convertValue:m,isVisitable:nr});function b(x,g,A=0){if(!d.isUndefined(x)){if(A>c)throw new w("Object is too deeply nested ("+A+" levels). Max depth: "+c,w.ERR_FORM_DATA_DEPTH_EXCEEDED);if(y.indexOf(x)!==-1)throw Error("Circular reference detected in "+g.join("."));y.push(x),d.forEach(x,function(h,j){(!(d.isUndefined(h)||h===null)&&a.call(t,h,d.isString(j)?j.trim():j,g,f))===!0&&b(h,g?g.concat(j):[j],A+1)}),y.pop()}}if(!d.isObject(r))throw new TypeError("data must be an object");return b(r),t}function Fr(r){const t={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+"};return encodeURIComponent(r).replace(/[!'()~]|%20/g,function(n){return t[n]})}function dr(r,t){this._pairs=[],r&&ze(r,this,t)}const lt=dr.prototype;lt.append=function(t,s){this._pairs.push([t,s])};lt.toString=function(t){const s=t?function(n){return t.call(this,n,Fr)}:Fr;return this._pairs.map(function(a){return s(a[0])+"="+s(a[1])},"").join("&")};function Pn(r){return encodeURIComponent(r).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+")}function ct(r,t,s){if(!t)return r;const n=s&&s.encode||Pn,a=d.isFunction(s)?{serialize:s}:s,i=a&&a.serialize;let o;if(i?o=i(t,a):o=d.isURLSearchParams(t)?t.toString():new dr(t,a).toString(n),o){const l=r.indexOf("#");l!==-1&&(r=r.slice(0,l)),r+=(r.indexOf("?")===-1?"?":"&")+o}return r}class kr{constructor(){this.handlers=[]}use(t,s,n){return this.handlers.push({fulfilled:t,rejected:s,synchronous:n?n.synchronous:!1,runWhen:n?n.runWhen:null}),this.handlers.length-1}eject(t){this.handlers[t]&&(this.handlers[t]=null)}clear(){this.handlers&&(this.handlers=[])}forEach(t){d.forEach(this.handlers,function(n){n!==null&&t(n)})}}const mr={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1,legacyInterceptorReqResOrdering:!0},Tn=typeof URLSearchParams<"u"?URLSearchParams:dr,Dn=typeof FormData<"u"?FormData:null,In=typeof Blob<"u"?Blob:null,Bn={isBrowser:!0,classes:{URLSearchParams:Tn,FormData:Dn,Blob:In},protocols:["http","https","file","blob","url","data"]},pr=typeof window<"u"&&typeof document<"u",ar=typeof navigator=="object"&&navigator||void 0,Mn=pr&&(!ar||["ReactNative","NativeScript","NS"].indexOf(ar.product)<0),zn=typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope&&typeof self.importScripts=="function",Gn=pr&&window.location.href||"http://localhost",Wn=Object.freeze(Object.defineProperty({__proto__:null,hasBrowserEnv:pr,hasStandardBrowserEnv:Mn,hasStandardBrowserWebWorkerEnv:zn,navigator:ar,origin:Gn},Symbol.toStringTag,{value:"Module"})),L={...Wn,...Bn};function Un(r,t){return ze(r,new L.classes.URLSearchParams,{visitor:function(s,n,a,i){return L.isNode&&d.isBuffer(s)?(this.append(n,s.toString("base64")),!1):i.defaultVisitor.apply(this,arguments)},...t})}function $n(r){return d.matchAll(/\w+|\[(\w*)]/g,r).map(t=>t[0]==="[]"?"":t[1]||t[0])}function Hn(r){const t={},s=Object.keys(r);let n;const a=s.length;let i;for(n=0;n<a;n++)i=s[n],t[i]=r[i];return t}function ut(r){function t(s,n,a,i){let o=s[i++];if(o==="__proto__")return!0;const l=Number.isFinite(+o),c=i>=s.length;return o=!o&&d.isArray(a)?a.length:o,c?(d.hasOwnProp(a,o)?a[o]=d.isArray(a[o])?a[o].concat(n):[a[o],n]:a[o]=n,!l):((!d.hasOwnProp(a,o)||!d.isObject(a[o]))&&(a[o]=[]),t(s,n,a[o],i)&&d.isArray(a[o])&&(a[o]=Hn(a[o])),!l)}if(d.isFormData(r)&&d.isFunction(r.entries)){const s={};return d.forEachEntry(r,(n,a)=>{t($n(n),a,s,0)}),s}return null}const le=(r,t)=>r!=null&&d.hasOwnProp(r,t)?r[t]:void 0;function Vn(r,t,s){if(d.isString(r))try{return(t||JSON.parse)(r),d.trim(r)}catch(n){if(n.name!=="SyntaxError")throw n}return(s||JSON.stringify)(r)}const xe={transitional:mr,adapter:["xhr","http","fetch"],transformRequest:[function(t,s){const n=s.getContentType()||"",a=n.indexOf("application/json")>-1,i=d.isObject(t);if(i&&d.isHTMLForm(t)&&(t=new FormData(t)),d.isFormData(t))return a?JSON.stringify(ut(t)):t;if(d.isArrayBuffer(t)||d.isBuffer(t)||d.isStream(t)||d.isFile(t)||d.isBlob(t)||d.isReadableStream(t))return t;if(d.isArrayBufferView(t))return t.buffer;if(d.isURLSearchParams(t))return s.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),t.toString();let l;if(i){const c=le(this,"formSerializer");if(n.indexOf("application/x-www-form-urlencoded")>-1)return Un(t,c).toString();if((l=d.isFileList(t))||n.indexOf("multipart/form-data")>-1){const u=le(this,"env"),m=u&&u.FormData;return ze(l?{"files[]":t}:t,m&&new m,c)}}return i||a?(s.setContentType("application/json",!1),Vn(t)):t}],transformResponse:[function(t){const s=le(this,"transitional")||xe.transitional,n=s&&s.forcedJSONParsing,a=le(this,"responseType"),i=a==="json";if(d.isResponse(t)||d.isReadableStream(t))return t;if(t&&d.isString(t)&&(n&&!a||i)){const l=!(s&&s.silentJSONParsing)&&i;try{return JSON.parse(t,le(this,"parseReviver"))}catch(c){if(l)throw c.name==="SyntaxError"?w.from(c,w.ERR_BAD_RESPONSE,this,null,le(this,"response")):c}}return t}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:L.classes.FormData,Blob:L.classes.Blob},validateStatus:function(t){return t>=200&&t<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};d.forEach(["delete","get","head","post","put","patch","query"],r=>{xe.headers[r]={}});function Xe(r,t){const s=this||xe,n=t||s,a=P.from(n.headers);let i=n.data;return d.forEach(r,function(l){i=l.call(s,i,a.normalize(),t?t.status:void 0)}),a.normalize(),i}function dt(r){return!!(r&&r.__CANCEL__)}let ye=class extends w{constructor(t,s,n){super(t??"canceled",w.ERR_CANCELED,s,n),this.name="CanceledError",this.__CANCEL__=!0}};function mt(r,t,s){const n=s.config.validateStatus;!s.status||!n||n(s.status)?r(s):t(new w("Request failed with status code "+s.status,s.status>=400&&s.status<500?w.ERR_BAD_REQUEST:w.ERR_BAD_RESPONSE,s.config,s.request,s))}function Jn(r){const t=/^([-+\w]{1,25}):(?:\/\/)?/.exec(r);return t&&t[1]||""}function Kn(r,t){r=r||10;const s=new Array(r),n=new Array(r);let a=0,i=0,o;return t=t!==void 0?t:1e3,function(c){const u=Date.now(),m=n[i];o||(o=u),s[a]=c,n[a]=u;let p=i,y=0;for(;p!==a;)y+=s[p++],p=p%r;if(a=(a+1)%r,a===i&&(i=(i+1)%r),u-o<t)return;const f=m&&u-m;return f?Math.round(y*1e3/f):void 0}}function Yn(r,t){let s=0,n=1e3/t,a,i;const o=(u,m=Date.now())=>{s=m,a=null,i&&(clearTimeout(i),i=null),r(...u)};return[(...u)=>{const m=Date.now(),p=m-s;p>=n?o(u,m):(a=u,i||(i=setTimeout(()=>{i=null,o(a)},n-p)))},()=>a&&o(a)]}const Pe=(r,t,s=3)=>{let n=0;const a=Kn(50,250);return Yn(i=>{if(!i||typeof i.loaded!="number")return;const o=i.loaded,l=i.lengthComputable?i.total:void 0,c=l!=null?Math.min(o,l):o,u=Math.max(0,c-n),m=a(u);n=Math.max(n,c);const p={loaded:c,total:l,progress:l?c/l:void 0,bytes:u,rate:m||void 0,estimated:m&&l?(l-c)/m:void 0,event:i,lengthComputable:l!=null,[t?"download":"upload"]:!0};r(p)},s)},Er=(r,t)=>{const s=r!=null;return[n=>t[0]({lengthComputable:s,total:r,loaded:n}),t[1]]},Or=r=>(...t)=>d.asap(()=>r(...t)),Xn=L.hasStandardBrowserEnv?((r,t)=>s=>(s=new URL(s,L.origin),r.protocol===s.protocol&&r.host===s.host&&(t||r.port===s.port)))(new URL(L.origin),L.navigator&&/(msie|trident)/i.test(L.navigator.userAgent)):()=>!0,Qn=L.hasStandardBrowserEnv?{write(r,t,s,n,a,i,o){if(typeof document>"u")return;const l=[`${r}=${encodeURIComponent(t)}`];d.isNumber(s)&&l.push(`expires=${new Date(s).toUTCString()}`),d.isString(n)&&l.push(`path=${n}`),d.isString(a)&&l.push(`domain=${a}`),i===!0&&l.push("secure"),d.isString(o)&&l.push(`SameSite=${o}`),document.cookie=l.join("; ")},read(r){if(typeof document>"u")return null;const t=document.cookie.split(";");for(let s=0;s<t.length;s++){const n=t[s].replace(/^\s+/,""),a=n.indexOf("=");if(a!==-1&&n.slice(0,a)===r)return decodeURIComponent(n.slice(a+1))}return null},remove(r){this.write(r,"",Date.now()-864e5,"/")}}:{write(){},read(){return null},remove(){}};function Zn(r){return typeof r!="string"?!1:/^([a-z][a-z\d+\-.]*:)?\/\//i.test(r)}function ea(r,t){return t?r.replace(/\/?\/$/,"")+"/"+t.replace(/^\/+/,""):r}function pt(r,t,s){let n=!Zn(t);return r&&(n||s===!1)?ea(r,t):t}const qr=r=>r instanceof P?{...r}:r;function ie(r,t){t=t||{};const s=Object.create(null);Object.defineProperty(s,"hasOwnProperty",{__proto__:null,value:Object.prototype.hasOwnProperty,enumerable:!1,writable:!0,configurable:!0});function n(u,m,p,y){return d.isPlainObject(u)&&d.isPlainObject(m)?d.merge.call({caseless:y},u,m):d.isPlainObject(m)?d.merge({},m):d.isArray(m)?m.slice():m}function a(u,m,p,y){if(d.isUndefined(m)){if(!d.isUndefined(u))return n(void 0,u,p,y)}else return n(u,m,p,y)}function i(u,m){if(!d.isUndefined(m))return n(void 0,m)}function o(u,m){if(d.isUndefined(m)){if(!d.isUndefined(u))return n(void 0,u)}else return n(void 0,m)}function l(u,m,p){if(d.hasOwnProp(t,p))return n(u,m);if(d.hasOwnProp(r,p))return n(void 0,u)}const c={url:i,method:i,data:i,baseURL:o,transformRequest:o,transformResponse:o,paramsSerializer:o,timeout:o,timeoutMessage:o,withCredentials:o,withXSRFToken:o,adapter:o,responseType:o,xsrfCookieName:o,xsrfHeaderName:o,onUploadProgress:o,onDownloadProgress:o,decompress:o,maxContentLength:o,maxBodyLength:o,beforeRedirect:o,transport:o,httpAgent:o,httpsAgent:o,cancelToken:o,socketPath:o,allowedSocketPaths:o,responseEncoding:o,validateStatus:l,headers:(u,m,p)=>a(qr(u),qr(m),p,!0)};return d.forEach(Object.keys({...r,...t}),function(m){if(m==="__proto__"||m==="constructor"||m==="prototype")return;const p=d.hasOwnProp(c,m)?c[m]:a,y=d.hasOwnProp(r,m)?r[m]:void 0,f=d.hasOwnProp(t,m)?t[m]:void 0,b=p(y,f,m);d.isUndefined(b)&&p!==l||(s[m]=b)}),s}const ra=["content-type","content-length"];function ta(r,t,s){if(s!=="content-only"){r.set(t);return}Object.entries(t).forEach(([n,a])=>{ra.includes(n.toLowerCase())&&r.set(n,a)})}const sa=r=>encodeURIComponent(r).replace(/%([0-9A-F]{2})/gi,(t,s)=>String.fromCharCode(parseInt(s,16))),ht=r=>{const t=ie({},r),s=y=>d.hasOwnProp(t,y)?t[y]:void 0,n=s("data");let a=s("withXSRFToken");const i=s("xsrfHeaderName"),o=s("xsrfCookieName");let l=s("headers");const c=s("auth"),u=s("baseURL"),m=s("allowAbsoluteUrls"),p=s("url");if(t.headers=l=P.from(l),t.url=ct(pt(u,p,m),r.params,r.paramsSerializer),c&&l.set("Authorization","Basic "+btoa((c.username||"")+":"+(c.password?sa(c.password):""))),d.isFormData(n)&&(L.hasStandardBrowserEnv||L.hasStandardBrowserWebWorkerEnv?l.setContentType(void 0):d.isFunction(n.getHeaders)&&ta(l,n.getHeaders(),s("formDataHeaderPolicy"))),L.hasStandardBrowserEnv&&(d.isFunction(a)&&(a=a(t)),a===!0||a==null&&Xn(t.url))){const f=i&&o&&Qn.read(o);f&&l.set(i,f)}return t},na=typeof XMLHttpRequest<"u",aa=na&&function(r){return new Promise(function(s,n){const a=ht(r);let i=a.data;const o=P.from(a.headers).normalize();let{responseType:l,onUploadProgress:c,onDownloadProgress:u}=a,m,p,y,f,b;function x(){f&&f(),b&&b(),a.cancelToken&&a.cancelToken.unsubscribe(m),a.signal&&a.signal.removeEventListener("abort",m)}let g=new XMLHttpRequest;g.open(a.method.toUpperCase(),a.url,!0),g.timeout=a.timeout;function A(){if(!g)return;const h=P.from("getAllResponseHeaders"in g&&g.getAllResponseHeaders()),_={data:!l||l==="text"||l==="json"?g.responseText:g.response,status:g.status,statusText:g.statusText,headers:h,config:r,request:g};mt(function(ee){s(ee),x()},function(ee){n(ee),x()},_),g=null}"onloadend"in g?g.onloadend=A:g.onreadystatechange=function(){!g||g.readyState!==4||g.status===0&&!(g.responseURL&&g.responseURL.startsWith("file:"))||setTimeout(A)},g.onabort=function(){g&&(n(new w("Request aborted",w.ECONNABORTED,r,g)),x(),g=null)},g.onerror=function(j){const _=j&&j.message?j.message:"Network Error",q=new w(_,w.ERR_NETWORK,r,g);q.event=j||null,n(q),x(),g=null},g.ontimeout=function(){let j=a.timeout?"timeout of "+a.timeout+"ms exceeded":"timeout exceeded";const _=a.transitional||mr;a.timeoutErrorMessage&&(j=a.timeoutErrorMessage),n(new w(j,_.clarifyTimeoutError?w.ETIMEDOUT:w.ECONNABORTED,r,g)),x(),g=null},i===void 0&&o.setContentType(null),"setRequestHeader"in g&&d.forEach(at(o),function(j,_){g.setRequestHeader(_,j)}),d.isUndefined(a.withCredentials)||(g.withCredentials=!!a.withCredentials),l&&l!=="json"&&(g.responseType=a.responseType),u&&([y,b]=Pe(u,!0),g.addEventListener("progress",y)),c&&g.upload&&([p,f]=Pe(c),g.upload.addEventListener("progress",p),g.upload.addEventListener("loadend",f)),(a.cancelToken||a.signal)&&(m=h=>{g&&(n(!h||h.type?new ye(null,r,g):h),g.abort(),x(),g=null)},a.cancelToken&&a.cancelToken.subscribe(m),a.signal&&(a.signal.aborted?m():a.signal.addEventListener("abort",m)));const N=Jn(a.url);if(N&&!L.protocols.includes(N)){n(new w("Unsupported protocol "+N+":",w.ERR_BAD_REQUEST,r));return}g.send(i||null)})},ia=(r,t)=>{if(r=r?r.filter(Boolean):[],!t&&!r.length)return;const s=new AbortController;let n=!1;const a=function(c){if(!n){n=!0,o();const u=c instanceof Error?c:this.reason;s.abort(u instanceof w?u:new ye(u instanceof Error?u.message:u))}};let i=t&&setTimeout(()=>{i=null,a(new w(`timeout of ${t}ms exceeded`,w.ETIMEDOUT))},t);const o=()=>{r&&(i&&clearTimeout(i),i=null,r.forEach(c=>{c.unsubscribe?c.unsubscribe(a):c.removeEventListener("abort",a)}),r=null)};r.forEach(c=>c.addEventListener("abort",a));const{signal:l}=s;return l.unsubscribe=()=>d.asap(o),l},oa=function*(r,t){let s=r.byteLength;if(s<t){yield r;return}let n=0,a;for(;n<s;)a=n+t,yield r.slice(n,a),n=a},la=async function*(r,t){for await(const s of ca(r))yield*oa(s,t)},ca=async function*(r){if(r[Symbol.asyncIterator]){yield*r;return}const t=r.getReader();try{for(;;){const{done:s,value:n}=await t.read();if(s)break;yield n}}finally{await t.cancel()}},Rr=(r,t,s,n)=>{const a=la(r,t);let i=0,o,l=c=>{o||(o=!0,n&&n(c))};return new ReadableStream({async pull(c){try{const{done:u,value:m}=await a.next();if(u){l(),c.close();return}let p=m.byteLength;if(s){let y=i+=p;s(y)}c.enqueue(new Uint8Array(m))}catch(u){throw l(u),u}},cancel(c){return l(c),a.return()}},{highWaterMark:2})};function ua(r){if(!r||typeof r!="string"||!r.startsWith("data:"))return 0;const t=r.indexOf(",");if(t<0)return 0;const s=r.slice(5,t),n=r.slice(t+1);if(/;base64/i.test(s)){let o=n.length;const l=n.length;for(let f=0;f<l;f++)if(n.charCodeAt(f)===37&&f+2<l){const b=n.charCodeAt(f+1),x=n.charCodeAt(f+2);(b>=48&&b<=57||b>=65&&b<=70||b>=97&&b<=102)&&(x>=48&&x<=57||x>=65&&x<=70||x>=97&&x<=102)&&(o-=2,f+=2)}let c=0,u=l-1;const m=f=>f>=2&&n.charCodeAt(f-2)===37&&n.charCodeAt(f-1)===51&&(n.charCodeAt(f)===68||n.charCodeAt(f)===100);u>=0&&(n.charCodeAt(u)===61?(c++,u--):m(u)&&(c++,u-=3)),c===1&&u>=0&&(n.charCodeAt(u)===61||m(u))&&c++;const y=Math.floor(o/4)*3-(c||0);return y>0?y:0}if(typeof Buffer<"u"&&typeof Buffer.byteLength=="function")return Buffer.byteLength(n,"utf8");let i=0;for(let o=0,l=n.length;o<l;o++){const c=n.charCodeAt(o);if(c<128)i+=1;else if(c<2048)i+=2;else if(c>=55296&&c<=56319&&o+1<l){const u=n.charCodeAt(o+1);u>=56320&&u<=57343?(i+=4,o++):i+=3}else i+=3}return i}const hr="1.16.1",Lr=64*1024,{isFunction:Ce}=d,Pr=(r,...t)=>{try{return!!r(...t)}catch{return!1}},da=r=>{const t=d.global!==void 0&&d.global!==null?d.global:globalThis,{ReadableStream:s,TextEncoder:n}=t;r=d.merge.call({skipUndefined:!0},{Request:t.Request,Response:t.Response},r);const{fetch:a,Request:i,Response:o}=r,l=a?Ce(a):typeof fetch=="function",c=Ce(i),u=Ce(o);if(!l)return!1;const m=l&&Ce(s),p=l&&(typeof n=="function"?(A=>N=>A.encode(N))(new n):async A=>new Uint8Array(await new i(A).arrayBuffer())),y=c&&m&&Pr(()=>{let A=!1;const N=new i(L.origin,{body:new s,method:"POST",get duplex(){return A=!0,"half"}}),h=N.headers.has("Content-Type");return N.body!=null&&N.body.cancel(),A&&!h}),f=u&&m&&Pr(()=>d.isReadableStream(new o("").body)),b={stream:f&&(A=>A.body)};l&&["text","arrayBuffer","blob","formData","stream"].forEach(A=>{!b[A]&&(b[A]=(N,h)=>{let j=N&&N[A];if(j)return j.call(N);throw new w(`Response type '${A}' is not supported`,w.ERR_NOT_SUPPORT,h)})});const x=async A=>{if(A==null)return 0;if(d.isBlob(A))return A.size;if(d.isSpecCompliantForm(A))return(await new i(L.origin,{method:"POST",body:A}).arrayBuffer()).byteLength;if(d.isArrayBufferView(A)||d.isArrayBuffer(A))return A.byteLength;if(d.isURLSearchParams(A)&&(A=A+""),d.isString(A))return(await p(A)).byteLength},g=async(A,N)=>{const h=d.toFiniteNumber(A.getContentLength());return h??x(N)};return async A=>{let{url:N,method:h,data:j,signal:_,cancelToken:q,timeout:ee,onDownloadProgress:$e,onUploadProgress:br,responseType:V,headers:re,withCredentials:Ae="same-origin",fetchOptions:vr,maxContentLength:z,maxBodyLength:He}=ht(A);const me=d.isNumber(z)&&z>-1,St=d.isNumber(He)&&He>-1;let xr=a||fetch;V=V?(V+"").toLowerCase():"text";let J=ia([_,q&&q.toAbortSignal()],ee),I=null;const te=J&&J.unsubscribe&&(()=>{J.unsubscribe()});let yr;try{if(me&&typeof N=="string"&&N.startsWith("data:")&&ua(N)>z)throw new w("maxContentLength size of "+z+" exceeded",w.ERR_BAD_RESPONSE,A,I);if(St&&h!=="get"&&h!=="head"){const k=await g(re,j);if(typeof k=="number"&&isFinite(k)&&k>He)throw new w("Request body larger than maxBodyLength limit",w.ERR_BAD_REQUEST,A,I)}if(br&&y&&h!=="get"&&h!=="head"&&(yr=await g(re,j))!==0){let k=new i(N,{method:"POST",body:j,duplex:"half"}),oe;if(d.isFormData(j)&&(oe=k.headers.get("content-type"))&&re.setContentType(oe),k.body){const[we,Ne]=Er(yr,Pe(Or(br)));j=Rr(k.body,Lr,we,Ne)}}d.isString(Ae)||(Ae=Ae?"include":"omit");const R=c&&"credentials"in i.prototype;if(d.isFormData(j)){const k=re.getContentType();k&&/^multipart\/form-data/i.test(k)&&!/boundary=/i.test(k)&&re.delete("content-type")}re.set("User-Agent","axios/"+hr,!1);const K={...vr,signal:J,method:h.toUpperCase(),headers:at(re.normalize()),body:j,duplex:"half",credentials:R?Ae:void 0};I=c&&new i(N,K);let G=await(c?xr(I,vr):xr(N,K));if(me){const k=d.toFiniteNumber(G.headers.get("content-length"));if(k!=null&&k>z)throw new w("maxContentLength size of "+z+" exceeded",w.ERR_BAD_RESPONSE,A,I)}const Ve=f&&(V==="stream"||V==="response");if(f&&G.body&&($e||me||Ve&&te)){const k={};["status","statusText","headers"].forEach(pe=>{k[pe]=G[pe]});const oe=d.toFiniteNumber(G.headers.get("content-length")),[we,Ne]=$e&&Er(oe,Pe(Or($e),!0))||[];let jr=0;const _t=pe=>{if(me&&(jr=pe,jr>z))throw new w("maxContentLength size of "+z+" exceeded",w.ERR_BAD_RESPONSE,A,I);we&&we(pe)};G=new o(Rr(G.body,Lr,_t,()=>{Ne&&Ne(),te&&te()}),k)}V=V||"text";let $=await b[d.findKey(b,V)||"text"](G,A);if(me&&!f&&!Ve){let k;if($!=null&&(typeof $.byteLength=="number"?k=$.byteLength:typeof $.size=="number"?k=$.size:typeof $=="string"&&(k=typeof n=="function"?new n().encode($).byteLength:$.length)),typeof k=="number"&&k>z)throw new w("maxContentLength size of "+z+" exceeded",w.ERR_BAD_RESPONSE,A,I)}return!Ve&&te&&te(),await new Promise((k,oe)=>{mt(k,oe,{data:$,headers:P.from(G.headers),status:G.status,statusText:G.statusText,config:A,request:I})})}catch(R){if(te&&te(),J&&J.aborted&&J.reason instanceof w){const K=J.reason;throw K.config=A,I&&(K.request=I),R!==K&&(K.cause=R),K}throw R&&R.name==="TypeError"&&/Load failed|fetch/i.test(R.message)?Object.assign(new w("Network Error",w.ERR_NETWORK,A,I,R&&R.response),{cause:R.cause||R}):w.from(R,R&&R.code,A,I,R&&R.response)}}},ma=new Map,ft=r=>{let t=r&&r.env||{};const{fetch:s,Request:n,Response:a}=t,i=[n,a,s];let o=i.length,l=o,c,u,m=ma;for(;l--;)c=i[l],u=m.get(c),u===void 0&&m.set(c,u=l?new Map:da(t)),m=u;return u};ft();const fr={http:qn,xhr:aa,fetch:{get:ft}};d.forEach(fr,(r,t)=>{if(r){try{Object.defineProperty(r,"name",{__proto__:null,value:t})}catch{}Object.defineProperty(r,"adapterName",{__proto__:null,value:t})}});const Tr=r=>`- ${r}`,pa=r=>d.isFunction(r)||r===null||r===!1;function ha(r,t){r=d.isArray(r)?r:[r];const{length:s}=r;let n,a;const i={};for(let o=0;o<s;o++){n=r[o];let l;if(a=n,!pa(n)&&(a=fr[(l=String(n)).toLowerCase()],a===void 0))throw new w(`Unknown adapter '${l}'`);if(a&&(d.isFunction(a)||(a=a.get(t))))break;i[l||"#"+o]=a}if(!a){const o=Object.entries(i).map(([c,u])=>`adapter ${c} `+(u===!1?"is not supported by the environment":"is not available in the build"));let l=s?o.length>1?`since :
`+o.map(Tr).join(`
`):" "+Tr(o[0]):"as no adapter specified";throw new w("There is no suitable adapter to dispatch the request "+l,"ERR_NOT_SUPPORT")}return a}const gt={getAdapter:ha,adapters:fr};function Qe(r){if(r.cancelToken&&r.cancelToken.throwIfRequested(),r.signal&&r.signal.aborted)throw new ye(null,r)}function Dr(r){return Qe(r),r.headers=P.from(r.headers),r.data=Xe.call(r,r.transformRequest),["post","put","patch"].indexOf(r.method)!==-1&&r.headers.setContentType("application/x-www-form-urlencoded",!1),gt.getAdapter(r.adapter||xe.adapter,r)(r).then(function(n){Qe(r),r.response=n;try{n.data=Xe.call(r,r.transformResponse,n)}finally{delete r.response}return n.headers=P.from(n.headers),n},function(n){if(!dt(n)&&(Qe(r),n&&n.response)){r.response=n.response;try{n.response.data=Xe.call(r,r.transformResponse,n.response)}finally{delete r.response}n.response.headers=P.from(n.response.headers)}return Promise.reject(n)})}const Ge={};["object","boolean","number","function","string","symbol"].forEach((r,t)=>{Ge[r]=function(n){return typeof n===r||"a"+(t<1?"n ":" ")+r}});const Ir={};Ge.transitional=function(t,s,n){function a(i,o){return"[Axios v"+hr+"] Transitional option '"+i+"'"+o+(n?". "+n:"")}return(i,o,l)=>{if(t===!1)throw new w(a(o," has been removed"+(s?" in "+s:"")),w.ERR_DEPRECATED);return s&&!Ir[o]&&(Ir[o]=!0,console.warn(a(o," has been deprecated since v"+s+" and will be removed in the near future"))),t?t(i,o,l):!0}};Ge.spelling=function(t){return(s,n)=>(console.warn(`${n} is likely a misspelling of ${t}`),!0)};function fa(r,t,s){if(typeof r!="object")throw new w("options must be an object",w.ERR_BAD_OPTION_VALUE);const n=Object.keys(r);let a=n.length;for(;a-- >0;){const i=n[a],o=Object.prototype.hasOwnProperty.call(t,i)?t[i]:void 0;if(o){const l=r[i],c=l===void 0||o(l,i,r);if(c!==!0)throw new w("option "+i+" must be "+c,w.ERR_BAD_OPTION_VALUE);continue}if(s!==!0)throw new w("Unknown option "+i,w.ERR_BAD_OPTION)}}const qe={assertOptions:fa,validators:Ge},B=qe.validators;let ae=class{constructor(t){this.defaults=t||{},this.interceptors={request:new kr,response:new kr}}async request(t,s){try{return await this._request(t,s)}catch(n){if(n instanceof Error){let a={};Error.captureStackTrace?Error.captureStackTrace(a):a=new Error;const i=(()=>{if(!a.stack)return"";const o=a.stack.indexOf(`
...
Agroforestry is one of the rare agricultural practices that simultaneously improves production, climate resilience, biodiversity, and farmer income. It is at the heart of GreenFCO's vision for sustainable agriculture in West Africa.
    `}};function Pa(){var l;const{slug:r}=kt(),{t,i18n:s}=D(),n=(l=s.language)!=null&&l.startsWith("fr")?"fr":"en",a=La[r];if(!a)return e.jsx("main",{className:"section",children:e.jsxs("div",{className:"container",style:{textAlign:"center"},children:[e.jsx("h2",{children:n==="fr"?"Article introuvable":"Article not found"}),e.jsx(S,{to:"/blog",className:"btn btn-primary",style:{marginTop:"1rem"},children:n==="fr"?"← Retour au blog":"← Back to blog"})]})});const i=typeof window<"u"?window.location.href:"",o=a[`title_${n}`];return e.jsxs("main",{className:"blog-post-page",children:[e.jsx("div",{className:"post-hero",children:e.jsxs("div",{className:"container",children:[e.jsx(S,{to:"/blog",className:"back-link",children:"← Blog"}),e.jsxs("div",{className:"post-meta",children:[e.jsx("span",{className:"badge badge-green",children:a.category}),e.jsx("span",{className:"post-date",children:new Date(a.date).toLocaleDateString(n==="fr"?"fr-FR":"en-US",{year:"numeric",month:"long",day:"numeric"})}),e.jsxs("span",{className:"post-read-time",children:["⏱ ",a.readTime]})]}),e.jsx("h1",{children:a[`title_${n}`]})]})}),e.jsxs("div",{className:"container post-layout",children:[e.jsxs("article",{className:"post-content",children:[e.jsx("div",{className:"post-image img-placeholder",style:{height:"400px",marginBottom:"2.5rem"},children:e.jsx("span",{children:n==="fr"?"Photo interview / GreenFCO — 1200×500px":"Interview photo / GreenFCO — 1200×500px"})}),e.jsx("div",{className:"prose",dangerouslySetInnerHTML:{__html:Ta(a[`body_${n}`])}})]}),e.jsxs("aside",{className:"post-sidebar",children:[e.jsxs("div",{className:"card author-bio-card",children:[e.jsx("div",{className:"author-avatar",style:{width:"64px",height:"64px",fontSize:"1.5rem",margin:"0 0 1rem"},children:a.author.charAt(0)}),e.jsx("h4",{children:a.author}),e.jsx("p",{children:n==="fr"?"Co-fondateur & Expert Agro-Environnemental, GreenFCO":"Co-founder & Agro-Environmental Expert, GreenFCO"}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.4rem",marginTop:"0.75rem"},children:[e.jsx("span",{className:"badge badge-green",children:"🏅 Mandela Washington Fellow 2023"}),e.jsx("span",{className:"badge badge-green",children:"🔬 Humboldt Fellow 2025"})]}),e.jsx("a",{href:"mailto:info@greenfco.com",className:"btn btn-secondary btn-sm",style:{marginTop:"1rem",width:"100%",textAlign:"center"},children:n==="fr"?"Contacter l'auteur":"Contact author"})]}),e.jsxs("div",{className:"card share-card",children:[e.jsx("h4",{children:n==="fr"?"Partager cet article":"Share this article"}),e.jsxs("div",{className:"share-buttons",children:[e.jsx("a",{href:`https://wa.me/?text=${encodeURIComponent(o+" "+i)}`,target:"_blank",rel:"noreferrer",className:"btn btn-whatsapp btn-sm",children:"💬 WhatsApp"}),e.jsx("a",{href:`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(i)}`,target:"_blank",rel:"noreferrer",className:"btn btn-secondary btn-sm",children:"Facebook"}),e.jsx("a",{href:`https://twitter.com/intent/tweet?text=${encodeURIComponent(o)}&url=${encodeURIComponent(i)}`,target:"_blank",rel:"noreferrer",className:"btn btn-secondary btn-sm",children:"Twitter/X"})]})]})]})]})]})}function Ta(r){return r?r.replace(/^## (.+)$/gm,"<h2>$1</h2>").replace(/^### (.+)$/gm,"<h3>$1</h3>").replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/^> (.+)$/gm,"<blockquote>$1</blockquote>").replace(/^---$/gm,'<hr style="border:none;border-top:1px solid var(--gray-light);margin:2rem 0">').replace(/^\d+\. \*\*(.+?)\*\* — (.+)$/gm,"<li><strong>$1</strong> — $2</li>").replace(/(<li>.*<\/li>\n?)+/g,"<ol>$&</ol>").replace(/\n\n/g,"</p><p>").replace(/^(?!<h|<bl|<hr|<ol|<li)(.+)$/gm,(t,s)=>s.startsWith("<")?t:`<p>${s}</p>`).replace(/<p><\/p>/g,""):""}const $r=["Tout","Terrain","Formations","Événements","Ferme-École"],Da=["All","Field","Training","Events","Farm School"],Ia={terrain:"Terrain",formations:"Formations",formation:"Formations",evenements:"Événements",evenement:"Événements",événements:"Événements",événement:"Événements",events:"Événements","ferme-ecole":"Ferme-École","ferme-école":"Ferme-École","farm-school":"Ferme-École",general:"Terrain"},Ba=[{id:1,cat:"Terrain",w:600,h:400,label_fr:"Visite terrain — Burkina Faso",label_en:"Field visit — Burkina Faso"},{id:2,cat:"Formations",w:600,h:600,label_fr:"Formation agriculture durable",label_en:"Sustainable agriculture training"},{id:3,cat:"Terrain",w:800,h:500,label_fr:"Parcelles maraîchères",label_en:"Market garden plots"},{id:4,cat:"Événements",w:600,h:400,label_fr:"Forum agro-environmental",label_en:"Agro-environmental forum"},{id:5,cat:"Ferme-École",w:600,h:800,label_fr:"Ferme-école — démonstration",label_en:"Farm school — demonstration"},{id:6,cat:"Formations",w:600,h:400,label_fr:"Agriculture hors-sol workshop",label_en:"Soilless agriculture workshop"},{id:7,cat:"Terrain",w:800,h:600,label_fr:"Aménagements hydro-agricoles",label_en:"Hydro-agricultural development"},{id:8,cat:"Événements",w:600,h:400,label_fr:"Rencontre avec partenaires",label_en:"Partner meeting"},{id:9,cat:"Ferme-École",w:600,h:600,label_fr:"Formation pratique — semences",label_en:"Practical training — seeds"}];function Ma(){var f;const{t:r,i18n:t}=D(),s=(f=t.language)!=null&&f.startsWith("fr")?"fr":"en",[n,a]=v.useState(0),[i,o]=v.useState(null),[l,c]=v.useState([]);v.useEffect(()=>{fetch("/api/gallery").then(b=>b.ok?b.json():[]).then(b=>c(Array.isArray(b)?b:[])).catch(()=>{})},[]);const u=s==="fr"?$r:Da,p=[...l.map(b=>({id:`api-${b.id}`,cat:b.category&&Ia[b.category.toLowerCase()]||"Terrain",w:600,h:400,label_fr:b.title_fr||b.title,label_en:b.title,image_url:b.image_url})),...Ba],y=n===0?p:p.filter(b=>b.cat===$r[n]);return e.jsxs("main",{className:"gallery-page",children:[e.jsxs("section",{className:"page-hero",children:[e.jsx("div",{className:"page-hero-bg"}),e.jsxs("div",{className:"container",children:[e.jsx("span",{className:"eyebrow",children:s==="fr"?"Galerie":"Gallery"}),e.jsx("h1",{children:s==="fr"?"Nos Actions en Images":"Our Actions in Pictures"}),e.jsx("p",{children:s==="fr"?"Découvrez nos activités de terrain, formations, événements et ferme-école à travers ces témoignages visuels.":"Discover our field activities, training, events, and farm school through these visual testimonials."})]})]}),e.jsx("section",{className:"section",children:e.jsxs("div",{className:"container",children:[e.jsx("div",{className:"gallery-filter",children:u.map((b,x)=>e.jsx("button",{className:`filter-btn ${n===x?"active":""}`,onClick:()=>a(x),children:b},b))}),e.jsx("div",{className:"masonry-grid",children:y.map((b,x)=>e.jsxs("div",{className:"masonry-item",style:{animationDelay:`${x*.05}s`},onClick:()=>o(b),children:[b.image_url?e.jsx("img",{src:b.image_url,alt:s==="fr"?b.label_fr:b.label_en,className:"gallery-img gallery-real-img",style:{width:"100%",display:"block",borderRadius:"inherit"},loading:"lazy"}):e.jsx("div",{className:"img-placeholder gallery-img",style:{paddingBottom:`${b.h/b.w*100}%`},children:e.jsx("span",{className:"gallery-label",children:s==="fr"?b.label_fr:b.label_en})}),e.jsxs("div",{className:"gallery-overlay",children:[e.jsx("span",{className:"gallery-zoom",children:"🔍"}),e.jsx("p",{children:s==="fr"?b.label_fr:b.label_en})]})]},b.id))}),e.jsxs("div",{className:"video-section",style:{marginTop:"4rem"},children:[e.jsx("h2",{style:{textAlign:"center",marginBottom:"2rem"},children:s==="fr"?"Vidéos":"Videos"}),e.jsxs("div",{className:"grid-2",children:[e.jsx("div",{className:"video-placeholder",children:e.jsx("div",{className:"img-placeholder",style:{height:"220px"},children:e.jsxs("span",{children:["🎬 ",s==="fr"?"Vidéo présentation GreenFCO — YouTube/Vimeo":"GreenFCO presentation video — YouTube/Vimeo"]})})}),e.jsx("div",{className:"video-placeholder",children:e.jsx("div",{className:"img-placeholder",style:{height:"220px"},children:e.jsxs("span",{children:["🎬 ",s==="fr"?"Vidéo terrain — Formation agroécologie":"Field video — Agroecology training"]})})})]})]})]})}),i&&e.jsx("div",{className:"lightbox",onClick:()=>o(null),children:e.jsxs("div",{className:"lightbox-content",onClick:b=>b.stopPropagation(),children:[e.jsx("button",{className:"lightbox-close",onClick:()=>o(null),children:"✕"}),i.image_url?e.jsx("img",{src:i.image_url,alt:s==="fr"?i.label_fr:i.label_en,style:{width:"100%",maxHeight:"70vh",objectFit:"contain",borderRadius:"8px",display:"block"}}):e.jsx("div",{className:"img-placeholder",style:{width:"100%",height:"400px"},children:e.jsx("span",{children:s==="fr"?i.label_fr:i.label_en})}),e.jsx("p",{className:"lightbox-caption",children:s==="fr"?i.label_fr:i.label_en})]})})]})}function Hr(r,t){document.title=r;const s=document.querySelector('meta[name="description"]');s&&s.setAttribute("content",t)}function za(){var p;const{t:r,i18n:t}=D(),s=(p=t.language)!=null&&p.startsWith("fr")?"fr":"en",[n,a]=v.useState({name:"",email:"",subject:"",message:"",country:""}),[i,o]=v.useState(null),[l,c]=v.useState(!1);v.useEffect(()=>{s==="fr"?Hr("Contact | GreenFCO — Parlons de Votre Projet Agricole","Contactez GreenFCO pour discuter de votre projet agro-environnemental. Notre équipe d'experts est basée à Ouagadougou, Burkina Faso et disponible du lundi au vendredi."):Hr("Contact | GreenFCO — Let's Talk About Your Agricultural Project","Contact GreenFCO to discuss your agro-environmental project. Our team of experts is based in Ouagadougou, Burkina Faso and available Monday to Friday.")},[s]);function u(y){a(f=>({...f,[y.target.name]:y.target.value}))}async function m(y){y.preventDefault(),c(!0);try{await U.post("/contact",n),o("success"),a({name:"",email:"",subject:"",message:"",country:""})}catch{o("error")}finally{c(!1)}}return e.jsxs("main",{className:"contact-page",children:[e.jsxs("section",{className:"page-hero",children:[e.jsx("div",{className:"page-hero-bg"}),e.jsxs("div",{className:"container",children:[e.jsx("span",{className:"eyebrow",children:r("contact.title")}),e.jsx("h1",{children:s==="fr"?"Parlons de Votre Projet":"Let's Talk About Your Project"}),e.jsx("p",{children:r("contact.subtitle")})]})]}),e.jsx("section",{className:"section",children:e.jsxs("div",{className:"container contact-layout",children:[e.jsxs("div",{className:"contact-info",children:[e.jsxs("div",{className:"info-block card",children:[e.jsx("div",{className:"info-icon",children:"📍"}),e.jsx("h3",{children:s==="fr"?"Adresse":"Address"}),e.jsx("p",{children:"Ouagadougou, Burkina Faso"}),e.jsx("p",{children:s==="fr"?"Afrique de l'Ouest":"West Africa"})]}),e.jsxs("div",{className:"info-block card",children:[e.jsx("div",{className:"info-icon",children:"✉️"}),e.jsx("h3",{children:"Email"}),e.jsx("a",{href:"mailto:info@greenfco.com",children:"info@greenfco.com"})]}),e.jsxs("div",{className:"info-block card whatsapp-block",children:[e.jsx("div",{className:"info-icon",children:"💬"}),e.jsx("h3",{children:"WhatsApp"}),e.jsx("p",{children:s==="fr"?"Canal de communication privilégié":"Preferred communication channel"}),e.jsxs("a",{href:"https://wa.me/22600000000",target:"_blank",rel:"noreferrer",className:"btn btn-whatsapp",children:["💬 ",r("contact.whatsapp")]})]}),e.jsxs("div",{className:"info-block card",children:[e.jsx("div",{className:"info-icon",children:"🕐"}),e.jsx("h3",{children:s==="fr"?"Disponibilité":"Availability"}),e.jsx("p",{children:s==="fr"?"Lundi – Vendredi : 8h00 – 18h00 (GMT+0)":"Monday – Friday: 8:00 AM – 6:00 PM (GMT+0)"})]}),e.jsxs("div",{className:"map-placeholder",children:[e.jsx("div",{className:"img-placeholder",style:{height:"250px",borderRadius:"var(--radius-lg)"},children:e.jsxs("span",{children:["🗺️ ",s==="fr"?"Carte — Ouagadougou, Burkina Faso":"Map — Ouagadougou, Burkina Faso"]})}),e.jsx("p",{style:{fontSize:"0.82rem",color:"var(--gray-mid)",marginTop:"0.5rem",textAlign:"center"},children:"Ouagadougou, Burkina Faso · +226 XX XX XX XX"})]})]}),e.jsx("div",{className:"contact-form-section",children:e.jsxs("div",{className:"card",style:{padding:"2.5rem"},children:[e.jsx("h2",{style:{marginBottom:"0.5rem"},children:s==="fr"?"Envoyez-nous un message":"Send us a message"}),e.jsx("p",{style:{color:"var(--gray-mid)",fontSize:"0.9rem",marginBottom:"2rem"},children:s==="fr"?"Nous vous répondons sous 24-48h (jours ouvrés).":"We respond within 24-48h (business days)."}),i==="success"&&e.jsxs("div",{className:"form-success",children:["✅ ",r("contact.success")]}),i==="error"&&e.jsxs("div",{className:"form-error",children:["❌ ",r("contact.error")]}),e.jsxs("form",{onSubmit:m,children:[e.jsxs("div",{className:"grid-2",children:[e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("contact.form_name")," *"]}),e.jsx("input",{type:"text",name:"name",className:"form-input",value:n.name,onChange:u,required:!0,placeholder:s==="fr"?"Votre nom complet":"Your full name"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:r("contact.form_country")}),e.jsx("input",{type:"text",name:"country",className:"form-input",value:n.country,onChange:u,placeholder:"Burkina Faso"})]})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("contact.form_email")," *"]}),e.jsx("input",{type:"email",name:"email",className:"form-input",value:n.email,onChange:u,required:!0,placeholder:"example@email.com"})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("contact.form_subject")," *"]}),e.jsx("input",{type:"text",name:"subject",className:"form-input",value:n.subject,onChange:u,required:!0,placeholder:s==="fr"?"Sujet de votre message":"Subject of your message"})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("contact.form_message")," *"]}),e.jsx("textarea",{name:"message",className:"form-input",value:n.message,onChange:u,required:!0,rows:6,placeholder:s==="fr"?"Décrivez votre projet ou votre demande...":"Describe your project or request..."})]}),e.jsx("button",{type:"submit",className:"btn btn-primary",disabled:l,style:{width:"100%"},children:l?s==="fr"?"Envoi...":"Sending...":r("contact.form_submit")})]})]})})]})})]})}const Ga=r=>U.post("/auth/login",r),Wa=r=>U.post("/auth/register",r),Ua=r=>U.post("/auth/forgot-password",{email:r}),Io=(r,t)=>U.post("/auth/reset-password",{token:r,password:t}),Bo=(r,t)=>U.post("/admin/auth/reset-password",{token:r,new_password:t}),$a=()=>e.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),Ha=()=>e.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"}),e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]});function or({className:r,style:t,inputStyle:s,...n}){const[a,i]=v.useState(!1);return e.jsxs("div",{style:{position:"relative",display:"flex",alignItems:"center",...t},children:[e.jsx("input",{...n,type:a?"text":"password",className:r,style:{paddingRight:"2.75rem",width:"100%",boxSizing:"border-box",...s}}),e.jsx("button",{type:"button",onClick:()=>i(o=>!o),tabIndex:-1,"aria-label":a?"Masquer le mot de passe":"Afficher le mot de passe",style:{position:"absolute",right:"0.75rem",background:"none",border:"none",cursor:"pointer",color:"#9ca3af",padding:"0",display:"flex",alignItems:"center",lineHeight:1},children:a?e.jsx(Ha,{}):e.jsx($a,{})})]})}function Va(){var y;const{t:r,i18n:t}=D(),s=(y=t.language)!=null&&y.startsWith("fr")?"fr":"en",n=Yr(),a=ue(f=>f.setAuth),[i,o]=v.useState({email:"",password:""}),[l,c]=v.useState(""),[u,m]=v.useState(!1);async function p(f){var b,x;f.preventDefault(),m(!0),c("");try{const g=await Ga(i);a(g.data.user,g.data.token),n("/dashboard")}catch(g){c(((x=(b=g.response)==null?void 0:b.data)==null?void 0:x.message)||(s==="fr"?"Identifiants incorrects.":"Invalid credentials."))}finally{m(!1)}}return e.jsxs("div",{className:"auth-page",children:[e.jsxs("div",{className:"auth-side auth-side-brand",children:[e.jsxs(S,{to:"/",className:"auth-logo",children:["🌿 ",e.jsx("span",{children:"Green"}),"FCO"]}),e.jsxs("div",{className:"auth-brand-content",children:[e.jsx("h2",{children:s==="fr"?"Bienvenue sur GreenFCO":"Welcome to GreenFCO"}),e.jsx("p",{children:s==="fr"?"Votre plateforme agro-environnementale pour une agriculture durable en Afrique francophone.":"Your agro-environmental platform for sustainable agriculture in Francophone Africa."}),e.jsx("div",{className:"auth-brand-features",children:["🌱 Gestion de cultures","💧 Irrigation intelligente","🤖 Conseiller IA","🛒 Marché numérique"].map(f=>e.jsx("div",{className:"auth-feature",children:f},f))})]}),e.jsx("p",{className:"auth-slogan",children:'"Cultiver un avenir durable, ensemble."'})]}),e.jsx("div",{className:"auth-side auth-side-form",children:e.jsxs("div",{className:"auth-form-container",children:[e.jsx("h1",{children:r("auth.login_title")}),e.jsxs("p",{className:"auth-subtitle",children:[r("auth.no_account")," ",e.jsx(S,{to:"/register",children:r("nav.register")})]}),l&&e.jsx("div",{className:"auth-error",children:l}),e.jsxs("form",{onSubmit:p,children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:r("auth.email")}),e.jsx("input",{type:"email",className:"form-input",value:i.email,onChange:f=>o(b=>({...b,email:f.target.value})),required:!0,placeholder:"example@email.com"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:r("auth.password")}),e.jsx(or,{className:"form-input",value:i.password,onChange:f=>o(b=>({...b,password:f.target.value})),required:!0,placeholder:"••••••••"})]}),e.jsx("div",{className:"auth-forgot",children:e.jsx(S,{to:"/forgot-password",children:r("auth.forgot_password")})}),e.jsx("button",{type:"submit",className:"btn btn-primary auth-submit",disabled:u,children:u?s==="fr"?"Connexion...":"Signing in...":r("auth.login_btn")})]})]})})]})}const Ja=["farmer","expert","investor","organization"];function Ka(){var A;const{t:r,i18n:t}=D(),s=(A=t.language)!=null&&A.startsWith("fr")?"fr":"en",n=Yr(),a=ue(N=>N.setAuth),[i,o]=v.useState({name:"",email:"",password:"",confirm_password:"",country:"",user_type:"farmer",language:s}),[l,c]=v.useState("buyer"),[u,m]=v.useState(""),[p,y]=v.useState(""),[f,b]=v.useState(!1);function x(N){o(h=>({...h,[N.target.name]:N.target.value}))}async function g(N){var h,j;if(N.preventDefault(),i.password!==i.confirm_password){y(s==="fr"?"Les mots de passe ne correspondent pas.":"Passwords do not match.");return}b(!0),y("");try{const _=await Wa({...i,market_role:l});if(l==="seller"){const q=(()=>{try{return JSON.parse(localStorage.getItem("greenfco_seller_profile"))||{}}catch{return{}}})();localStorage.setItem("greenfco_seller_profile",JSON.stringify({...q,location:u,memberSince:new Date().getFullYear().toString()}))}a(_.data.user,_.data.token),n("/dashboard")}catch(_){y(((j=(h=_.response)==null?void 0:h.data)==null?void 0:j.message)||(s==="fr"?"Erreur lors de la création du compte.":"Account creation failed."))}finally{b(!1)}}return e.jsxs("div",{className:"auth-page",children:[e.jsxs("div",{className:"auth-side auth-side-brand",children:[e.jsxs(S,{to:"/",className:"auth-logo",children:["🌿 ",e.jsx("span",{children:"Green"}),"FCO"]}),e.jsxs("div",{className:"auth-brand-content",children:[e.jsx("h2",{children:s==="fr"?"Rejoignez la communauté":"Join the community"}),e.jsx("p",{children:s==="fr"?"Agriculteurs, experts, investisseurs, organisations — GreenFCO rassemble tous les acteurs de l'agro-environnement.":"Farmers, experts, investors, organizations — GreenFCO brings together all agro-environmental actors."}),e.jsx("div",{className:"auth-brand-features",children:(s==="fr"?["🌱 Agriculteur / Agripreneur","🔬 Expert / Consultant","💼 Investisseur","🏢 Organisation / ONG"]:["🌱 Farmer / Agripreneur","🔬 Expert / Consultant","💼 Investor","🏢 Organization / NGO"]).map(N=>e.jsx("div",{className:"auth-feature",children:N},N))})]}),e.jsx("p",{className:"auth-slogan",children:'"Cultiver un avenir durable, ensemble."'})]}),e.jsx("div",{className:"auth-side auth-side-form",children:e.jsxs("div",{className:"auth-form-container",children:[e.jsx("h1",{children:r("auth.register_title")}),e.jsxs("p",{className:"auth-subtitle",children:[r("auth.have_account")," ",e.jsx(S,{to:"/login",children:r("nav.login")})]}),p&&e.jsx("div",{className:"auth-error",children:p}),e.jsxs("form",{onSubmit:g,children:[e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("auth.name")," *"]}),e.jsx("input",{type:"text",name:"name",className:"form-input",value:i.name,onChange:x,required:!0,placeholder:"Jean Ouédraogo"})]}),e.jsxs("div",{className:"grid-2",children:[e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("auth.email")," *"]}),e.jsx("input",{type:"email",name:"email",className:"form-input",value:i.email,onChange:x,required:!0,placeholder:"jean@email.com"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:r("auth.country")}),e.jsx("input",{type:"text",name:"country",className:"form-input",value:i.country,onChange:x,placeholder:"Burkina Faso"})]})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("auth.user_type")," *"]}),e.jsx("select",{name:"user_type",className:"form-select",value:i.user_type,onChange:x,children:Ja.map(N=>e.jsx("option",{value:N,children:r(`auth.${N}`)},N))})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[s==="fr"?"Je souhaite utiliser la plateforme comme":"I want to use the platform as"," *"]}),e.jsxs("select",{className:"form-select",value:l,onChange:N=>c(N.target.value),children:[e.jsx("option",{value:"buyer",children:s==="fr"?"Acheteur (je cherche des produits)":"Buyer (I look for products)"}),e.jsx("option",{value:"seller",children:s==="fr"?"Vendeur (je vends des produits)":"Seller (I sell products)"})]})]}),l==="seller"&&e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:s==="fr"?"Localisation (ville / région) *":"Location (city / region) *"}),e.jsx("input",{type:"text",className:"form-input",value:u,onChange:N=>m(N.target.value),placeholder:s==="fr"?"Ex : Ouagadougou, Plateau Central":"E.g. Ouagadougou, Plateau Central",required:!0})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:r("auth.language_pref")}),e.jsxs("select",{name:"language",className:"form-select",value:i.language,onChange:x,children:[e.jsx("option",{value:"fr",children:"Français"}),e.jsx("option",{value:"en",children:"English"})]})]}),e.jsxs("div",{className:"grid-2",children:[e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("auth.password")," *"]}),e.jsx(or,{name:"password",className:"form-input",value:i.password,onChange:x,required:!0,placeholder:"••••••••",minLength:8})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:[r("auth.confirm_password")," *"]}),e.jsx(or,{name:"confirm_password",className:"form-input",value:i.confirm_password,onChange:x,required:!0,placeholder:"••••••••"})]})]}),e.jsx("button",{type:"submit",className:"btn btn-primary auth-submit",disabled:f,children:f?s==="fr"?"Création...":"Creating...":r("auth.register_btn")})]})]})})]})}function Ya(){var p;const{i18n:r}=D(),t=(p=r.language)!=null&&p.startsWith("fr")?"fr":"en",[s,n]=v.useState(""),[a,i]=v.useState(!1),[o,l]=v.useState(""),[c,u]=v.useState(!1);async function m(y){var f;y.preventDefault(),u(!0);try{const b=await Ua(s);(f=b.data)!=null&&f.reset_link&&l(b.data.reset_link)}catch{}finally{i(!0),u(!1)}}return e.jsxs("div",{className:"auth-page",children:[e.jsxs("div",{className:"auth-side auth-side-brand",children:[e.jsxs(S,{to:"/",className:"auth-logo",children:["🌿 ",e.jsx("span",{children:"Green"}),"FCO"]}),e.jsxs("div",{className:"auth-brand-content",children:[e.jsx("h2",{children:t==="fr"?"Réinitialisation":"Password Reset"}),e.jsx("p",{children:t==="fr"?"Nous vous enverrons un lien de réinitialisation par e-mail.":"We'll send you a reset link by email."})]}),e.jsx("p",{className:"auth-slogan",children:'"Cultiver un avenir durable, ensemble."'})]}),e.jsx("div",{className:"auth-side auth-side-form",children:e.jsxs("div",{className:"auth-form-container",children:[e.jsx("h1",{children:t==="fr"?"Mot de passe oublié ?":"Forgot password?"}),e.jsx("p",{className:"auth-subtitle",children:e.jsxs(S,{to:"/login",children:["← ",t==="fr"?"Retour à la connexion":"Back to sign in"]})}),a?e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.75rem"},children:[e.jsxs("div",{className:"form-success",style:{padding:"1.25rem",background:"var(--green-pale)",borderRadius:"var(--radius-md)",color:"var(--green-deep)"},children:["✅ ",t==="fr"?"Si un compte existe avec cet e-mail, vous recevrez un lien de réinitialisation sous peu.":"If an account exists with this email, you will receive a reset link shortly."]}),o&&e.jsxs("div",{style:{padding:"1rem",background:"#fef9c3",borderRadius:"var(--radius-md)",border:"1px solid #fde047",fontSize:"0.85rem"},children:[e.jsx("p",{style:{color:"#854d0e",fontWeight:600,marginBottom:"0.4rem"},children:t==="fr"?"⚠ Email non configuré — lien direct :":"⚠ Email not configured — direct link:"}),e.jsx("a",{href:o,style:{color:"#1B4332",wordBreak:"break-all"},children:o})]})]}):e.jsxs("form",{onSubmit:m,children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:t==="fr"?"Adresse e-mail":"Email address"}),e.jsx("input",{type:"email",className:"form-input",value:s,onChange:y=>n(y.target.value),required:!0,placeholder:"example@email.com"})]}),e.jsx("button",{type:"submit",className:"btn btn-primary auth-submit",disabled:c,children:c?"...":t==="fr"?"Envoyer le lien":"Send reset link"})]})]})})]})}const Vr=v.lazy(()=>F(()=>import("./ResetPassword-BRQ5H9cQ.js"),__vite__mapDeps([0,1,2]))),Xa=v.lazy(()=>F(()=>import("./AdminLayout-DNEB-Qvr.js"),__vite__mapDeps([3,1,4,5,2,6]))),Qa=v.lazy(()=>F(()=>import("./AdminDashboard-t28pIDMb.js"),__vite__mapDeps([7,1,5,2]))),Za=v.lazy(()=>F(()=>import("./AdminUsers-SNgVHDPE.js"),__vite__mapDeps([8,1,5,9,2]))),ei=v.lazy(()=>F(()=>import("./AdminListings-B9zMXWxX.js"),__vite__mapDeps([10,1,5,9,2]))),ri=v.lazy(()=>F(()=>import("./AdminBlog-Bjd_qs6h.js"),__vite__mapDeps([11,1]))),ti=v.lazy(()=>F(()=>import("./AdminConsulting-BxwOLwFf.js"),__vite__mapDeps([12,1,5,9,2]))),si=v.lazy(()=>F(()=>import("./AdminGallery-ByGhguaM.js"),__vite__mapDeps([13,1,5,2]))),_e=v.lazy(()=>F(()=>import("./DashboardLayout-CSuroefW.js"),__vite__mapDeps([14,1,2,15]))),ni=v.lazy(()=>F(()=>import("./DashboardHome-DgsFgGQX.js"),__vite__mapDeps([16,1,2,17]))),ai=v.lazy(()=>F(()=>import("./CropManager-YK1klW9M.js"),__vite__mapDeps([18,1,2,19]))),ii=v.lazy(()=>F(()=>import("./IrrigationManager-DI5P_SJd.js"),__vite__mapDeps([20,1,2,21]))),oi=v.lazy(()=>F(()=>import("./FinanceManager-DuCoQ3sB.js"),__vite__mapDeps([22,1,2,23,24]))),li=v.lazy(()=>F(()=>import("./WeatherHub-QLNfJU_p.js"),__vite__mapDeps([25,1,2,23,26]))),ci=v.lazy(()=>F(()=>import("./SpeciesLibrary-atL8VbK0.js"),__vite__mapDeps([27,1,2,28]))),ui=v.lazy(()=>F(()=>import("./GreenBot-CVqcXQG5.js"),__vite__mapDeps([29,1,2,30]))),di=v.lazy(()=>F(()=>import("./SoilAdvisor-FBYCJrVQ.js"),__vite__mapDeps([31,1,2,32]))),mi=v.lazy(()=>F(()=>import("./KoobAssist-BHYPrQVG.js"),__vite__mapDeps([33,1,2,34]))),Jr=v.lazy(()=>F(()=>import("./MarketPage-CaQ4i16Y.js"),__vite__mapDeps([35,1,2,23,36]))),pi=v.lazy(()=>F(()=>import("./SellerProfilePage-BxshXGZJ.js"),__vite__mapDeps([37,1,2,38]))),hi=v.lazy(()=>F(()=>import("./BuyerProfilePage-BtrHiGss.js"),__vite__mapDeps([39,1,2,40]))),fi=v.lazy(()=>F(()=>import("./NetworkPage-CbXt2YNK.js"),__vite__mapDeps([41,1,2,42]))),gi=v.lazy(()=>F(()=>import("./VerifyTransaction-BD0HF4eb.js"),__vite__mapDeps([43,1,44]))),bi=v.lazy(()=>F(()=>import("./AdminTransactions-8i5QPySX.js"),__vite__mapDeps([45,1]))),vi=v.lazy(()=>F(()=>import("./AdminSettings-BdIPoKjG.js"),__vite__mapDeps([46,1,4,5,9,2]))),xi=v.lazy(()=>F(()=>import("./AdminProjects-Bs8mcpMk.js"),__vite__mapDeps([47,1,5,9,2]))),yi=v.lazy(()=>F(()=>import("./AdminActivity-B8kGOhrd.js"),__vite__mapDeps([9,1,5,2]))),ji=v.lazy(()=>F(()=>import("./AdminTeamChat-CqlZc-BM.js"),__vite__mapDeps([48,1,5,2]))),Ai=v.lazy(()=>F(()=>import("./AdminLogin-DqON5QF6.js"),__vite__mapDeps([49,1,2])));function Fe({children:r}){const{isAuthenticated:t}=ue();return t?r:e.jsx(Le,{to:"/login",replace:!0})}function wi({children:r}){const t=(()=>{try{return JSON.parse(localStorage.getItem("greenfco_admin_session"))}catch{return null}})();return t!=null&&t.verified?r:e.jsx(Le,{to:"/admin/login",replace:!0})}function Y({children:r}){return e.jsxs(e.Fragment,{children:[e.jsx(ws,{}),e.jsx("div",{style:{minHeight:"calc(100vh - 70px)"},children:r}),e.jsx(Ns,{})]})}function Ni(){return e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",minHeight:"60vh"},children:e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("div",{style:{fontSize:"2rem",marginBottom:"1rem"},children:"🌿"}),e.jsx("p",{style:{color:"var(--gray-mid)"},children:"Chargement..."})]})})}function Ci({title:r,icon:t}){return e.jsxs("div",{style:{textAlign:"center",padding:"4rem 2rem",color:"var(--gray-mid)"},children:[e.jsx("div",{style:{fontSize:"3rem",marginBottom:"1rem"},children:t}),e.jsx("h2",{style:{color:"var(--black)",marginBottom:"0.5rem"},children:r}),e.jsx("p",{children:"Cette fonctionnalité arrive bientôt. / This feature is coming soon."})]})}function Si(){return e.jsx(Et,{children:e.jsx(js,{children:e.jsx(v.Suspense,{fallback:e.jsx(Ni,{}),children:e.jsxs(Ot,{children:[e.jsx(C,{path:"/",element:e.jsx(Y,{children:e.jsx(ya,{})})}),e.jsx(C,{path:"/about",element:e.jsx(Y,{children:e.jsx(Na,{})})}),e.jsx(C,{path:"/services",element:e.jsx(Y,{children:e.jsx(Sa,{})})}),e.jsx(C,{path:"/consulting",element:e.jsx(Y,{children:e.jsx(Oa,{})})}),e.jsx(C,{path:"/blog",element:e.jsx(Y,{children:e.jsx(qa,{})})}),e.jsx(C,{path:"/blog/:slug",element:e.jsx(Y,{children:e.jsx(Pa,{})})}),e.jsx(C,{path:"/gallery",element:e.jsx(Y,{children:e.jsx(Ma,{})})}),e.jsx(C,{path:"/contact",element:e.jsx(Y,{children:e.jsx(za,{})})}),e.jsx(C,{path:"/login",element:e.jsx(Va,{})}),e.jsx(C,{path:"/register",element:e.jsx(Ka,{})}),e.jsx(C,{path:"/forgot-password",element:e.jsx(Ya,{})}),e.jsx(C,{path:"/reset-password",element:e.jsx(Vr,{type:"user"})}),e.jsx(C,{path:"/admin/reset-password",element:e.jsx(Vr,{type:"admin"})}),e.jsxs(C,{path:"/dashboard",element:e.jsx(Fe,{children:e.jsx(_e,{})}),children:[e.jsx(C,{index:!0,element:e.jsx(ni,{})}),e.jsx(C,{path:"crops",element:e.jsx(ai,{})}),e.jsx(C,{path:"irrigation",element:e.jsx(ii,{})}),e.jsx(C,{path:"finance",element:e.jsx(oi,{})}),e.jsx(C,{path:"weather",element:e.jsx(li,{})}),e.jsx(C,{path:"species",element:e.jsx(ci,{})}),e.jsx(C,{path:"greenbot",element:e.jsx(ui,{})}),e.jsx(C,{path:"soil-advisor",element:e.jsx(di,{})}),e.jsx(C,{path:"koob-assist",element:e.jsx(mi,{})}),e.jsx(C,{path:"map",element:e.jsx(Ci,{title:"Farm Map",icon:"🗺️"})})]}),e.jsxs(C,{path:"/marketplace",element:e.jsx(Fe,{children:e.jsx(_e,{})}),children:[e.jsx(C,{index:!0,element:e.jsx(Jr,{mode:"marketplace"},"marketplace")}),e.jsx(C,{path:"profile",element:e.jsx(hi,{})})]}),e.jsxs(C,{path:"/agropro",element:e.jsx(Fe,{children:e.jsx(_e,{})}),children:[e.jsx(C,{index:!0,element:e.jsx(Jr,{mode:"agropro"},"agropro")}),e.jsx(C,{path:"profile",element:e.jsx(pi,{})})]}),e.jsx(C,{path:"/verify-transaction",element:e.jsx(gi,{})}),e.jsx(C,{path:"/market",element:e.jsx(Le,{to:"/marketplace",replace:!0})}),e.jsx(C,{path:"/network",element:e.jsx(Fe,{children:e.jsx(_e,{})}),children:e.jsx(C,{index:!0,element:e.jsx(fi,{})})}),e.jsx(C,{path:"/admin/login",element:e.jsx(Ai,{})}),e.jsxs(C,{path:"/admin",element:e.jsx(wi,{children:e.jsx(Xa,{})}),children:[e.jsx(C,{index:!0,element:e.jsx(Qa,{})}),e.jsx(C,{path:"users",element:e.jsx(Za,{})}),e.jsx(C,{path:"listings",element:e.jsx(ei,{})}),e.jsx(C,{path:"blog",element:e.jsx(ri,{})}),e.jsx(C,{path:"consulting",element:e.jsx(ti,{})}),e.jsx(C,{path:"gallery",element:e.jsx(si,{})}),e.jsx(C,{path:"transactions",element:e.jsx(bi,{})}),e.jsx(C,{path:"settings",element:e.jsx(vi,{})}),e.jsx(C,{path:"projects",element:e.jsx(xi,{})}),e.jsx(C,{path:"activity",element:e.jsx(yi,{})}),e.jsx(C,{path:"messages",element:e.jsx(ji,{})})]}),e.jsx(C,{path:"*",element:e.jsx(Le,{to:"/",replace:!0})})]})})})})}let _i={data:""},Fi=r=>{if(typeof window=="object"){let t=(r?r.querySelector("#_goober"):window._goober)||Object.assign(document.createElement("style"),{innerHTML:" ",id:"_goober"});return t.nonce=window.__nonce__,t.parentNode||(r||document.head).appendChild(t),t.firstChild}return r||_i},ki=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,Ei=/\/\*[^]*?\*\/|  +/g,Kr=/\n+/g,Q=(r,t)=>{let s="",n="",a="";for(let i in r){let o=r[i];i[0]=="@"?i[1]=="i"?s=i+" "+o+";":n+=i[1]=="f"?Q(o,i):i+"{"+Q(o,i[1]=="k"?"":t)+"}":typeof o=="object"?n+=Q(o,t?t.replace(/([^,])+/g,l=>i.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,c=>/&/.test(c)?c.replace(/&/g,l):l?l+" "+c:c)):i):o!=null&&(i=i[1]=="-"?i:i.replace(/[A-Z]/g,"-$&").toLowerCase(),a+=Q.p?Q.p(i,o):i+":"+o+";")}return s+(t&&a?t+"{"+a+"}":a)+n},X={},xt=r=>{if(typeof r=="object"){let t="";for(let s in r)t+=s+xt(r[s]);return t}return r},Oi=(r,t,s,n,a)=>{let i=xt(r),o=X[i]||(X[i]=(c=>{let u=0,m=11;for(;u<c.length;)m=101*m+c.charCodeAt(u++)>>>0;return"go"+m})(i));if(!X[o]){let c=i!==r?r:(u=>{let m,p,y=[{}];for(;m=ki.exec(u.replace(Ei,""));)m[4]?y.shift():m[3]?(p=m[3].replace(Kr," ").trim(),y.unshift(y[0][p]=y[0][p]||{})):y[0][m[1]]=m[2].replace(Kr," ").trim();return y[0]})(r);X[o]=Q(a?{["@keyframes "+o]:c}:c,s?"":"."+o)}let l=s&&X.g;return s&&(X.g=X[o]),((c,u,m,p)=>{p?u.data=u.data.replace(p,c):u.data.indexOf(c)===-1&&(u.data=m?c+u.data:u.data+c)})(X[o],t,n,l),o},qi=(r,t,s)=>r.reduce((n,a,i)=>{let o=t[i];if(o&&o.call){let l=o(s),c=l&&l.props&&l.props.className||/^go/.test(l)&&l;o=c?"."+c:l&&typeof l=="object"?l.props?"":Q(l,""):l===!1?"":l}return n+a+(o??"")},"");function We(r){let t=this||{},s=r.call?r(t.p):r;return Oi(s.unshift?s.raw?qi(s,[].slice.call(arguments,1),t.p):s.reduce((n,a)=>Object.assign(n,a&&a.call?a(t.p):a),{}):s,Fi(t.target),t.g,t.o,t.k)}let yt,lr,cr;We.bind({g:1});let H=We.bind({k:1});function Ri(r,t,s,n){Q.p=t,yt=r,lr=s,cr=n}function Z(r,t){let s=this||{};return function(){let n=arguments;function a(i,o){let l=Object.assign({},i),c=l.className||a.className;s.p=Object.assign({theme:lr&&lr()},l),s.o=/go\d/.test(c),l.className=We.apply(s,n)+(c?" "+c:"");let u=r;return r[0]&&(u=l.as||r,delete l.as),cr&&u[0]&&cr(l),yt(u,l)}return a}}var Li=r=>typeof r=="function",Te=(r,t)=>Li(r)?r(t):r,Pi=(()=>{let r=0;return()=>(++r).toString()})(),jt=(()=>{let r;return()=>{if(r===void 0&&typeof window<"u"){let t=matchMedia("(prefers-reduced-motion: reduce)");r=!t||t.matches}return r}})(),Ti=20,gr="default",At=(r,t)=>{let{toastLimit:s}=r.settings;switch(t.type){case 0:return{...r,toasts:[t.toast,...r.toasts].slice(0,s)};case 1:return{...r,toasts:r.toasts.map(o=>o.id===t.toast.id?{...o,...t.toast}:o)};case 2:let{toast:n}=t;return At(r,{type:r.toasts.find(o=>o.id===n.id)?1:0,toast:n});case 3:let{toastId:a}=t;return{...r,toasts:r.toasts.map(o=>o.id===a||a===void 0?{...o,dismissed:!0,visible:!1}:o)};case 4:return t.toastId===void 0?{...r,toasts:[]}:{...r,toasts:r.toasts.filter(o=>o.id!==t.toastId)};case 5:return{...r,pausedAt:t.time};case 6:let i=t.time-(r.pausedAt||0);return{...r,pausedAt:void 0,toasts:r.toasts.map(o=>({...o,pauseDuration:o.pauseDuration+i}))}}},Re=[],wt={toasts:[],pausedAt:void 0,settings:{toastLimit:Ti}},W={},Nt=(r,t=gr)=>{W[t]=At(W[t]||wt,r),Re.forEach(([s,n])=>{s===t&&n(W[t])})},Ct=r=>Object.keys(W).forEach(t=>Nt(r,t)),Di=r=>Object.keys(W).find(t=>W[t].toasts.some(s=>s.id===r)),Ue=(r=gr)=>t=>{Nt(t,r)},Ii={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},Bi=(r={},t=gr)=>{let[s,n]=v.useState(W[t]||wt),a=v.useRef(W[t]);v.useEffect(()=>(a.current!==W[t]&&n(W[t]),Re.push([t,n]),()=>{let o=Re.findIndex(([l])=>l===t);o>-1&&Re.splice(o,1)}),[t]);let i=s.toasts.map(o=>{var l,c,u;return{...r,...r[o.type],...o,removeDelay:o.removeDelay||((l=r[o.type])==null?void 0:l.removeDelay)||(r==null?void 0:r.removeDelay),duration:o.duration||((c=r[o.type])==null?void 0:c.duration)||(r==null?void 0:r.duration)||Ii[o.type],style:{...r.style,...(u=r[o.type])==null?void 0:u.style,...o.style}}});return{...s,toasts:i}},Mi=(r,t="blank",s)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:t,ariaProps:{role:"status","aria-live":"polite"},message:r,pauseDuration:0,...s,id:(s==null?void 0:s.id)||Pi()}),je=r=>(t,s)=>{let n=Mi(t,r,s);return Ue(n.toasterId||Di(n.id))({type:2,toast:n}),n.id},O=(r,t)=>je("blank")(r,t);O.error=je("error");O.success=je("success");O.loading=je("loading");O.custom=je("custom");O.dismiss=(r,t)=>{let s={type:3,toastId:r};t?Ue(t)(s):Ct(s)};O.dismissAll=r=>O.dismiss(void 0,r);O.remove=(r,t)=>{let s={type:4,toastId:r};t?Ue(t)(s):Ct(s)};O.removeAll=r=>O.remove(void 0,r);O.promise=(r,t,s)=>{let n=O.loading(t.loading,{...s,...s==null?void 0:s.loading});return typeof r=="function"&&(r=r()),r.then(a=>{let i=t.success?Te(t.success,a):void 0;return i?O.success(i,{id:n,...s,...s==null?void 0:s.success}):O.dismiss(n),a}).catch(a=>{let i=t.error?Te(t.error,a):void 0;i?O.error(i,{id:n,...s,...s==null?void 0:s.error}):O.dismiss(n)}),r};var zi=1e3,Gi=(r,t="default")=>{let{toasts:s,pausedAt:n}=Bi(r,t),a=v.useRef(new Map).current,i=v.useCallback((p,y=zi)=>{if(a.has(p))return;let f=setTimeout(()=>{a.delete(p),o({type:4,toastId:p})},y);a.set(p,f)},[]);v.useEffect(()=>{if(n)return;let p=Date.now(),y=s.map(f=>{if(f.duration===1/0)return;let b=(f.duration||0)+f.pauseDuration-(p-f.createdAt);if(b<0){f.visible&&O.dismiss(f.id);return}return setTimeout(()=>O.dismiss(f.id,t),b)});return()=>{y.forEach(f=>f&&clearTimeout(f))}},[s,n,t]);let o=v.useCallback(Ue(t),[t]),l=v.useCallback(()=>{o({type:5,time:Date.now()})},[o]),c=v.useCallback((p,y)=>{o({type:1,toast:{id:p,height:y}})},[o]),u=v.useCallback(()=>{n&&o({type:6,time:Date.now()})},[n,o]),m=v.useCallback((p,y)=>{let{reverseOrder:f=!1,gutter:b=8,defaultPosition:x}=y||{},g=s.filter(h=>(h.position||x)===(p.position||x)&&h.height),A=g.findIndex(h=>h.id===p.id),N=g.filter((h,j)=>j<A&&h.visible).length;return g.filter(h=>h.visible).slice(...f?[N+1]:[0,N]).reduce((h,j)=>h+(j.height||0)+b,0)},[s]);return v.useEffect(()=>{s.forEach(p=>{if(p.dismissed)i(p.id,p.removeDelay);else{let y=a.get(p.id);y&&(clearTimeout(y),a.delete(p.id))}})},[s,i]),{toasts:s,handlers:{updateHeight:c,startPause:l,endPause:u,calculateOffset:m}}},Wi=H`
from {
...
to {
  ...
  animation: ${eo} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,to=({toast:r})=>{let{icon:t,type:s,iconTheme:n}=r;return t!==void 0?typeof t=="string"?v.createElement(ro,null,t):t:s==="blank"?null:v.createElement(Zi,null,v.createElement(Ji,{...n}),s!=="loading"&&v.createElement(Qi,null,s==="error"?v.createElement(Hi,{...n}):v.createElement(Xi,{...n})))},so=r=>`
0% {transform: translate3d(0,${r*-200}%,0) scale(.6); opacity:.5;}
100% {transform: translate3d(0,0,0) scale(1); opacity:1;}
`,no=r=>`
0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}
100% {transform: translate3d(0,${r*-150}%,-1px) scale(.6); opacity:0;}
`,ao="0%{opacity:0;} 100%{opacity:1;}",io="0%{opacity:1;} 100%{opacity:0;}",oo=Z("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`,co=(r,t)=>{let s=r.includes("top")?1:-1,[n,a]=jt()?[ao,io]:[so(s),no(s)];return{animation:t?`${H(n)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${H(a)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},uo=v.memo(({toast:r,position:t,style:s,children:n})=>{let a=r.height?co(r.position||t||"top-center",r.visible):{opacity:0},i=v.createElement(to,{toast:r}),o=v.createElement(lo,{...r.ariaProps},Te(r.message,r));return v.createElement(oo,{className:r.className,style:{...a,...s,...r.style}},typeof n=="function"?n({icon:i,message:o}):v.createElement(v.Fragment,null,i,o))});Ri(v.createElement);var mo=({id:r,className:t,style:s,onHeightUpdate:n,children:a})=>{let i=v.useCallback(o=>{if(o){let l=()=>{let c=o.getBoundingClientRect().height;n(r,c)};l(),new MutationObserver(l).observe(o,{subtree:!0,childList:!0,characterData:!0})}},[r,n]);return v.createElement("div",{ref:i,className:t,style:s},a)},po=(r,t)=>{let s=r.includes("top"),n=s?{top:0}:{bottom:0},a=r.includes("center")?{justifyContent:"center"}:r.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:jt()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${t*(s?1:-1)}px)`,...n,...a}},ho=We`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,ke=16,fo=({reverseOrder:r,position:t="top-center",toastOptions:s,gutter:n,children:a,toasterId:i,containerStyle:o,containerClassName:l})=>{let{toasts:c,handlers:u}=Gi(s,i);return v.createElement("div",{"data-rht-toaster":i||"",style:{position:"fixed",zIndex:9999,top:ke,left:ke,right:ke,bottom:ke,pointerEvents:"none",...o},className:l,onMouseEnter:u.startPause,onMouseLeave:u.endPause},c.map(m=>{let p=m.position||t,y=u.calculateOffset(m,{reverseOrder:r,gutter:n,defaultPosition:t}),f=po(p,y);return v.createElement(mo,{id:m.id,key:m.id,onHeightUpdate:u.updateHeight,className:m.visible?ho:"",style:f},m.type==="custom"?Te(m.message,m):a?a(m):v.createElement(uo,{toast:m,position:p}))}))};qt.createRoot(document.getElementById("root")).render(e.jsxs(fe.StrictMode,{children:[e.jsx(Si,{}),e.jsx(fo,{position:"bottom-right",toastOptions:{style:{fontFamily:"var(--font-body)",borderRadius:"var(--radius-md)"},success:{iconTheme:{primary:"#52B788",secondary:"white"}}}})]}));export{As as L,or as P,Bo as a,U as b,E as c,Io as r,ue as u};
